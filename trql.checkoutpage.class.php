...
/** {{{*fheader
    {*file                  trql.checkoutpage.class.php *}
    {*purpose               Web page type: Checkout page. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'CHECKOUTPAGE_CLASS_VERSION' ) or define( 'CHECKOUTPAGE_CLASS_VERSION','0.1' );
...
/*------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of CheckoutPage.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of CheckoutPage.__destruct() =========================================== */
    /* ================================================================================ */
