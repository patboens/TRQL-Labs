...
defined( 'LOCKSMITH_CLASS_VERSION' ) or define( 'LOCKSMITH_CLASS_VERSION','0.1' );
...
/** {{*class Locksmith=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Locksmith[/url] *}
...
/*-----------------------------------------------*/
{
    ...
    public      $wikidataId                     = 'Q3479990';       /* {*property   $wikidataId                     (string)                        Wikidata ID. Craftsmen who works with locks and keys *} */
