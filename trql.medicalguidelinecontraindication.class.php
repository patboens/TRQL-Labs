...
/** {{{*fheader
    {*file                  trql.medicalguidelinecontraindication.class.php *}
    {*purpose               A guideline contraindication that designates a process as
    ...
    *}}} */
/****************************************************************************************/
namespace trql\medicalguidelinecontraindication;
...
defined( 'MEDICALGUIDELINECONTRAINDICATION_CLASS_VERSION' ) or define( 'MEDICALGUIDELINECONTRAINDICATION_CLASS_VERSION','0.1' );
...
/** {{*class MedicalGuidelineContraindication=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MedicalGuidelineContraindication[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of MedicalGuidelineContraindication.__construct() ========================================== */
    /* ================================================================================ */
...
}   /* End of class MedicalGuidelineContraindication ====================================================== */
/* ==================================================================================== */
