...
/** {{{*fheader
    {*file                  trql.taxireservation.class.php *}
    {*purpose               A reservation for a taxi.Note: This type is for information
                            about actual reservations, e.g. in confirmation emails or
...
defined( 'TAXIRESERVATION_CLASS_VERSION' ) or define( 'TAXIRESERVATION_CLASS_VERSION','0.1' );
...
/** {{*class TaxiReservation=
    ...
    {*desc
        ...
        A reservation for a taxi.Note: This type is for information about actual
    ...
    *}
    ...
    {*doc [url]http://schema.org/TaxiReservation[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of TaxiReservation.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of TaxiReservation.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class TaxiReservation ====================================================== */
/* ==================================================================================== */
