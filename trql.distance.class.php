...
/** {{{*fheader
    {*file                  trql.distance.class.php *}
    {*purpose               Properties that take Distances as values are of the form
                            '&lt;Number&gt; &lt;Length unit of measure&gt;'. E.g., '7
                            ft'. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'DISTANCE_CLASS_VERSION' ) or define( 'DISTANCE_CLASS_VERSION','0.1' );
...
/** {{*class Distance=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Distance[/url] *}
