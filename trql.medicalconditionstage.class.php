...
/** {{{*fheader
    {*file                  trql.medicalconditionstage.class.php *}
    {*purpose               A stage of a medical condition, such as 'Stage IIIa'. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
/****************************************************************************************/
namespace trql\medicalconditionstage;
...
defined( 'MEDICALCONDITIONSTAGE_CLASS_VERSION' ) or define( 'MEDICALCONDITIONSTAGE_CLASS_VERSION','0.1' );
...
/** {{*class MedicalConditionStage=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MedicalConditionStage[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $sameAs                         = null;             /* {*property   $sameAs                         (URL)                           URL of a reference Web page that unambiguously indicates the item's
                                                                                                                                                    ...
                                                                                                                                                    or official website. *} */
    public      $stageAsNumber                  = null;             /* {*property   $stageAsNumber                  (float)                         The stage represented as a number, e.g. 3. *} */
    public      $study                          = null;             /* {*property   $study                          (MedicalStudy)                  A medical study or trial related to this entity. *} */
    public      $subStageSuffix                 = null;             /* {*property   $subStageSuffix                 (string)                        The substage, e.g. 'a' for Stage IIIa. *} */
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of MedicalConditionStage.__construct() ========================================== */
    /* ================================================================================ */
...
}   /* End of class MedicalConditionStage ====================================================== */
/* ==================================================================================== */
