...
use \trql\bankaccount, investmentordeposit\BankAccount, InvestmentOrDeposit    as BankAccount, InvestmentOrDeposit;


if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'trql.vaesoli.class.php' );

if ( ! defined( 'BANKACCOUNT, INVESTMENTORDEPOSIT_CLASS_VERSION' ) )
    require_once( 'trql.bankaccount, investmentordeposit.class.php' );
 ...
 */
/* ==================================================================================== */
class DepositAccount extends BankAccount, InvestmentOrDeposit
/*--------------------------------------*/
{
