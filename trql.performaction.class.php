...
/** {{{*fheader
    {*file                  trql.performaction.class.php *}
    {*purpose               The act of participating in performance arts. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'PERFORMACTION_CLASS_VERSION' ) or define( 'PERFORMACTION_CLASS_VERSION','0.1' );
...
/** {{*class PerformAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/PerformAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $entertainmentBusiness          = null;             /* {*property   $entertainmentBusiness          (EntertainmentBusiness)         A sub property of location. The entertainment business where the
                                                                                                                                                    action occurred. *} */
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of PerformAction.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of PerformAction.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class PerformAction ====================================================== */
/* ==================================================================================== */
