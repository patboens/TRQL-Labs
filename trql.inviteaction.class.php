...
/** {{{*fheader
    {*file                  trql.inviteaction.class.php *}
    {*purpose               The act of asking someone to attend an event. Reciprocal of
                            RsvpAction. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'INVITEACTION_CLASS_VERSION' ) or define( 'INVITEACTION_CLASS_VERSION','0.1' );
...
/** {{*class InviteAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/InviteAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of InviteAction.__construct() ========================================== */
    /* ================================================================================ */
