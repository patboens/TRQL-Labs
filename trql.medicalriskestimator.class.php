...
/** {{{*fheader
    {*file                  trql.medicalriskestimator.class.php *}
    {*purpose               Any rule set or interactive tool for estimating the risk of
    ...
    *}}} */
/****************************************************************************************/
namespace trql\medicalriskestimator;
...
/** {{*class MedicalRiskEstimator=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MedicalRiskEstimator[/url] *}
...
/*--------------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of MedicalRiskEstimator.__destruct() =================================== */
    /* ================================================================================ */
}   /* End of class MedicalRiskEstimator ============================================== */
/* ==================================================================================== */
?>