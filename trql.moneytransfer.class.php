...
/** {{{*fheader
    {*file                  trql.moneytransfer.class.php *}
    {*purpose               The act of transferring money from one place to another
...
defined( 'MONEYTRANSFER_CLASS_VERSION' ) or define( 'MONEYTRANSFER_CLASS_VERSION','0.1' );
...
/** {{*class MoneyTransfer=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MoneyTransfer[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $beneficiaryBank                = null;             /* {*property   $beneficiaryBank                (string|BankOrCreditUnion)      A bank or bank’s branch, financial institution or international
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of MoneyTransfer.__construct() ========================================= */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of MoneyTransfer.__destruct() ========================================== */
    /* ================================================================================ */
}   /* End of class MoneyTransfer ===================================================== */
/* ==================================================================================== */
