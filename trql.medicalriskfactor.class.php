...
/** {{{*fheader
    {*file                  trql.medicalriskfactor.class.php *}
    {*purpose               A risk factor is anything that increases a person's
                            likelihood of developing or contracting a disease, medical
    ...
    *}}} */
/****************************************************************************************/
namespace trql\medicalriskfactor;
...
defined( 'MEDICALRISKFACTOR_CLASS_VERSION' ) or define( 'MEDICALRISKFACTOR_CLASS_VERSION','0.1' );
...
/** {{*class MedicalRiskFactor=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MedicalRiskFactor[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $image                          = null;             /* {*property   $image                          (ImageObject|URL)               An image of the item. This can be a URL or a fully described
                                                                                                                                                    ImageObject. *} */
    public      $increasesRiskOf                = null;             /* {*property   $increasesRiskOf                (MedicalEntity)                 The condition, complication, etc. influenced by this factor. *} */
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of MedicalRiskFactor.__construct() ========================================== */
    /* ================================================================================ */
...
}   /* End of class MedicalRiskFactor ====================================================== */
/* ==================================================================================== */
