...
/** {{{*fheader
    {*file                  trql.volcano.class.php *}
    {*purpose               A volcano, like Fuji san. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'VOLCANO_CLASS_VERSION' ) or define( 'VOLCANO_CLASS_VERSION','0.1' );
...
/** {{*class Volcano=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Volcano[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of Volcano.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class Volcano ====================================================== */
/* ==================================================================================== */
