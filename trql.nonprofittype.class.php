...
/** {{{*fheader
    {*file                  trql.nonprofittype.class.php *}
    {*purpose               NonprofitType enumerates several kinds of official
                            non-profit types of which a non-profit organization can be. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'NONPROFITTYPE_CLASS_VERSION' ) or define( 'NONPROFITTYPE_CLASS_VERSION','0.1' );
...
/** {{*class NonprofitType=
    ...
    *}
    ...
    {*doc [url]http://schema.org/NonprofitType[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of NonprofitType.__construct() ========================================= */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of NonprofitType.__destruct() ========================================== */
    /* ================================================================================ */

}   /* End of class NonprofitType ===================================================== */
/* ==================================================================================== */
