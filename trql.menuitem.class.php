...
/** {{{*fheader
    {*file                  trql.menuitem.class.php *}
    {*purpose               A food or drink item listed in a menu or menu section. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'MENUITEM_CLASS_VERSION' ) or define( 'MENUITEM_CLASS_VERSION','0.1' );
...
/** {{*class MenuItem=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MenuItem[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $menuAddOn                      = null;             /* {*property   $menuAddOn                      (MenuItem|MenuSection)          Additional menu item(s) such as a side dish of salad or side order of
