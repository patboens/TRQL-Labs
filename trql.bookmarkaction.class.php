...
/** {{{*fheader
    {*file                  trql.bookmarkaction.class.php *}
    {*purpose               An agent bookmarks/flags/labels/tags/marks an object. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'BOOKMARKACTION_CLASS_VERSION' ) or define( 'BOOKMARKACTION_CLASS_VERSION','0.1' );
...
/** {{*class BookmarkAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/BookmarkAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of BookmarkAction.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of BookmarkAction.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class BookmarkAction ====================================================== */
/* ==================================================================================== */
