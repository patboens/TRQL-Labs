...
/** {{{*fheader
    {*file                  trql.veterinarycare.class.php *}
    {*purpose               A vet's office. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'VETERINARYCARE_CLASS_VERSION' ) or define( 'VETERINARYCARE_CLASS_VERSION','0.1' );
...
/** {{*class VeterinaryCare=
    ...
    *}
    ...
    {*doc [url]http://schema.org/VeterinaryCare[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of VeterinaryCare.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of VeterinaryCare.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class VeterinaryCare ====================================================== */
/* ==================================================================================== */
