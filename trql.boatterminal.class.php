...
/** {{{*fheader
    {*file                  trql.boatterminal.class.php *}
    {*purpose               A terminal for boats, ships, and other water vessels. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'BOATTERMINAL_CLASS_VERSION' ) or define( 'BOATTERMINAL_CLASS_VERSION','0.1' );
...
/** {{*class BoatTerminal=
    ...
    *}
    ...
    {*doc [url]http://schema.org/BoatTerminal[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of BoatTerminal.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->autodoc();
        $this->UIKey();
    }   /* End of BoatTerminal.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class BoatTerminal ====================================================== */
/* ==================================================================================== */
