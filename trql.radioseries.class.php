...
/** {{{*fheader
    {*file                  trql.radioseries.class.php *}
    {*purpose               CreativeWorkSeries dedicated to radio broadcast and
...
defined( 'RADIOSERIES_CLASS_VERSION' ) or define( 'RADIOSERIES_CLASS_VERSION','0.1' );
...
/*----------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of RadioSeries.__construct() =========================================== */
    /* ================================================================================ */
