...
/*--------------------------------------*/
{
    ...
    public      $actor                          = null;             /* {*property   $actor                          (Person)                        An actor, e.g. in tv, radio, movie, video games etc., or in an event.
                                                                                                                                                    ...
                                                                                                                                                    episode, clip. *} */
    public      $actors                         = null;             /* {*property   $actors                         (Person)                        An actor, e.g. in tv, radio, movie, video games etc. Actors can be
    ...
    public      $director                       = null;             /* {*property   $director                       (Person)                        A director of e.g. tv, radio, movie, video gaming etc. content, or of
                                                                                                                                                    ...
                                                                                                                                                    series, episode, clip. *} */
    public      $directors                      = null;             /* {*property   $directors                      (Person)                        A director of e.g. tv, radio, movie, video games etc. content.
    ...
    public      $season                         = null;             /* {*property   $season                         (CreativeWorkSeason|URL)        A season in a media series. *} */
    public      $seasons                        = null;             /* {*property   $seasons                        (CreativeWorkSeason)            A season in a media series. *} */
