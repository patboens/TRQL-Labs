...
/** {{{*fheader
    {*file                  trql.pathologytest.class.php *}
    {*purpose               A medical test performed by a laboratory that typically
    ...
    *}}} */
/****************************************************************************************/
namespace trql\pathologytest;

use \trql\vaesoli\Vaesoli                   as Vaesoli;
use \trql\medicaltest\MedicalTest    as MedicalTest;


if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'trql.vaesoli.class.php' );

if ( ! defined( 'MEDICALTEST_CLASS_VERSION' ) )
    require_once( 'trql.medicaltest.class.php' );



defined( 'PATHOLOGYTEST_CLASS_VERSION' ) or define( 'PATHOLOGYTEST_CLASS_VERSION','0.1' );
...
/** {{*class PathologyTest=
    ...
    *}
    ...
    {*doc [url]http://schema.org/PathologyTest[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $tissueSample                   = null;             /* {*property   $tissueSample                   (string)                        The type of tissue sample required for the test. *} */
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of PathologyTest.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of PathologyTest.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class PathologyTest ====================================================== */
/* ==================================================================================== */
