...
/** {{{*fheader
    {*file                  trql.faqpage.class.php *}
    {*purpose               A FAQPage is a WebPage presenting one or more "Frequently
                            asked questions" (see also QAPage). *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
/** {{*class FAQPage=
    ...
    *}
    ...
    {*doc [url]http://schema.org/FAQPage[/url] *}
