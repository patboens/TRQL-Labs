...
/** {{{*fheader
    {*file                  trql.leaveaction.class.php *}
    {*purpose               An agent leaves an event / group with participants/friends
                            at a location.Related actions:JoinAction: The antonym of
                            LeaveAction.UnRegisterAction: Unlike UnRegisterAction,
                            LeaveAction implies leaving a group/team of people rather
                            than a service. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'LEAVEACTION_CLASS_VERSION' ) or define( 'LEAVEACTION_CLASS_VERSION','0.1' );
...
/** {{*class LeaveAction=
    ...
    {*desc
        ...
        location.Related actions:JoinAction: The antonym of
        LeaveAction.UnRegisterAction: Unlike UnRegisterAction, LeaveAction implies
        leaving a group/team of people rather than a service.
    ...
    *}
    ...
    {*doc [url]http://schema.org/LeaveAction[/url] *}
