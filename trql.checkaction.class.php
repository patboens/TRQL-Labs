...
/** {{{*fheader
    {*file                  trql.checkaction.class.php *}
    {*purpose               An agent inspects, determines, investigates, inquires, or
...
defined( 'CHECKACTION_CLASS_VERSION' ) or define( 'CHECKACTION_CLASS_VERSION','0.1' );
...
/** {{*class CheckAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/CheckAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of CheckAction.__construct() ========================================== */
    /* ================================================================================ */
