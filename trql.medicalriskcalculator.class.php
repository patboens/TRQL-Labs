...
/** {{{*fheader
    {*file                  trql.medicalriskcalculator.class.php *}
    {*purpose               A complex mathematical calculation requiring an online
    ...
    *}}} */
/****************************************************************************************/
namespace trql\medicalriskcalculator;
...
defined( 'MEDICALRISKCALCULATOR_CLASS_VERSION' ) or define( 'MEDICALRISKCALCULATOR_CLASS_VERSION','0.1' );
...
/** {{*class MedicalRiskCalculator=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MedicalRiskCalculator[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of MedicalRiskCalculator.__construct() ========================================== */
    /* ================================================================================ */
...
}   /* End of class MedicalRiskCalculator ====================================================== */
/* ==================================================================================== */
