...
/** {{{*fheader
    {*file                  trql.individualproduct.class.php *}
    {*purpose               A single, identifiable product instance (e.g. a laptop with
...
/****************************************************************************************/
namespace trql\individualproduct;
...
defined( 'INDIVIDUALPRODUCT_CLASS_VERSION' ) or define( 'INDIVIDUALPRODUCT_CLASS_VERSION','0.1' );
...
/** {{*class IndividualProduct=
    ...
    *}
    ...
    {*doc [url]http://schema.org/IndividualProduct[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of IndividualProduct.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->autodoc();
        $this->UIKey();
    }   /* End of IndividualProduct.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class IndividualProduct ====================================================== */
/* ==================================================================================== */
