...
/** {{{*fheader
    {*file                  trql.physicalactivity.class.php *}
    {*purpose               Any bodily activity that enhances or maintains physical
                            fitness and overall health and wellness. Includes activity
                            that is part of daily living and routine, structured
                            exercise, and exercise prescribed as part of a medical
    ...
    *}}} */
/****************************************************************************************/
namespace trql\physicalactivity;

use \trql\vaesoli\Vaesoli                   as Vaesoli;
use \trql\lifestylemodification\LifestyleModification    as LifestyleModification;


if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'trql.vaesoli.class.php' );

if ( ! defined( 'LIFESTYLEMODIFICATION_CLASS_VERSION' ) )
    require_once( 'trql.lifestylemodification.class.php' );



defined( 'PHYSICALACTIVITY_CLASS_VERSION' ) or define( 'PHYSICALACTIVITY_CLASS_VERSION','0.1' );
...
/** {{*class PhysicalActivity=
    ...
    *}
    ...
    {*doc [url]http://schema.org/PhysicalActivity[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of PhysicalActivity.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of PhysicalActivity.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class PhysicalActivity ====================================================== */
/* ==================================================================================== */
