...
/** {{{*fheader
    {*file                  trql.medicalriskscore.class.php *}
    {*purpose               A simple system that adds up the number of risk factors to
    ...
    *}}} */
/****************************************************************************************/
namespace trql\medicalriskscore;

use \trql\vaesoli\Vaesoli                   as Vaesoli;
use \trql\medicalriskestimator\MedicalRiskEstimator    as MedicalRiskEstimator;


if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'trql.vaesoli.class.php' );

if ( ! defined( 'MEDICALRISKESTIMATOR_CLASS_VERSION' ) )
    require_once( 'trql.medicalriskestimator.class.php' );



defined( 'MEDICALRISKSCORE_CLASS_VERSION' ) or define( 'MEDICALRISKSCORE_CLASS_VERSION','0.1' );
...
/** {{*class MedicalRiskScore=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MedicalRiskScore[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $algorithm                      = null;             /* {*property   $algorithm                      (string)                        The algorithm or rules to follow to compute the score. *} */
    ...
    public      $estimatesRiskOf                = null;             /* {*property   $estimatesRiskOf                (MedicalEntity)                 The condition, complication, or symptom whose risk is being estimated. *} */
    ...
    public      $image                          = null;             /* {*property   $image                          (ImageObject|URL)               An image of the item. This can be a URL or a fully described
                                                                                                                                                    ImageObject. *} */
    public      $includedRiskFactor             = null;             /* {*property   $includedRiskFactor             (MedicalRiskFactor)             A modifiable or non-modifiable risk factor included in the
