...
/** {{{*fheader
    {*file                  trql.festival.class.php *}
    {*purpose               Event type: Festival. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'FESTIVAL_CLASS_VERSION' ) or define( 'FESTIVAL_CLASS_VERSION','0.1' );
...
/** {{*class Festival=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Festival[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->autodoc();
        $this->UIKey();
    }   /* End of Festival.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class Festival ====================================================== */
/* ==================================================================================== */
