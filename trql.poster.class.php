...
/** {{{*fheader
    {*file                  trql.poster.class.php *}
    {*purpose               A large, usually printed placard, bill, or announcement,
                            often illustrated, that is posted to advertise or publicize
                            something. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'POSTER_CLASS_VERSION' ) or define( 'POSTER_CLASS_VERSION','0.1' );
...
/** {{*class Poster=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Poster[/url] *}
...
/*-----------------------------*/
{
    ...
    public      $wikidataId                     = 'Q429785';        /* {*property   $wikidataId                     (string)                        Wikidata ID. Type of graphic advertisement *} */
