...
/** {{{*fheader
    {*file                  trql.medicalguideline.class.php *}
    {*purpose               Any recommendation made by a standard society (e.g. ACC/AHA)
                            or consensus statement that denotes how to diagnose and
                            treat a particular condition. Note: this type should be used
                            to tag the actual guideline recommendation; if the guideline
    ...
    *}}} */
/****************************************************************************************/
namespace trql\medicalguideline;
...
defined( 'MEDICALGUIDELINE_CLASS_VERSION' ) or define( 'MEDICALGUIDELINE_CLASS_VERSION','0.1' );
...
/** {{*class MedicalGuideline=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MedicalGuideline[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of MedicalGuideline.__construct() ========================================== */
    /* ================================================================================ */
