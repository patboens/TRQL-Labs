...
/** {{{*fheader
    {*file                  trql.nlnonprofittype.class.php *}
    {*purpose               NLNonprofitType: Non-profit organization type originating
...
defined( 'NLNONPROFITTYPE_CLASS_VERSION' ) or define( 'NLNONPROFITTYPE_CLASS_VERSION','0.1' );
...
/** {{*class NLNonprofitType=
    ...
    *}
    ...
    {*doc [url]http://schema.org/NLNonprofitType[/url] *}
