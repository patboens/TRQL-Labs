...
/** {{{*fheader
    {*file                  trql.middleschool.class.php *}
    {*purpose               A middle school (typically for children aged around 11-14,
...
/** {{*class MiddleSchool=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MiddleSchool[/url] *}
...
/*----------------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of MiddleSchool.__construct() ========================================== */
    /* ================================================================================ */
