...
/** {{{*fheader
    {*file                  trql.catholicchurch.class.php *}
    {*purpose               A Catholic church. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
/****************************************************************************************/
namespace trql\catholicchurch;

use \trql\vaesoli\Vaesoli                   as Vaesoli;
use \trql\church\Church    as Church;


if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'trql.vaesoli.class.php' );

if ( ! defined( 'CHURCH_CLASS_VERSION' ) )
    require_once( 'trql.church.class.php' );



defined( 'CATHOLICCHURCH_CLASS_VERSION' ) or define( 'CATHOLICCHURCH_CLASS_VERSION','0.1' );
...
/** {{*class CatholicChurch=
    ...
    *}
    ...
    {*doc [url]http://schema.org/CatholicChurch[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of CatholicChurch.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->autodoc();
        $this->UIKey();
    }   /* End of CatholicChurch.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class CatholicChurch ====================================================== */
/* ==================================================================================== */
