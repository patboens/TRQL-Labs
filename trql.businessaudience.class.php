...
/** {{{*fheader
    {*file                  trql.businessaudience.class.php *}
    {*purpose               A set of characteristics belonging to businesses, e.g. who
...
/****************************************************************************************/
namespace trql\businessaudience;
...
defined( 'BUSINESSAUDIENCE_CLASS_VERSION' ) or define( 'BUSINESSAUDIENCE_CLASS_VERSION','0.1' );
...
/** {{*class BusinessAudience=
    ...
    *}
    ...
    {*doc [url]http://schema.org/BusinessAudience[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $yearlyRevenue                  = null;             /* {*property   $yearlyRevenue                  (QuantitativeValue)             The size of the business in annual revenue. *} */
    public      $yearsInOperation               = null;             /* {*property   $yearsInOperation               (QuantitativeValue)             The age of the business. *} */
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of BusinessAudience.__construct() ========================================== */
    /* ================================================================================ */
