...
/** {{{*fheader
    {*file                  trql.assignaction.class.php *}
    {*purpose               The act of allocating an action/event/task to some
...
defined( 'ASSIGNACTION_CLASS_VERSION' ) or define( 'ASSIGNACTION_CLASS_VERSION','0.1' );
...
/** {{*class AssignAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/AssignAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of AssignAction.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->autodoc();
        $this->UIKey();
    }   /* End of AssignAction.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class AssignAction ====================================================== */
/* ==================================================================================== */
