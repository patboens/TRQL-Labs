...
/** {{{*fheader
    {*file                  trql.realestateagent.class.php *}
    {*purpose               A real-estate agent. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'REALESTATEAGENT_CLASS_VERSION' ) or define( 'REALESTATEAGENT_CLASS_VERSION','0.1' );
...
/** {{*class RealEstateAgent=
    ...
    *}
    ...
    {*doc [url]http://schema.org/RealEstateAgent[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of RealEstateAgent.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of RealEstateAgent.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class RealEstateAgent ====================================================== */
/* ==================================================================================== */
