...
/** {{{*fheader
    {*file                  trql.guide.class.php *}
    {*purpose               Guide is a page or article that recommend specific products
...
defined( 'GUIDE_CLASS_VERSION' ) or define( 'GUIDE_CLASS_VERSION','0.1' );
...
/** {{*class Guide=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Guide[/url] *}
