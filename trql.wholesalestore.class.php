...
/** {{{*fheader
    {*file                  trql.wholesalestore.class.php *}
    {*purpose               A wholesale store. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'WHOLESALESTORE_CLASS_VERSION' ) or define( 'WHOLESALESTORE_CLASS_VERSION','0.1' );
...
/** {{*class WholesaleStore=
    ...
    *}
    ...
    {*doc [url]http://schema.org/WholesaleStore[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of WholesaleStore.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of WholesaleStore.__destruct() =========================================== */
    /* ================================================================================ */
