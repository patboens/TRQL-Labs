...
/** {{{*fheader
    {*file                  trql.boatreservation.class.php *}
    {*purpose               A reservation for boat travel.Note: This type is for
...
/****************************************************************************************/
namespace trql\boatreservation;
...
defined( 'BOATRESERVATION_CLASS_VERSION' ) or define( 'BOATRESERVATION_CLASS_VERSION','0.1' );
...
/** {{*class BoatReservation=
    ...
    *}
    ...
    {*doc [url]http://schema.org/BoatReservation[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of BoatReservation.__construct() ========================================== */
    /* ================================================================================ */
