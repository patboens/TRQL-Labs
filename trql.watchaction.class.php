...
/** {{{*fheader
    {*file                  trql.watchaction.class.php *}
    {*purpose               The act of consuming dynamic/moving visual content. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'WATCHACTION_CLASS_VERSION' ) or define( 'WATCHACTION_CLASS_VERSION','0.1' );
...
/** {{*class WatchAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/WatchAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of WatchAction.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of WatchAction.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class WatchAction ====================================================== */
/* ==================================================================================== */
