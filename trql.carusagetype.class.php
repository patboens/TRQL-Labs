...
/** {{{*fheader
    {*file                  trql.carusagetype.class.php *}
    {*purpose               A value indicating a special usage of a car, e.g. commercial
...
defined( 'CARUSAGETYPE_CLASS_VERSION' ) or define( 'CARUSAGETYPE_CLASS_VERSION','0.1' );
...
/** {{*class CarUsageType=
    ...
    *}
    ...
    {*doc [url]http://schema.org/CarUsageType[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of CarUsageType.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of CarUsageType.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class CarUsageType ====================================================== */
/* ==================================================================================== */
