...
/** {{{*fheader
    {*file                  trql.governmentpermit.class.php *}
    {*purpose               A permit issued by a government agency. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
use \trql\permit\Permit    as Permit;


if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'trql.vaesoli.class.php' );

if ( ! defined( 'PERMIT_CLASS_VERSION' ) )
    require_once( 'trql.permit.class.php' );



defined( 'GOVERNMENTPERMIT_CLASS_VERSION' ) or define( 'GOVERNMENTPERMIT_CLASS_VERSION','0.1' );
...
/** {{*class GovernmentPermit=
    ...
    *}
    ...
    {*doc [url]http://schema.org/GovernmentPermit[/url] *}
