...
/** {{{*fheader
    {*file                  trql.nerve.class.php *}
    {*purpose               A common pathway for the electrochemical nerve impulses that
...
defined( 'NERVE_CLASS_VERSION' ) or define( 'NERVE_CLASS_VERSION','0.1' );
...
/** {{*class Nerve=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Nerve[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $branch                         = null;             /* {*property   $branch                         (AnatomicalStructure)           The branches that delineate from the nerve bundle. Not to be confused
                                                                                                                                                    with branchOf. *} */
    ...
    public      $nerveMotor                     = null;             /* {*property   $nerveMotor                     (Muscle)                        The neurological pathway extension that involves muscle control. *} */
    ...
    public      $sameAs                         = null;             /* {*property   $sameAs                         (URL)                           URL of a reference Web page that unambiguously indicates the item's
                                                                                                                                                    ...
                                                                                                                                                    or official website. *} */
    public      $sensoryUnit                    = null;             /* {*property   $sensoryUnit                    (SuperficialAnatomy|AnatomicalStructure)The neurological pathway extension that inputs and sends information
                                                                                                                                                    to the brain or spinal cord. *} */
    public      $sourcedFrom                    = null;             /* {*property   $sourcedFrom                    (BrainStructure)                The neurological pathway that originates the neurons. *} */
