...
/** {{{*fheader
    {*file                  trql.saleevent.class.php *}
    {*purpose               Event type: Sales event. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'SALEEVENT_CLASS_VERSION' ) or define( 'SALEEVENT_CLASS_VERSION','0.1' );
...
/** {{*class SaleEvent=
    ...
    *}
    ...
    {*doc [url]http://schema.org/SaleEvent[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of SaleEvent.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class SaleEvent ====================================================== */
/* ==================================================================================== */
