...
/** {{{*fheader
    {*file                  trql.peopleaudience.class.php *}
    {*purpose               A set of characteristics belonging to people, e.g. who
...
defined( 'PEOPLEAUDIENCE_CLASS_VERSION' ) or define( 'PEOPLEAUDIENCE_CLASS_VERSION','0.1' );
...
/** {{*class PeopleAudience=
    ...
    *}
    ...
    {*doc [url]http://schema.org/PeopleAudience[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of PeopleAudience.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of PeopleAudience.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class PeopleAudience ====================================================== */
/* ==================================================================================== */
