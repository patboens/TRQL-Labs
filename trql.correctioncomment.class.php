...
/** {{{*fheader
    {*file                  trql.correctioncomment.class.php *}
    {*purpose               A comment that corrects CreativeWork. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
/****************************************************************************************/
namespace trql\correctioncomment;
...
defined( 'CORRECTIONCOMMENT_CLASS_VERSION' ) or define( 'CORRECTIONCOMMENT_CLASS_VERSION','0.1' );
...
/** {{*class CorrectionComment=
    ...
    *}
    ...
    {*doc [url]http://schema.org/CorrectionComment[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of CorrectionComment.__construct() ===================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of CorrectionComment.__destruct() ====================================== */
    /* ================================================================================ */
}   /* End of class CorrectionComment ================================================= */
/* ==================================================================================== */
?>