...
/** {{{*fheader
    {*file                  trql.riverbodyofwater.class.php *}
    {*purpose               A river (for example, the broad majestic Shannon). *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
    ...
    *}}} */
/****************************************************************************************/
namespace trql\riverbodyofwater;

use \trql\vaesoli\Vaesoli                   as Vaesoli;
use \trql\bodyofwater\BodyOfWater    as BodyOfWater;


if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'trql.vaesoli.class.php' );

if ( ! defined( 'BODYOFWATER_CLASS_VERSION' ) )
    require_once( 'trql.bodyofwater.class.php' );



defined( 'RIVERBODYOFWATER_CLASS_VERSION' ) or define( 'RIVERBODYOFWATER_CLASS_VERSION','0.1' );
...
/** {{*class RiverBodyOfWater=
    ...
    *}
    ...
    {*doc [url]http://schema.org/RiverBodyOfWater[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of RiverBodyOfWater.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of RiverBodyOfWater.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class RiverBodyOfWater ====================================================== */
/* ==================================================================================== */
