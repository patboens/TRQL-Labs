...
/** {{{*fheader
    {*file                  trql.creditcard.class.php *}
    {*purpose               A card payment method of a particular brand or name. Used to
                            mark up a particular payment method and/or the financial
                            product/service that supplies the card account.Commonly used
                            values:http://purl.org/goodrelations/v1#AmericanExpresshttp://purl.org/goodrelations/v1#DinersClubhttp://purl.org/goodrelations/v1#Discoverhttp://purl.org/goodrelations/v1#JCBhttp://purl.org/goodrelations/v1#MasterCardhttp://purl.org/goodrelations/v1#VISA *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
/****************************************************************************************/
namespace trql\creditcard;

use \trql\vaesoli\Vaesoli                   as Vaesoli;
use \trql\loanorcredit, paymentcard\LoanOrCredit, PaymentCard    as LoanOrCredit, PaymentCard;


if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'trql.vaesoli.class.php' );

if ( ! defined( 'LOANORCREDIT, PAYMENTCARD_CLASS_VERSION' ) )
    require_once( 'trql.loanorcredit, paymentcard.class.php' );



defined( 'CREDITCARD_CLASS_VERSION' ) or define( 'CREDITCARD_CLASS_VERSION','0.1' );
...
/** {{*class CreditCard=
    ...
    {*desc
        ...
        supplies the card account.Commonly used
        values:http://purl.org/goodrelations/v1#AmericanExpresshttp://purl.org/goodrelations/v1#DinersClubhttp://purl.org/goodrelations/v1#Discoverhttp://purl.org/goodrelations/v1#JCBhttp://purl.org/goodrelations/v1#MasterCardhttp://purl.org/goodrelations/v1#VISA
    ...
    *}
    ...
    {*doc [url]http://schema.org/CreditCard[/url] *}
 ...
 */
/* ==================================================================================== */
class CreditCard extends LoanOrCredit, PaymentCard
/*--------------------------------------*/
{
