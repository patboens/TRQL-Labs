...
/** {{{*fheader
    {*file                  trql.recommendeddoseschedule.class.php *}
    {*purpose               A recommended dosing schedule for a drug or supplement as
    ...
    *}}} */
/****************************************************************************************/
namespace trql\recommendeddoseschedule;

use \trql\vaesoli\Vaesoli                   as Vaesoli;
use \trql\doseschedule\DoseSchedule    as DoseSchedule;


if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'trql.vaesoli.class.php' );

if ( ! defined( 'DOSESCHEDULE_CLASS_VERSION' ) )
    require_once( 'trql.doseschedule.class.php' );



defined( 'RECOMMENDEDDOSESCHEDULE_CLASS_VERSION' ) or define( 'RECOMMENDEDDOSESCHEDULE_CLASS_VERSION','0.1' );
...
/** {{*class RecommendedDoseSchedule=
    ...
    *}
    ...
    {*doc [url]http://schema.org/RecommendedDoseSchedule[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $doseUnit                       = null;             /* {*property   $doseUnit                       (string)                        The unit of the dose, e.g. 'mg'. *} */
    public      $doseValue                      = null;             /* {*property   $doseValue                      (QualitativeValue|float)        The value of the dose, e.g. 500. *} */
    public      $frequency                      = null;             /* {*property   $frequency                      (string)                        How often the dose is taken, e.g. 'daily'. *} */
    ...
    public      $targetPopulation               = null;             /* {*property   $targetPopulation               (string)                        Characteristics of the population for which this is intended, or which
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of RecommendedDoseSchedule.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of RecommendedDoseSchedule.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class RecommendedDoseSchedule ====================================================== */
/* ==================================================================================== */
