...
/** {{{*fheader
    {*file                  trql.findaction.class.php *}
    {*purpose               The act of finding an object.Related actions:SearchAction:
...
defined( 'FINDACTION_CLASS_VERSION' ) or define( 'FINDACTION_CLASS_VERSION','0.1' );
...
/** {{*class FindAction=
    ...
    {*desc
        ...
        The act of finding an object.Related actions:SearchAction: FindAction is
    ...
    *}
    ...
    {*doc [url]http://schema.org/FindAction[/url] *}
