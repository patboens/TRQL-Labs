...
/** {{{*fheader
    {*file                  trql.comiccoverart.class.php *}
    {*purpose               The artwork on the cover of a comic. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
/** {{*class ComicCoverArt=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ComicCoverArt[/url] *}
...
/*--------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of ComicCoverArt.__destruct() ========================================== */
    /* ================================================================================ */
}   /* End of class ComicCoverArt ===================================================== */
/* ==================================================================================== */
?>