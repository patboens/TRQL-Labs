...
/** {{{*fheader
    {*file                  trql.recyclingcenter.class.php *}
    {*purpose               A recycling center. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'RECYCLINGCENTER_CLASS_VERSION' ) or define( 'RECYCLINGCENTER_CLASS_VERSION','0.1' );
...
/** {{*class RecyclingCenter=
    ...
    *}
    ...
    {*doc [url]http://schema.org/RecyclingCenter[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of RecyclingCenter.__construct() ======================================= */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of RecyclingCenter.__destruct() ======================================== */
    /* ================================================================================ */
}   /* End of class RecyclingCenter =================================================== */
/* ==================================================================================== */
?>