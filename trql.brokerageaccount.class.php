...
/** {{{*fheader
    {*file                  trql.brokerageaccount.class.php *}
    {*purpose               An account that allows an investor to deposit funds and
                            place investment orders with a licensed broker or brokerage
                            firm. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
/****************************************************************************************/
namespace trql\brokerageaccount;
...
defined( 'BROKERAGEACCOUNT_CLASS_VERSION' ) or define( 'BROKERAGEACCOUNT_CLASS_VERSION','0.1' );
...
/** {{*class BrokerageAccount=
    ...
    *}
    ...
    {*doc [url]http://schema.org/BrokerageAccount[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of BrokerageAccount.__construct() ========================================== */
    /* ================================================================================ */
