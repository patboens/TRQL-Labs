...
/** {{{*fheader
    {*file                  trql.checkoutaction.class.php *}
    {*purpose               The act of an agent communicating (service provider, social
                            ...
                            (e.g. flight check in) or place (e.g. hotel).Related
                            actions:CheckInAction: The antonym of
                            CheckOutAction.DepartAction: Unlike DepartAction,
                            CheckOutAction implies that the agent is
                            informing/confirming the end of a previously reserved
                            service.CancelAction: Unlike CancelAction, CheckOutAction
                            implies that the agent is informing/confirming the end of a
...
defined( 'CHECKOUTACTION_CLASS_VERSION' ) or define( 'CHECKOUTACTION_CLASS_VERSION','0.1' );
...
/** {{*class CheckOutAction=
    ...
    {*desc
        ...
        CheckOutAction.DepartAction: Unlike DepartAction, CheckOutAction implies
        that the agent is informing/confirming the end of a previously reserved
        service.CancelAction: Unlike CancelAction, CheckOutAction implies that the
    ...
    *}
    ...
    {*doc [url]http://schema.org/CheckOutAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $instrument                     = null;             /* {*property   $instrument                     (Thing)                         The object that helped the agent perform the action. e.g. John wrote a
                                                                                                                                                    book with a pen. *} */
    public      $language                       = null;             /* {*property   $language                       (Language)                      A sub property of instrument. The language used on this action. *} */
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of CheckOutAction.__construct() ========================================== */
    /* ================================================================================ */
