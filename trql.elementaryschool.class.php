...
/** {{{*fheader
    {*file                  trql.elementaryschool.class.php *}
    {*purpose               An elementary school. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'ELEMENTARYSCHOOL_CLASS_VERSION' ) or define( 'ELEMENTARYSCHOOL_CLASS_VERSION','0.1' );
...
/** {{*class ElementarySchool=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ElementarySchool[/url] *}
...
/*--------------------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of ElementarySchool.__construct() ====================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of ElementarySchool.__destruct() ======================================= */
    /* ================================================================================ */
