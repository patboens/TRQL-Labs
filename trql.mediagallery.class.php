...
/** {{{*fheader
    {*file                  trql.mediagallery.class.php *}
    {*purpose               Web page type: Media gallery page. A mixed-media page that
                            can contains media such as images, videos, and other
                            multimedia. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
if ( ! defined( 'COLLECTIONPAGE_CLASS_VERSION' ) )
    require_once( 'trql.collectionpage.class.php' );

defined( 'MEDIAGALLERY_CLASS_VERSION' ) or define( 'MEDIAGALLERY_CLASS_VERSION','0.1' );
...
/** {{*class MediaGallery=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MediaGallery[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of MediaGallery.__destruct() =========================================== */
    /* ================================================================================ */
