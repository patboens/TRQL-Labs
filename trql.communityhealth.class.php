...
/** {{{*fheader
    {*file                  trql.communityhealth.class.php *}
    {*purpose               A field of public health focusing on improving health
                            characteristics of a defined population in relation with
...
/****************************************************************************************/
namespace trql\communityhealth;
...
defined( 'COMMUNITYHEALTH_CLASS_VERSION' ) or define( 'COMMUNITYHEALTH_CLASS_VERSION','0.1' );
...
/** {{*class CommunityHealth=
    ...
    *}
    ...
    {*doc [url]http://schema.org/CommunityHealth[/url] *}
