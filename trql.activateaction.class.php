...
/** {{{*fheader
    {*file                  trql.activateaction.class.php *}
    {*purpose               The act of starting or activating a device or application 
...
/** {{*class ActivateAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ActivateAction[/url] *}
