...
/** {{{*fheader
    {*file                  trql.comedyevent.class.php *}
    {*purpose               Event type: Comedy event. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'COMEDYEVENT_CLASS_VERSION' ) or define( 'COMEDYEVENT_CLASS_VERSION','0.1' );
...
/** {{*class ComedyEvent=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ComedyEvent[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of ComedyEvent.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->autodoc();
        $this->UIKey();
    }   /* End of ComedyEvent.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class ComedyEvent ====================================================== */
/* ==================================================================================== */
