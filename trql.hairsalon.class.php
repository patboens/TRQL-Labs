...
/** {{{*fheader
    {*file                  trql.hairsalon.class.php *}
    {*purpose               A hair salon. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'HAIRSALON_CLASS_VERSION' ) or define( 'HAIRSALON_CLASS_VERSION','0.1' );
...
/** {{*class HairSalon=
    ...
    *}
    ...
    {*doc [url]http://schema.org/HairSalon[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->autodoc();
        $this->UIKey();
    }   /* End of HairSalon.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class HairSalon ====================================================== */
/* ==================================================================================== */
