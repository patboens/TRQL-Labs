...
/** {{{*fheader
    {*file                  trql.drivewheelconfigurationvalue.class.php *}
    {*purpose               A value indicating which roadwheels will receive torque. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
/****************************************************************************************/
namespace trql\drivewheelconfigurationvalue;
...
defined( 'DRIVEWHEELCONFIGURATIONVALUE_CLASS_VERSION' ) or define( 'DRIVEWHEELCONFIGURATIONVALUE_CLASS_VERSION','0.1' );
...
/** {{*class DriveWheelConfigurationValue=
    ...
    *}
    ...
    {*doc [url]http://schema.org/DriveWheelConfigurationValue[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of DriveWheelConfigurationValue.__construct() ========================================== */
    /* ================================================================================ */
...
}   /* End of class DriveWheelConfigurationValue ====================================================== */
/* ==================================================================================== */
