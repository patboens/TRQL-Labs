...
/** {{{*fheader
    {*file                  trql.cableorsatelliteservice.class.php *}
    {*purpose               A service which provides access to media programming like TV
                            or radio. Access may be via cable or satellite. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
/****************************************************************************************/
namespace trql\cableorsatelliteservice;
...
defined( 'CABLEORSATELLITESERVICE_CLASS_VERSION' ) or define( 'CABLEORSATELLITESERVICE_CLASS_VERSION','0.1' );
...
/** {{*class CableOrSatelliteService=
    ...
    *}
    ...
    {*doc [url]http://schema.org/CableOrSatelliteService[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of CableOrSatelliteService.__construct() ========================================== */
    /* ================================================================================ */
...
}   /* End of class CableOrSatelliteService ====================================================== */
/* ==================================================================================== */
