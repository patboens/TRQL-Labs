...
/** {{{*fheader
    {*file                  trql.disagreeaction.class.php *}
    {*purpose               The act of expressing a difference of opinion with the
                            object. An agent disagrees to/about an object (a
...
defined( 'DISAGREEACTION_CLASS_VERSION' ) or define( 'DISAGREEACTION_CLASS_VERSION','0.1' );
...
/** {{*class DisagreeAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/DisagreeAction[/url] *}
