...
/** {{{*fheader
    {*file                  trql.wantaction.class.php *}
    {*purpose               The act of expressing a desire about the object. An agent
                            wants an object. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'WANTACTION_CLASS_VERSION' ) or define( 'WANTACTION_CLASS_VERSION','0.1' );
...
/** {{*class WantAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/WantAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of WantAction.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class WantAction ====================================================== */
/* ==================================================================================== */
