...
/** {{{*fheader
    {*file                  trql.usertweets.class.php *}
...
defined( 'USERTWEETS_CLASS_VERSION' ) or define( 'USERTWEETS_CLASS_VERSION','0.1' );
...
/** {{*class UserTweets=
    ...
    *}
    ...
    {*doc [url]http://schema.org/UserTweets[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of UserTweets.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class UserTweets ====================================================== */
/* ==================================================================================== */
