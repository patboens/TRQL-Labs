...
defined( 'MOSQUE_CLASS_VERSION' ) or define( 'MOSQUE_CLASS_VERSION','0.1' );
...
/** {{*class Mosque=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Mosque[/url] *}
