...
/** {{{*fheader
    {*file                  trql.howtosupply.class.php *}
    {*purpose               A supply consumed when performing the instructions for how
                            to achieve a result. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'HOWTOSUPPLY_CLASS_VERSION' ) or define( 'HOWTOSUPPLY_CLASS_VERSION','0.1' );
...
/** {{*class HowToSupply=
    ...
    *}
    ...
    {*doc [url]http://schema.org/HowToSupply[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of HowToSupply.__construct() ========================================== */
    /* ================================================================================ */
