...
/** {{{*fheader
    {*file                  trql.crematorium.class.php *}
    {*purpose               A crematorium. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'CREMATORIUM_CLASS_VERSION' ) or define( 'CREMATORIUM_CLASS_VERSION','0.1' );
...
/** {{*class Crematorium=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Crematorium[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of Crematorium.__construct() =========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of Crematorium.__destruct() ============================================ */
    /* ================================================================================ */
}   /* End of class Crematorium ======================================================= */
/* ==================================================================================== */
?>