...
/** {{{*fheader
    {*file                  trql.researchproject.class.php *}
    {*purpose               A Research project. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
/** {{*class ResearchProject=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ResearchProject[/url] *}
...
/*---------------------------------*/
{
    ...
    public      $wikidataId                     = 'Q1298668';       /* {*property   $wikidataId                     (string)                        Wikidata ID. Project of one or more scientists or an institute or 
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of ResearchProject.__construct() ======================================= */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of ResearchProject.__destruct() ======================================== */
    /* ================================================================================ */
