...
/** {{{*fheader
    {*file                  trql.hvacbusiness.class.php *}
    {*purpose               A business that provide Heating, Ventilation and Air
...
defined( 'HVACBUSINESS_CLASS_VERSION' ) or define( 'HVACBUSINESS_CLASS_VERSION','0.1' );
...
/** {{*class HVACBusiness=
    ...
    *}
    ...
    {*doc [url]http://schema.org/HVACBusiness[/url] *}
...
/*--------------------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of HVACBusiness.__construct() ========================================== */
    /* ================================================================================ */
