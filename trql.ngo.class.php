...
/** {{{*fheader
    {*file                  trql.ngo.class.php *}
    {*purpose               Organization: Non-governmental Organization. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'NGO_CLASS_VERSION' ) or define( 'NGO_CLASS_VERSION','0.1' );
...
/** {{*class NGO=
    ...
    *}
    ...
    {*doc [url]http://schema.org/NGO[/url] *}
