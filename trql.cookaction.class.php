...
/** {{{*fheader
    {*file                  trql.cookaction.class.php *}
    {*purpose               The act of producing/preparing food. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'COOKACTION_CLASS_VERSION' ) or define( 'COOKACTION_CLASS_VERSION','0.1' );
...
/** {{*class CookAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/CookAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $foodEstablishment              = null;             /* {*property   $foodEstablishment              (Place|FoodEstablishment)       A sub property of location. The specific food establishment where the
                                                                                                                                                    action occurred. *} */
    public      $foodEvent                      = null;             /* {*property   $foodEvent                      (FoodEvent)                     A sub property of location. The specific food event where the action
                                                                                                                                                    occurred. *} */
    ...
    public      $recipe                         = null;             /* {*property   $recipe                         (Recipe)                        A sub property of instrument. The recipe/instructions used to perform
                                                                                                                                                    the action. *} */
