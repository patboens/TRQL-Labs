...
/** {{{*fheader
    {*file                  trql.brand.class.php *}
    {*purpose               A brand is a name used by an organization or business person
...
defined( 'BRAND_CLASS_VERSION' ) or define( 'BRAND_CLASS_VERSION','0.1' );
...
/** {{*class Brand=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Brand[/url] *}
