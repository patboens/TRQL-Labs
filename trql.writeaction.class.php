...
/** {{{*fheader
    {*file                  trql.writeaction.class.php *}
    {*purpose               The act of authoring written creative content. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'WRITEACTION_CLASS_VERSION' ) or define( 'WRITEACTION_CLASS_VERSION','0.1' );
...
/** {{*class WriteAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/WriteAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of WriteAction.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of WriteAction.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class WriteAction ====================================================== */
/* ==================================================================================== */
