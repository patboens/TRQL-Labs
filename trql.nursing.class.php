...
/** {{{*fheader
    {*file                  trql.nursing.class.php *}
    {*purpose               A health profession of a person formally educated and
                            trained in the care of the sick or infirm person. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'NURSING_CLASS_VERSION' ) or define( 'NURSING_CLASS_VERSION','0.1' );
...
/** {{*class Nursing=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Nursing[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $wikidataId                     = 'Q55693893';      /* {*property   $wikidataId                     (string)                        Wikidata ID. Nursing (the closest I can get): 
