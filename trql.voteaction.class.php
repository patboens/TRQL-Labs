...
/** {{{*fheader
    {*file                  trql.voteaction.class.php *}
    {*purpose               The act of expressing a preference from a
...
/** {{*class VoteAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/VoteAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $candidate                      = null;             /* {*property   $candidate                      (Person)                        A sub property of object. The candidate subject of this action. *} */
    ...
    public      $object                         = null;             /* {*property   $object                         (Thing)                         The object upon which the action is carried out, whose state is kept
                                                                                                                                                    ...
                                                                                                                                                    John read a book. *} */
    public      $option                         = null;             /* {*property   $option                         (Thing|string)                  A sub property of object. The options subject to this action. *} */
