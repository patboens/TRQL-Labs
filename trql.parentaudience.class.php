...
/** {{{*fheader
    {*file                  trql.parentaudience.class.php *}
    {*purpose               A set of characteristics describing parents, who can be
...
defined( 'PARENTAUDIENCE_CLASS_VERSION' ) or define( 'PARENTAUDIENCE_CLASS_VERSION','0.1' );
...
/** {{*class ParentAudience=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ParentAudience[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $childMaxAge                    = null;             /* {*property   $childMaxAge                    (float)                         Maximal age of the child. *} */
    public      $childMinAge                    = null;             /* {*property   $childMinAge                    (float)                         Minimal age of the child. *} */
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of ParentAudience.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of ParentAudience.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class ParentAudience ====================================================== */
/* ==================================================================================== */
