...
/** {{{*fheader
    {*file                  trql.replyaction.class.php *}
    {*purpose               The act of responding to a question/message asked/sent by
                            the object. Related to AskActionRelated actions:AskAction:
...
defined( 'REPLYACTION_CLASS_VERSION' ) or define( 'REPLYACTION_CLASS_VERSION','0.1' );
...
/** {{*class ReplyAction=
    ...
    {*desc
        ...
        Related to AskActionRelated actions:AskAction: Appears generally as an
        origin of a ReplyAction.
    ...
    *}
    ...
    {*doc [url]http://schema.org/ReplyAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $resultComment                  = null;             /* {*property   $resultComment                  (Comment)                       A sub property of result. The Comment created or sent as a result of
                                                                                                                                                    this action. *} */
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of ReplyAction.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of ReplyAction.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class ReplyAction ====================================================== */
/* ==================================================================================== */
