...
/** {{{*fheader
    {*file                  trql.marryaction.class.php *}
    {*purpose               The act of marrying a person. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'MARRYACTION_CLASS_VERSION' ) or define( 'MARRYACTION_CLASS_VERSION','0.1' );
...
/** {{*class MarryAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MarryAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of MarryAction.__construct() ========================================== */
    /* ================================================================================ */
