...
defined( 'AQUARIUM_CLASS_VERSION' ) or define( 'AQUARIUM_CLASS_VERSION','0.1' );
...
/** {{*class Aquarium=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Aquarium[/url] *}
