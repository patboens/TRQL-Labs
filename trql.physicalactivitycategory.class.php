...
/** {{{*fheader
    {*file                  trql.physicalactivitycategory.class.php *}
    {*purpose               Categories of physical activity, organized by physiologic
                            classification. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
    ...
    *}}} */
/****************************************************************************************/
namespace trql\physicalactivitycategory;
...
defined( 'PHYSICALACTIVITYCATEGORY_CLASS_VERSION' ) or define( 'PHYSICALACTIVITYCATEGORY_CLASS_VERSION','0.1' );
...
/** {{*class PhysicalActivityCategory=
    ...
    *}
    ...
    {*doc [url]http://schema.org/PhysicalActivityCategory[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of PhysicalActivityCategory.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of PhysicalActivityCategory.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class PhysicalActivityCategory ====================================================== */
/* ==================================================================================== */
