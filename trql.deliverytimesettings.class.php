...
/** {{{*fheader
    {*file                  trql.deliverytimesettings.class.php *}
    {*purpose               A DeliveryTimeSettings represents re-usable pieces of
                            shipping information, relating to timing. It is designed for
                            publication on an URL that may be referenced via the
                            shippingSettingsLink property of a OfferShippingDetails.
...
defined( 'DELIVERYTIMESETTINGS_CLASS_VERSION' ) or define( 'DELIVERYTIMESETTINGS_CLASS_VERSION','0.1' );
...
/** {{*class DeliveryTimeSettings=
    ...
    {*desc
        ...
        referenced via the shippingSettingsLink property of a OfferShippingDetails.
        Several occurrences can be published, distinguished (and
        identified/referenced) by their different values for transitTimeLabel.
    ...
    *}
    ...
    {*doc [url]http://schema.org/DeliveryTimeSettings[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of DeliveryTimeSettings.__construct() ========================================== */
    /* ================================================================================ */
...
}   /* End of class DeliveryTimeSettings ====================================================== */
/* ==================================================================================== */
