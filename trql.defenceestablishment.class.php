...
/** {{{*fheader
    {*file                  trql.defenceestablishment.class.php *}
    {*purpose               A defence establishment, such as an army or navy base. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
/****************************************************************************************/
namespace trql\defenceestablishment;

use \trql\vaesoli\Vaesoli                   as Vaesoli;
use \trql\governmentbuilding\GovernmentBuilding    as GovernmentBuilding;


if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'trql.vaesoli.class.php' );

if ( ! defined( 'GOVERNMENTBUILDING_CLASS_VERSION' ) )
    require_once( 'trql.governmentbuilding.class.php' );



defined( 'DEFENCEESTABLISHMENT_CLASS_VERSION' ) or define( 'DEFENCEESTABLISHMENT_CLASS_VERSION','0.1' );
...
/** {{*class DefenceEstablishment=
    ...
    *}
    ...
    {*doc [url]http://schema.org/DefenceEstablishment[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of DefenceEstablishment.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->autodoc();
        $this->UIKey();
    }   /* End of DefenceEstablishment.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class DefenceEstablishment ====================================================== */
/* ==================================================================================== */
