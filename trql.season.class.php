...
defined( 'SEASON_CLASS_VERSION' ) or define( 'SEASON_CLASS_VERSION','0.1' );
...
/** {{*class Season=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Season[/url] *}
 ...
 */
/* ==================================================================================== */
class Season extends CreativeWorkSeason
/*-----------------------------------*/
{
