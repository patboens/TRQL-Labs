...
/** {{{*fheader
    {*file                  trql.bustrip.class.php *}
    {*purpose               A trip on a commercial bus line. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'BUSTRIP_CLASS_VERSION' ) or define( 'BUSTRIP_CLASS_VERSION','0.1' );
...
/** {{*class BusTrip=
    ...
    *}
    ...
    {*doc [url]http://schema.org/BusTrip[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $arrivalBusStop                 = null;             /* {*property   $arrivalBusStop                 (BusStop|BusStation)            The stop or station from which the bus arrives. *} */
    public      $arrivalTime                    = null;             /* {*property   $arrivalTime                    (Time|DateTime)                 The expected arrival time. *} */
    public      $busName                        = null;             /* {*property   $busName                        (string)                        The name of the bus (e.g. Bolt Express). *} */
    public      $busNumber                      = null;             /* {*property   $busNumber                      (string)                        The unique identifier for the bus. *} */
    public      $departureBusStop               = null;             /* {*property   $departureBusStop               (BusStop|BusStation)            The stop or station from which the bus departs. *} */
