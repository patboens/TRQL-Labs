...
/** {{{*fheader
    {*file                  trql.reporteddoseschedule.class.php *}
    {*purpose               A patient-reported or observed dosing schedule for a drug or
                            supplement. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
    ...
    *}}} */
/****************************************************************************************/
namespace trql\reporteddoseschedule;
...
defined( 'REPORTEDDOSESCHEDULE_CLASS_VERSION' ) or define( 'REPORTEDDOSESCHEDULE_CLASS_VERSION','0.1' );
...
/** {{*class ReportedDoseSchedule=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ReportedDoseSchedule[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of ReportedDoseSchedule.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of ReportedDoseSchedule.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class ReportedDoseSchedule ====================================================== */
/* ==================================================================================== */
