...
/** {{{*fheader
    {*file                  trql.childrensevent.class.php *}
    {*purpose               Event type: Children's event. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'CHILDRENSEVENT_CLASS_VERSION' ) or define( 'CHILDRENSEVENT_CLASS_VERSION','0.1' );
...
/** {{*class ChildrensEvent=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ChildrensEvent[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of ChildrensEvent.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->autodoc();
        $this->UIKey();
    }   /* End of ChildrensEvent.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class ChildrensEvent ====================================================== */
/* ==================================================================================== */
