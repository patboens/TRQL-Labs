...
/** {{{*fheader
    {*file                  trql.hotel.class.php *}
    {*purpose               A hotel is an establishment that provides lodging paid on a
                            short-term basis (Source: Wikipedia, the free encyclopedia,
                            see http://en.wikipedia.org/wiki/Hotel).See also the
...
defined( 'HOTEL_CLASS_VERSION' ) or define( 'HOTEL_CLASS_VERSION','0.1' );
...
/** {{*class Hotel=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Hotel[/url] *}
...
/*-------------------------------*/
{
    ...
    public      $wikidataId                     = 'Q27686';         /* {*property   $wikidataId                 (string)            Wikidata ID. business enterprise that provides lodging
                                                                                                                                    in a single building paid on a short-term basis. *} */
