...
/** {{{*fheader
    {*file                  trql.reservoir.class.php *}
    {*purpose               A reservoir of water, typically an artificially created
                            lake, like the Lake Kariba reservoir. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'RESERVOIR_CLASS_VERSION' ) or define( 'RESERVOIR_CLASS_VERSION','0.1' );
...
/** {{*class Reservoir=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Reservoir[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of Reservoir.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class Reservoir ====================================================== */
/* ==================================================================================== */
