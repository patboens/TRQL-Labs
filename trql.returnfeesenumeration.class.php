...
/** {{{*fheader
    {*file                  trql.returnfeesenumeration.class.php *}
    {*purpose               ReturnFeesEnumeration expresses policies for return fees. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
    ...
    *}}} */
/****************************************************************************************/
namespace trql\returnfeesenumeration;
...
defined( 'RETURNFEESENUMERATION_CLASS_VERSION' ) or define( 'RETURNFEESENUMERATION_CLASS_VERSION','0.1' );
...
/** {{*class ReturnFeesEnumeration=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ReturnFeesEnumeration[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of ReturnFeesEnumeration.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of ReturnFeesEnumeration.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class ReturnFeesEnumeration ====================================================== */
/* ==================================================================================== */
