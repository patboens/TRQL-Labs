...
/** {{{*fheader
    {*file                  trql.legalvaluelevel.class.php *}
    {*purpose               A list of possible levels for the legal validity of a
                            legislation. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
/****************************************************************************************/
namespace trql\legalvaluelevel;
...
defined( 'LEGALVALUELEVEL_CLASS_VERSION' ) or define( 'LEGALVALUELEVEL_CLASS_VERSION','0.1' );
...
/** {{*class LegalValueLevel=
    ...
    *}
    ...
    {*doc [url]http://schema.org/LegalValueLevel[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of LegalValueLevel.__construct() ========================================== */
    /* ================================================================================ */
