...
/** {{{*fheader
    {*file                  trql.url.class.php *}
    {*purpose               Data type: URL. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'URL_CLASS_VERSION' ) or define( 'URL_CLASS_VERSION','0.1' );
...
/** {{*class URL=
    ...
    *}
    ...
    {*doc [url]http://schema.org/URL[/url] *}
