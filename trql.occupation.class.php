...
/** {{{*fheader
    {*file                  trql.occupation.class.php *}
    {*purpose               A profession, may involve prolonged training and/or a formal
                            qualification. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'OCCUPATION_CLASS_VERSION' ) or define( 'OCCUPATION_CLASS_VERSION','0.1' );
...
/** {{*class Occupation=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Occupation[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $occupationLocation             = null;             /* {*property   $occupationLocation             (AdministrativeArea)            The region/country for which this occupational description is
