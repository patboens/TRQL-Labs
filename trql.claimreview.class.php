...
/** {{{*fheader
    {*file                  trql.claimreview.class.php *}
    {*purpose               A fact-checking review of claims made (or reported) in some
...
defined( 'CLAIMREVIEW_CLASS_VERSION' ) or define( 'CLAIMREVIEW_CLASS_VERSION','0.1' );
...
/** {{*class ClaimReview=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ClaimReview[/url] *}
...
/*----------------------------*/
{
    ...
    public      $claimReviewed                  = null;             /* {*property   $claimReviewed                  (string)                        A short summary of the specific claims reviewed in a ClaimReview. *} */
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of ClaimReview.__construct() =========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of ClaimReview.__destruct() ============================================ */
    /* ================================================================================ */
}   /* End of class ClaimReview ======================================================= */
/* ==================================================================================== */
?>