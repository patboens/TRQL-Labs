...
/** {{{*fheader
    {*file                  trql.comedyclub.class.php *}
    {*purpose               A comedy club. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'COMEDYCLUB_CLASS_VERSION' ) or define( 'COMEDYCLUB_CLASS_VERSION','0.1' );
...
/** {{*class ComedyClub=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ComedyClub[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->autodoc();
        $this->UIKey();
    }   /* End of ComedyClub.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class ComedyClub ====================================================== */
/* ==================================================================================== */
