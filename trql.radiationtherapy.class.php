...
/** {{{*fheader
    {*file                  trql.radiationtherapy.class.php *}
    {*purpose               A process of care using radiation aimed at improving a
                            health condition. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
    ...
    *}}} */
/****************************************************************************************/
namespace trql\radiationtherapy;
...
defined( 'RADIATIONTHERAPY_CLASS_VERSION' ) or define( 'RADIATIONTHERAPY_CLASS_VERSION','0.1' );
...
/** {{*class RadiationTherapy=
    ...
    *}
    ...
    {*doc [url]http://schema.org/RadiationTherapy[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of RadiationTherapy.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of RadiationTherapy.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class RadiationTherapy ====================================================== */
/* ==================================================================================== */
