...
/** {{{*fheader
    {*file                  trql.mass.class.php *}
    {*purpose               Properties that take Mass as values are of the form
...
defined( 'MASS_CLASS_VERSION' ) or define( 'MASS_CLASS_VERSION','0.1' );
...
/** {{*class Mass=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Mass[/url] *}
