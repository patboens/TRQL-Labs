...
/** {{{*fheader
    {*file                  trql.scheduleaction.class.php *}
    {*purpose               Scheduling future actions, events, or tasks.Related
                            actions:ReserveAction: Unlike ReserveAction, ScheduleAction
                            allocates future actions (e.g. an event, a task, etc)
...
defined( 'SCHEDULEACTION_CLASS_VERSION' ) or define( 'SCHEDULEACTION_CLASS_VERSION','0.1' );
...
/** {{*class ScheduleAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ScheduleAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $sameAs                         = null;             /* {*property   $sameAs                         (URL)                           URL of a reference Web page that unambiguously indicates the item's
                                                                                                                                                    ...
                                                                                                                                                    or official website. *} */
    public      $scheduledTime                  = null;             /* {*property   $scheduledTime                  (DateTime)                      The time the object is scheduled to. *} */
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of ScheduleAction.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of ScheduleAction.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class ScheduleAction ====================================================== */
/* ==================================================================================== */
