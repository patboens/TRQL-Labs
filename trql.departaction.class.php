...
/** {{{*fheader
    {*file                  trql.departaction.class.php *}
    {*purpose               The act of departing from a place. An agent departs from an
                            fromLocation for a destination, optionally with
                            participants. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'DEPARTACTION_CLASS_VERSION' ) or define( 'DEPARTACTION_CLASS_VERSION','0.1' );
...
/** {{*class DepartAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/DepartAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of DepartAction.__construct() ========================================== */
    /* ================================================================================ */
