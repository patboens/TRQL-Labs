...
/** {{{*fheader
    {*file                  trql.eventreservation.class.php *}
    {*purpose               A reservation for an event like a concert, sporting event,
                            or lecture.Note: This type is for information about actual
...
/****************************************************************************************/
namespace trql\eventreservation;
...
defined( 'EVENTRESERVATION_CLASS_VERSION' ) or define( 'EVENTRESERVATION_CLASS_VERSION','0.1' );
...
/** {{*class EventReservation=
    ...
    {*desc
        ...
        A reservation for an event like a concert, sporting event, or lecture.Note:
    ...
    *}
    ...
    {*doc [url]http://schema.org/EventReservation[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of EventReservation.__construct() ========================================== */
    /* ================================================================================ */
