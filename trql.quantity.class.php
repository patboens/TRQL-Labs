...
/** {{{*fheader
    {*file                  trql.quantity.class.php *}
    {*purpose               Quantities such as distance, time, mass, weight, etc. 
                            Particular instances of say Mass are entities like '3 Kg' 
                            or '4 milligrams'. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
    {*cdate                 25-08-2020 13:20 *}
    {*mdate                 auto *}
    {*license               {RIGHTS} *}
    {*UTF-8                 Quel bel été *}
...
defined( 'QUANTITY_CLASS_VERSION' ) or define( 'QUANTITY_CLASS_VERSION','0.1' );
...
/** {{*class Quantity=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Quantity[/url] *}
