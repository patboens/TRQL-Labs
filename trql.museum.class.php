...
defined( 'MUSEUM_CLASS_VERSION' ) or define( 'MUSEUM_CLASS_VERSION','0.1' );
...
/** {{*class Museum=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Museum[/url] *}
