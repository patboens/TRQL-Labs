...
/** {{{*fheader
    {*file                  trql.therapeuticprocedure.class.php *}
    {*purpose               A medical procedure intended primarily for therapeutic
    ...
    *}}} */
/****************************************************************************************/
namespace trql\therapeuticprocedure;

use \trql\vaesoli\Vaesoli                   as Vaesoli;
use \trql\medicalprocedure\MedicalProcedure    as MedicalProcedure;


if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'trql.vaesoli.class.php' );

if ( ! defined( 'MEDICALPROCEDURE_CLASS_VERSION' ) )
    require_once( 'trql.medicalprocedure.class.php' );



defined( 'THERAPEUTICPROCEDURE_CLASS_VERSION' ) or define( 'THERAPEUTICPROCEDURE_CLASS_VERSION','0.1' );
...
/** {{*class TherapeuticProcedure=
    ...
    *}
    ...
    {*doc [url]http://schema.org/TherapeuticProcedure[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of TherapeuticProcedure.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of TherapeuticProcedure.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class TherapeuticProcedure ====================================================== */
/* ==================================================================================== */
