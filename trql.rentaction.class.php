...
/** {{{*fheader
    {*file                  trql.rentaction.class.php *}
    {*purpose               The act of giving money in return for temporary use, but not
                            ownership, of an object such as a vehicle or property. For
                            example, an agent rents a property from a landlord in
...
defined( 'RENTACTION_CLASS_VERSION' ) or define( 'RENTACTION_CLASS_VERSION','0.1' );
...
/** {{*class RentAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/RentAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $instrument                     = null;             /* {*property   $instrument                     (Thing)                         The object that helped the agent perform the action. e.g. John wrote a
                                                                                                                                                    book with a pen. *} */
    public      $landlord                       = null;             /* {*property   $landlord                       (Person|Organization)           A sub property of participant. The owner of the real estate property. *} */
    ...
    public      $realEstateAgent                = null;             /* {*property   $realEstateAgent                (RealEstateAgent)               A sub property of participant. The real estate agent involved in the
                                                                                                                                                    action. *} */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of RentAction.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class RentAction ====================================================== */
/* ==================================================================================== */
