...
/** {{{*fheader
    {*file                  trql.wearaction.class.php *}
    {*purpose               The act of dressing oneself in clothing. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
    ...
    *}}} */
/****************************************************************************************/
namespace trql\wearaction;

use \trql\vaesoli\Vaesoli                   as Vaesoli;
use \trql\useaction\UseAction    as UseAction;


if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'trql.vaesoli.class.php' );

if ( ! defined( 'USEACTION_CLASS_VERSION' ) )
    require_once( 'trql.useaction.class.php' );



defined( 'WEARACTION_CLASS_VERSION' ) or define( 'WEARACTION_CLASS_VERSION','0.1' );
...
/** {{*class WearAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/WearAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $actionAccessibilityRequirement = null;             /* {*property   $actionAccessibilityRequirement (ActionAccessSpecification)     A set of requirements that a must be fulfilled in order to perform an
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of WearAction.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class WearAction ====================================================== */
/* ==================================================================================== */
