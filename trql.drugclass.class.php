...
/** {{{*fheader
    {*file                  trql.drugclass.class.php *}
    {*purpose               A class of medical drugs, e.g., statins. Classes can
                            represent general pharmacological class, common mechanisms
...
defined( 'DRUGCLASS_CLASS_VERSION' ) or define( 'DRUGCLASS_CLASS_VERSION','0.1' );
...
/** {{*class DrugClass=
    ...
    *}
    ...
    {*doc [url]http://schema.org/DrugClass[/url] *}
