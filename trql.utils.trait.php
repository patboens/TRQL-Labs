...
/*-------*/
{
    ...
    }   /* End of Utils.isValidURL() ================================================== */
    public function isURL( $szURL ) { return ( $this->isValidURL( $szURL ) ); }
    /* ================================================================================ */
    ...
    */
    // public function XMLToArrayNOTWORKING( $xml,$options = array() )
    // /*-------------------------------------------------*/
    // {
    //     $defaults = array(
