...
/** {{{*fheader
    {*file                  trql.musicstore.class.php *}
    {*purpose               A music store. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'MUSICSTORE_CLASS_VERSION' ) or define( 'MUSICSTORE_CLASS_VERSION','0.1' );
...
/** {{*class MusicStore=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MusicStore[/url] *}
