...
/** {{{*fheader
    {*file                  trql.homegoodsstore.class.php *}
    {*purpose               A home goods store. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'HOMEGOODSSTORE_CLASS_VERSION' ) or define( 'HOMEGOODSSTORE_CLASS_VERSION','0.1' );
...
/** {{*class HomeGoodsStore=
    ...
    *}
    ...
    {*doc [url]http://schema.org/HomeGoodsStore[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of HomeGoodsStore.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->autodoc();
        $this->UIKey();
    }   /* End of HomeGoodsStore.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class HomeGoodsStore ====================================================== */
/* ==================================================================================== */
