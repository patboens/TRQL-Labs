...
/** {{{*fheader
    {*file                  trql.musicvenue.class.php *}
    {*purpose               A music venue. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'MUSICVENUE_CLASS_VERSION' ) or define( 'MUSICVENUE_CLASS_VERSION','0.1' );
...
/** {{*class MusicVenue=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MusicVenue[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of MusicVenue.__destruct() ============================================= */
    /* ================================================================================ */

}   /* End of class MusicVenue ======================================================== */
/* ==================================================================================== */
