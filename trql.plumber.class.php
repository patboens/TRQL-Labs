...
/** {{{*fheader
    {*file                  trql.plumber.class.php *}
    {*purpose               A plumbing service. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'PLUMBER_CLASS_VERSION' ) or define( 'PLUMBER_CLASS_VERSION','0.1' );
...
/** {{*class Plumber=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Plumber[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of Plumber.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class Plumber ====================================================== */
/* ==================================================================================== */
