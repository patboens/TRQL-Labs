...
/** {{{*fheader
    {*file                  trql.resort.class.php *}
    {*purpose               A resort is a place used for relaxation or recreation,
                            attracting visitors for holidays or vacations. Resorts are
                            places, towns or sometimes commercial establishment operated
                            by a single company (Source: Wikipedia, the free
                            encyclopedia, see http://en.wikipedia.org/wiki/Resort).See
                            also the dedicated document on the use of schema.org for
...
defined( 'RESORT_CLASS_VERSION' ) or define( 'RESORT_CLASS_VERSION','0.1' );
...
/** {{*class Resort=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Resort[/url] *}
...
/*--------------------------------*/
{
    ...
    public      $wikidataId                     = 'Q875157';        /* {*property   $wikidataId                     (string)                        Wikidata ID. self-contained commercial establishment 
                                                                                                                                                    which attempts to provide for most of a vacationer's wants *} */
