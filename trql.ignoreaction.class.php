...
/** {{{*fheader
    {*file                  trql.ignoreaction.class.php *}
    {*purpose               The act of intentionally disregarding the object. An agent
                            ignores an object. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'IGNOREACTION_CLASS_VERSION' ) or define( 'IGNOREACTION_CLASS_VERSION','0.1' );
...
/** {{*class IgnoreAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/IgnoreAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of IgnoreAction.__construct() ========================================== */
    /* ================================================================================ */
