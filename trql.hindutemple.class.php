...
/** {{{*fheader
    {*file                  trql.hindutemple.class.php *}
    {*purpose               A Hindu temple. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'HINDUTEMPLE_CLASS_VERSION' ) or define( 'HINDUTEMPLE_CLASS_VERSION','0.1' );
...
/** {{*class HinduTemple=
    ...
    *}
    ...
    {*doc [url]http://schema.org/HinduTemple[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of HinduTemple.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->autodoc();
        $this->UIKey();
    }   /* End of HinduTemple.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class HinduTemple ====================================================== */
/* ==================================================================================== */
