...
/** {{{*fheader
    {*file                  trql.musicreleaseformattype.class.php *}
    {*purpose               Format of this release (the type of recording media used,
                            ie. compact disc, digital media, LP, etc.). *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
    ...
    *}}} */
/****************************************************************************************/
namespace trql\musicreleaseformattype;
...
defined( 'MUSICRELEASEFORMATTYPE_CLASS_VERSION' ) or define( 'MUSICRELEASEFORMATTYPE_CLASS_VERSION','0.1' );
...
/** {{*class MusicReleaseFormatType=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MusicReleaseFormatType[/url] *}
