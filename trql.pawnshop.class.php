...
/** {{{*fheader
    {*file                  trql.pawnshop.class.php *}
    {*purpose               A shop that will buy, or lend money against the security of,
...
defined( 'PAWNSHOP_CLASS_VERSION' ) or define( 'PAWNSHOP_CLASS_VERSION','0.1' );
...
/** {{*class PawnShop=
    ...
    *}
    ...
    {*doc [url]http://schema.org/PawnShop[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of PawnShop.__destruct() =============================================== */
    /* ================================================================================ */
}   /* End of class PawnShop ========================================================== */
/* ==================================================================================== */
?>