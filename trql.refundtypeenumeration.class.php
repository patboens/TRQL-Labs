...
/** {{{*fheader
    {*file                  trql.refundtypeenumeration.class.php *}
    {*purpose               RefundTypeEnumeration enumerates several kinds of product
                            return refund types. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
    ...
    *}}} */
/****************************************************************************************/
namespace trql\refundtypeenumeration;
...
defined( 'REFUNDTYPEENUMERATION_CLASS_VERSION' ) or define( 'REFUNDTYPEENUMERATION_CLASS_VERSION','0.1' );
...
/** {{*class RefundTypeEnumeration=
    ...
    *}
    ...
    {*doc [url]http://schema.org/RefundTypeEnumeration[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of RefundTypeEnumeration.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of RefundTypeEnumeration.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class RefundTypeEnumeration ====================================================== */
/* ==================================================================================== */
