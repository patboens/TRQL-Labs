...
defined( 'TIRESHOP_CLASS_VERSION' ) or define( 'TIRESHOP_CLASS_VERSION','0.1' );
...
/** {{*class TireShop=
    ...
    *}
    ...
    {*doc [url]http://schema.org/TireShop[/url] *}
