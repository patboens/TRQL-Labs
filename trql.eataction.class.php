...
/** {{{*fheader
    {*file                  trql.eataction.class.php *}
    {*purpose               The act of swallowing solid objects. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'EATACTION_CLASS_VERSION' ) or define( 'EATACTION_CLASS_VERSION','0.1' );
...
/** {{*class EatAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/EatAction[/url] *}
