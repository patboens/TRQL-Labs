...
/** {{{*fheader
    {*file                  trql.productcollection.class.php *}
    {*purpose               A set of products (either ProductGroups or specific
...
/** {{*class ProductCollection=
    ...
    {*desc
        ...
        A set of products (either ProductGroups or specific variants) that are
    ...
    *}
    ...
    {*doc [url]http://schema.org/ProductCollection[/url] *}
...
/*-----------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of ProductCollection.__destruct() ====================================== */
    /* ================================================================================ */
