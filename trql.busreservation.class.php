...
/** {{{*fheader
    {*file                  trql.busreservation.class.php *}
    {*purpose               A reservation for bus travel. Note: This type is for
...
defined( 'BUSRESERVATION_CLASS_VERSION' ) or define( 'BUSRESERVATION_CLASS_VERSION','0.1' );
...
/** {{*class BusReservation=
    ...
    {*desc
        ...
        A reservation for bus travel. Note: This type is for information about
    ...
    *}
    ...
    {*doc [url]http://schema.org/BusReservation[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of BusReservation.__construct() ========================================== */
    /* ================================================================================ */
