...
/** {{{*fheader
    {*file                  trql.governmentbenefitstype.class.php *}
    {*purpose               GovernmentBenefitsType enumerates several kinds of
                            government benefits to support the COVID-19 situation. Note
                            that this structure may not capture all benefits offered. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
    ...
    *}}} */
/****************************************************************************************/
namespace trql\governmentbenefitstype;
...
defined( 'GOVERNMENTBENEFITSTYPE_CLASS_VERSION' ) or define( 'GOVERNMENTBENEFITSTYPE_CLASS_VERSION','0.1' );
...
/** {{*class GovernmentBenefitsType=
    ...
    *}
    ...
    {*doc [url]http://schema.org/GovernmentBenefitsType[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of GovernmentBenefitsType.__construct() ========================================== */
    /* ================================================================================ */
