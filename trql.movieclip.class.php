...
/** {{{*fheader
    {*file                  trql.movieclip.class.php *}
    {*purpose               A short segment/part of a movie. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'MOVIECLIP_CLASS_VERSION' ) or define( 'MOVIECLIP_CLASS_VERSION','0.1' );
...
/** {{*class MovieClip=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MovieClip[/url] *}
