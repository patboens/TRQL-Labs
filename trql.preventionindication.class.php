...
/** {{{*fheader
    {*file                  trql.preventionindication.class.php *}
    {*purpose               An indication for preventing an underlying condition,
                            symptom, etc. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
    ...
    *}}} */
/****************************************************************************************/
namespace trql\preventionindication;
...
defined( 'PREVENTIONINDICATION_CLASS_VERSION' ) or define( 'PREVENTIONINDICATION_CLASS_VERSION','0.1' );
...
/** {{*class PreventionIndication=
    ...
    *}
    ...
    {*doc [url]http://schema.org/PreventionIndication[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of PreventionIndication.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of PreventionIndication.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class PreventionIndication ====================================================== */
/* ==================================================================================== */
