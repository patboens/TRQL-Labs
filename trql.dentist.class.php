...
/****************************************************************************************/
namespace trql\dentist;

use \trql\vaesoli\Vaesoli                   as Vaesoli;
use \trql\localbusiness, medicalbusiness, medicalorganization\LocalBusiness, MedicalBusiness, MedicalOrganization    as LocalBusiness, MedicalBusiness, MedicalOrganization;


if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'trql.vaesoli.class.php' );

if ( ! defined( 'LOCALBUSINESS, MEDICALBUSINESS, MEDICALORGANIZATION_CLASS_VERSION' ) )
    require_once( 'trql.localbusiness, medicalbusiness, medicalorganization.class.php' );



defined( 'DENTIST_CLASS_VERSION' ) or define( 'DENTIST_CLASS_VERSION','0.1' );
...
/** {{*class Dentist=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Dentist[/url] *}
 ...
 */
/* ==================================================================================== */
class Dentist extends LocalBusiness, MedicalBusiness, MedicalOrganization
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of Dentist.__destruct() ================================================ */
    /* ================================================================================ */
}   /* End of class Dentist =========================================================== */
/* ==================================================================================== */
?>