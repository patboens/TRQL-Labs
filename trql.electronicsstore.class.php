...
/** {{{*fheader
    {*file                  trql.electronicsstore.class.php *}
    {*purpose               An electronics store. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'ELECTRONICSSTORE_CLASS_VERSION' ) or define( 'ELECTRONICSSTORE_CLASS_VERSION','0.1' );
...
/** {{*class ElectronicsStore=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ElectronicsStore[/url] *}
...
/*--------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of ElectronicsStore.__construct() ====================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of ElectronicsStore.__destruct() ======================================= */
    /* ================================================================================ */
