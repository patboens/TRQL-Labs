...
/** {{{*fheader
    {*file                  trql.campground.class.php *}
    {*purpose               A camping site, campsite, or Campground is a place used for
                            overnight stay in the outdoors, typically containing
                            individual CampingPitch locations. In British English a
                            campsite is an area, usually divided into a number of
                            pitches, where people can camp overnight using tents or
                            camper vans or caravans; this British English use of the
                            word is synonymous with the American English expression
                            campground. In American English the term campsite generally
                            means an area where an individual, family, group, or
                            military unit can pitch a tent or park a camper; a
...
/****************************************************************************************/
namespace trql\campground;

use \trql\vaesoli\Vaesoli                   as Vaesoli;
use \trql\civicstructure, lodgingbusiness\CivicStructure, LodgingBusiness    as CivicStructure, LodgingBusiness;


if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'trql.vaesoli.class.php' );

if ( ! defined( 'CIVICSTRUCTURE, LODGINGBUSINESS_CLASS_VERSION' ) )
    require_once( 'trql.civicstructure, lodgingbusiness.class.php' );



defined( 'CAMPGROUND_CLASS_VERSION' ) or define( 'CAMPGROUND_CLASS_VERSION','0.1' );
...
/** {{*class Campground=
    ...
    {*desc
        ...
        in the outdoors, typically containing individual CampingPitch locations. In
        British English a campsite is an area, usually divided into a number of
    ...
    *}
    ...
    {*doc [url]http://schema.org/Campground[/url] *}
 ...
 */
/* ==================================================================================== */
class Campground extends CivicStructure, LodgingBusiness
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of Campground.__destruct() ============================================= */
    /* ================================================================================ */
}   /* End of class Campground ======================================================== */
/* ==================================================================================== */
