...
/** {{{*fheader
    {*file                  trql.tipaction.class.php *}
    {*purpose               The act of giving money voluntarily to a beneficiary in
...
defined( 'TIPACTION_CLASS_VERSION' ) or define( 'TIPACTION_CLASS_VERSION','0.1' );
...
/** {{*class TipAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/TipAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of TipAction.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class TipAction ====================================================== */
/* ==================================================================================== */
