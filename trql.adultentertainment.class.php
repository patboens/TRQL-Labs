...
/** {{{*fheader
    {*file                  trql.adultentertainment.class.php *}
    {*purpose               An adult entertainment establishment. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
    ...
    *}}} */
/****************************************************************************************/
namespace trql\adultentertainment;
...
defined( 'ADULTENTERTAINMENT_CLASS_VERSION' ) or define( 'ADULTENTERTAINMENT_CLASS_VERSION','0.1' );
...
/** {{*class AdultEntertainment=
    ...
    *}
    ...
    {*doc [url]http://schema.org/AdultEntertainment[/url] *}
...
/*--------------------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of AdultEntertainment.__construct() ==================================== */
    /* ================================================================================ */
