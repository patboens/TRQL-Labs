...
/** {{{*fheader
    {*file                  trql.conveniencestore.class.php *}
    {*purpose               A convenience store. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'CONVENIENCESTORE_CLASS_VERSION' ) or define( 'CONVENIENCESTORE_CLASS_VERSION','0.1' );
...
/** {{*class ConvenienceStore=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ConvenienceStore[/url] *}
...
/*--------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of ConvenienceStore.__construct() ====================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of ConvenienceStore.__destruct() ======================================= */
    /* ================================================================================ */
