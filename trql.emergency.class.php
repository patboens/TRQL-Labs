...
/** {{{*fheader
    {*file                  trql.emergency.class.php *}
    {*purpose               A specific branch of medical science that deals with the
                            evaluation and initial treatment of medical conditions
...
defined( 'EMERGENCY_CLASS_VERSION' ) or define( 'EMERGENCY_CLASS_VERSION','0.1' );
...
/** {{*class Emergency=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Emergency[/url] *}
