...
/** {{{*fheader
    {*file                  trql.bookseries.class.php *}
    {*purpose               A series of books. Included books can be indicated with the
                            hasPart property. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
/** {{*class BookSeries=
    ...
    *}
    ...
    {*doc [url]http://schema.org/BookSeries[/url] *}
...
/*---------------------------------------*/
{
    ...
    public      $wikidataId                     = 'Q277759';        /* {*property   $wikidataId                     (string)                        Wikidata ID. sequence of books having certain 
                                                                                                                                                    characteristics in common that are formally 
                                                                                                                                                    identified together as a group *} */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of BookSeries.__destruct() ============================================= */
    /* ================================================================================ */
}   /* End of class BookSeries ======================================================== */
/* ==================================================================================== */
?>