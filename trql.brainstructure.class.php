...
/** {{{*fheader
    {*file                  trql.brainstructure.class.php *}
    {*purpose               Any anatomical structure which pertains to the soft nervous
                            tissue functioning as the coordinating center of sensation
...
defined( 'BRAINSTRUCTURE_CLASS_VERSION' ) or define( 'BRAINSTRUCTURE_CLASS_VERSION','0.1' );
...
/** {{*class BrainStructure=
    ...
    *}
    ...
    {*doc [url]http://schema.org/BrainStructure[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of BrainStructure.__construct() ========================================== */
    /* ================================================================================ */
