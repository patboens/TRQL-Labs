...
/** {{{*fheader
    {*file                  trql.confirmaction.class.php *}
    {*purpose               The act of notifying someone that a future event/action is
                            going to happen as expected.Related actions:CancelAction:
...
/** {{*class ConfirmAction=
    ...
    {*desc
        ...
        as expected.Related actions:CancelAction: The antonym of ConfirmAction.
    ...
    *}
    ...
    {*doc [url]http://schema.org/ConfirmAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of ConfirmAction.__construct() ========================================== */
    /* ================================================================================ */
