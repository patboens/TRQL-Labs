...
/** {{{*fheader
    {*file                  trql.searchresultspage.class.php *}
    {*purpose               Web page type: Search results page. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'SEARCHRESULTSPAGE_CLASS_VERSION' ) or define( 'SEARCHRESULTSPAGE_CLASS_VERSION','0.1' );
...
/** {{*class SearchResultsPage=
    ...
    *}
    ...
    {*doc [url]http://schema.org/SearchResultsPage[/url] *}
...
/*-----------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of SearchResultsPage.__destruct() ====================================== */
    /* ================================================================================ */
