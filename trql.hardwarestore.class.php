...
/** {{{*fheader
    {*file                  trql.hardwarestore.class.php *}
    {*purpose               A hardware store. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'HARDWARESTORE_CLASS_VERSION' ) or define( 'HARDWARESTORE_CLASS_VERSION','0.1' );
...
/** {{*class HardwareStore=
    ...
    *}
    ...
    {*doc [url]http://schema.org/HardwareStore[/url] *}
...
/*-----------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of HardwareStore.__construct() ========================================= */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of HardwareStore.__destruct() ========================================== */
    /* ================================================================================ */
