...
/** {{{*fheader
    {*file                  trql.skiresort.class.php *}
    {*purpose               A ski resort. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'SKIRESORT_CLASS_VERSION' ) or define( 'SKIRESORT_CLASS_VERSION','0.1' );
...
/** {{*class SkiResort=
    ...
    *}
    ...
    {*doc [url]http://schema.org/SkiResort[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of SkiResort.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class SkiResort ====================================================== */
/* ==================================================================================== */
