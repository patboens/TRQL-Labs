...
/** {{{*fheader
    {*file                  trql.donateaction.class.php *}
    {*purpose               The act of providing goods, services, or money without
...
defined( 'DONATEACTION_CLASS_VERSION' ) or define( 'DONATEACTION_CLASS_VERSION','0.1' );
...
/** {{*class DonateAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/DonateAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of DonateAction.__construct() ========================================== */
    /* ================================================================================ */
