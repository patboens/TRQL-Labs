...
/** {{{*fheader
    {*file                  trql.cancelaction.class.php *}
    {*purpose               The act of asserting that a future event/action is no longer
                            going to happen.Related actions:ConfirmAction: The antonym
                            of CancelAction. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'CANCELACTION_CLASS_VERSION' ) or define( 'CANCELACTION_CLASS_VERSION','0.1' );
...
/** {{*class CancelAction=
    ...
    {*desc
        ...
        happen.Related actions:ConfirmAction: The antonym of CancelAction.
    ...
    *}
    ...
    {*doc [url]http://schema.org/CancelAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of CancelAction.__construct() ========================================== */
    /* ================================================================================ */
