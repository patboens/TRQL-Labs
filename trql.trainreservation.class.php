...
/** {{{*fheader
    {*file                  trql.trainreservation.class.php *}
    {*purpose               A reservation for train travel.Note: This type is for
    ...
    *}}} */
/****************************************************************************************/
namespace trql\trainreservation;
...
defined( 'TRAINRESERVATION_CLASS_VERSION' ) or define( 'TRAINRESERVATION_CLASS_VERSION','0.1' );
...
/** {{*class TrainReservation=
    ...
    {*desc
        ...
        A reservation for train travel.Note: This type is for information about
    ...
    *}
    ...
    {*doc [url]http://schema.org/TrainReservation[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of TrainReservation.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of TrainReservation.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class TrainReservation ====================================================== */
/* ==================================================================================== */
