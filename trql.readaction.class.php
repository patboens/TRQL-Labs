...
/** {{{*fheader
    {*file                  trql.readaction.class.php *}
    {*purpose               The act of consuming written content. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'READACTION_CLASS_VERSION' ) or define( 'READACTION_CLASS_VERSION','0.1' );
...
/** {{*class ReadAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ReadAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of ReadAction.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class ReadAction ====================================================== */
/* ==================================================================================== */
