...
/** {{{*fheader
    {*file                  trql.energy.class.php *}
    {*purpose               Properties that take Energy as values are of the form
...
defined( 'ENERGY_CLASS_VERSION' ) or define( 'ENERGY_CLASS_VERSION','0.1' );
...
/** {{*class Energy=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Energy[/url] *}
