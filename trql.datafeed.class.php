...
/*--------------------------------------*/
{
    ...
    public      $catalog                        = null;             /* {*property   $catalog                        (DataCatalog)                   A data catalog which contains this dataset. *} */
    ...
    public      $dataFeedElement                = null;             /* {*property   $dataFeedElement                (string|DataFeedItem|Thing)     An item within in a data feed. Data feeds may have many elements. *} */
    public      $datasetTimeInterval            = null;             /* {*property   $datasetTimeInterval            (DateTime)                      The range of temporal applicability of a dataset, e.g. for a 2011
    ...
    public      $includedDataCatalog            = null;             /* {*property   $includedDataCatalog            (DataCatalog)                   A data catalog which contains this dataset (this property was
                                                                                                                                                    previously 'catalog', preferred name is now 'includedInDataCatalog'). *} */
