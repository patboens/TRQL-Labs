...
/** {{{*fheader
    {*file                  trql.datafeed.class.php *}
    {*purpose               A single feed providing structured information about one or
                            more entities or topics. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'DATAFEED_CLASS_VERSION' ) or define( 'DATAFEED_CLASS_VERSION','0.1' );
