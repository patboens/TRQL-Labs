...
/** {{{*fheader
    {*file                  trql.investmentordeposit.class.php *}
    {*purpose               A type of financial product that typically requires the
                            client to transfer funds to a financial service in return
...
defined( 'INVESTMENTORDEPOSIT_CLASS_VERSION' ) or define( 'INVESTMENTORDEPOSIT_CLASS_VERSION','0.1' );
...
/** {{*class InvestmentOrDeposit=
    ...
    *}
    ...
    {*doc [url]http://schema.org/InvestmentOrDeposit[/url] *}
...
}   /* End of class InvestmentOrDeposit ====================================================== */
/* ==================================================================================== */
