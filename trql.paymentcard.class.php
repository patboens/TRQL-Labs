...
use \trql\financialproduct, paymentmethod\FinancialProduct, PaymentMethod    as FinancialProduct, PaymentMethod;


if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'trql.vaesoli.class.php' );

if ( ! defined( 'FINANCIALPRODUCT, PAYMENTMETHOD_CLASS_VERSION' ) )
    require_once( 'trql.financialproduct, paymentmethod.class.php' );
 ...
 */
/* ==================================================================================== */
class PaymentCard extends FinancialProduct, PaymentMethod
/*--------------------------------------*/
{
