...
/*--------------------------------------*/
{
    ...
    public      $runtime                        = null;             /* {*property   $runtime                        (string)                        Runtime platform or script interpreter dependencies (Example - Java
    ...
    public      $sameAs                         = null;             /* {*property   $sameAs                         (URL)                           URL of a reference Web page that unambiguously indicates the item's
                                                                                                                                                    ...
                                                                                                                                                    or official website. *} */
    public      $sampleType                     = null;             /* {*property   $sampleType                     (string)                        What type of code sample: full (compile ready) solution, code snippet,
                                                                                                                                                    inline code, scripts, template. *} */
