...
/** {{{*fheader
    {*file                  trql.fundingagency.class.php *}
    {*purpose               A FundingAgency is an organization that implements one or
                            more FundingSchemes and manages the granting process (via
                            Grants, typically MonetaryGrants). A funding agency is not
                            always required for grant funding, e.g. philanthropic
                            giving, corporate sponsorship etc.Examples of funding
                            agencies include ERC, REA, NIH, Bill and Melinda Gates
                            Foundation... *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'FUNDINGAGENCY_CLASS_VERSION' ) or define( 'FUNDINGAGENCY_CLASS_VERSION','0.1' );
...
/** {{*class FundingAgency=
    ...
    {*desc
        ...
        FundingSchemes and manages the granting process (via Grants, typically
    ...
    *}
    ...
    {*doc [url]http://schema.org/FundingAgency[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of FundingAgency.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->autodoc();
        $this->UIKey();
    }   /* End of FundingAgency.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class FundingAgency ====================================================== */
/* ==================================================================================== */
