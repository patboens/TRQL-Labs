...
/** {{{*fheader
    {*file                  trql.nightclub.class.php *}
    {*purpose               A nightclub or discotheque. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'NIGHTCLUB_CLASS_VERSION' ) or define( 'NIGHTCLUB_CLASS_VERSION','0.1' );
...
/** {{*class NightClub=
    ...
    *}
    ...
    {*doc [url]http://schema.org/NightClub[/url] *}
...
/*-----------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of NightClub.__destruct() ============================================== */
    /* ================================================================================ */
}   /* End of class NightClub ========================================================= */
/* ==================================================================================== */
?>