...
/** {{{*fheader
    {*file                  trql.shoestore.class.php *}
    {*purpose               A shoe store. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'SHOESTORE_CLASS_VERSION' ) or define( 'SHOESTORE_CLASS_VERSION','0.1' );
...
/** {{*class ShoeStore=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ShoeStore[/url] *}
