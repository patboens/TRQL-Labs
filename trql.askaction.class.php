...
/** {{{*fheader
    {*file                  trql.askaction.class.php *}
    {*purpose               The act of posing a question / favor to someone.Related
                            actions:ReplyAction: Appears generally as a response to
                            AskAction. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'ASKACTION_CLASS_VERSION' ) or define( 'ASKACTION_CLASS_VERSION','0.1' );
...
/** {{*class AskAction=
    ...
    {*desc
        ...
        The act of posing a question / favor to someone.Related
    ...
    *}
    ...
    {*doc [url]http://schema.org/AskAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $question                       = null;             /* {*property   $question                       (Question)                      A sub property of object. A question. *} */
