...
/** {{{*fheader
    {*file                  trql.imagingtest.class.php *}
...
defined( 'IMAGINGTEST_CLASS_VERSION' ) or define( 'IMAGINGTEST_CLASS_VERSION','0.1' );
...
/** {{*class ImagingTest=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ImagingTest[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $image                          = null;             /* {*property   $image                          (ImageObject|URL)               An image of the item. This can be a URL or a fully described
                                                                                                                                                    ImageObject. *} */
    public      $imagingTechnique               = null;             /* {*property   $imagingTechnique               (MedicalImagingTechnique)       Imaging technique used. *} */
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of ImagingTest.__construct() ========================================== */
    /* ================================================================================ */
