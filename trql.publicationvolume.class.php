...
/** {{{*fheader
    {*file                  trql.publicationvolume.class.php *}
    {*purpose               A part of a successively published publication such as a
                            periodical or multi-volume work, often numbered. It may
                            represent a time span, such as a year.See also blog post. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
    ...
    *}}} */
/****************************************************************************************/
namespace trql\publicationvolume;
...
defined( 'PUBLICATIONVOLUME_CLASS_VERSION' ) or define( 'PUBLICATIONVOLUME_CLASS_VERSION','0.1' );
...
/** {{*class PublicationVolume=
    ...
    *}
    ...
    {*doc [url]http://schema.org/PublicationVolume[/url] *}
...
/*----------------------------------------*/
{
    ...
    public      $volumeNumber                   = null;             /* {*property   $volumeNumber                   (string|int)                    Identifies the volume of publication or multi-part work; for example,
                                                                                                                                                    "iii" or "2". *} */
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of PublicationVolume.__construct() ===================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of PublicationVolume.__destruct() ====================================== */
    /* ================================================================================ */
}   /* End of class PublicationVolume ================================================= */
/* ==================================================================================== */
?>