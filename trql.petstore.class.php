...
defined( 'PETSTORE_CLASS_VERSION' ) or define( 'PETSTORE_CLASS_VERSION','0.1' );
...
/** {{*class PetStore=
    ...
    *}
    ...
    {*doc [url]http://schema.org/PetStore[/url] *}
