...
/** {{{*fheader
    {*file                  trql.joint.class.php *}
    {*purpose               The anatomical location at which two or more bones make
                            contact. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'JOINT_CLASS_VERSION' ) or define( 'JOINT_CLASS_VERSION','0.1' );
...
/** {{*class Joint=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Joint[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $biomechnicalClass              = null;             /* {*property   $biomechnicalClass              (string)                        The biomechanical properties of the bone. *} */
    ...
    public      $functionalClass                = null;             /* {*property   $functionalClass                (MedicalEntity|string)          The degree of mobility the joint allows. *} */
    ...
    public      $sameAs                         = null;             /* {*property   $sameAs                         (URL)                           URL of a reference Web page that unambiguously indicates the item's
                                                                                                                                                    ...
                                                                                                                                                    or official website. *} */
    public      $structuralClass                = null;             /* {*property   $structuralClass                (string)                        The name given to how bone physically connects to each other. *} */
