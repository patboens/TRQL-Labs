...
/** {{{*fheader
    {*file                  trql.sculpture.class.php *}
    {*purpose               A piece of sculpture. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'SCULPTURE_CLASS_VERSION' ) or define( 'SCULPTURE_CLASS_VERSION','0.1' );
...
/** {{*class Sculpture=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Sculpture[/url] *}
...
/*---------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of Sculpture.__destruct() ============================================== */
    /* ================================================================================ */
}   /* End of class Sculpture ========================================================= */
/* ==================================================================================== */
?>