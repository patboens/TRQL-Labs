...
/** {{{*fheader
    {*file                  trql.electrician.class.php *}
    {*purpose               An electrician. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'ELECTRICIAN_CLASS_VERSION' ) or define( 'ELECTRICIAN_CLASS_VERSION','0.1' );
...
/** {{*class Electrician=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Electrician[/url] *}
...
/*-------------------------------------------------*/
{
    ...
    public      $wikidataId         = 'Q17030553';                  /* {*property   $wikidataId                     (string)                        Wikidata ID. Tradesperson specializing in electrical 
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of Electrician.__construct() =========================================== */
    /* ================================================================================ */
