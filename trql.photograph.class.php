...
/** {{{*fheader
    {*file                  trql.photograph.class.php *}
    {*purpose               A photograph. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'PHOTOGRAPH_CLASS_VERSION' ) or define( 'PHOTOGRAPH_CLASS_VERSION','0.1' );
...
/** {{*class Photograph=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Photograph[/url] *}
