...
/** {{{*fheader
    {*file                  trql.sportsclub.class.php *}
    {*purpose               A sports club. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'SPORTSCLUB_CLASS_VERSION' ) or define( 'SPORTSCLUB_CLASS_VERSION','0.1' );
...
/** {{*class SportsClub=
    ...
    *}
    ...
    {*doc [url]http://schema.org/SportsClub[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of SportsClub.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class SportsClub ====================================================== */
/* ==================================================================================== */
