...
/** {{{*fheader
    {*file                  trql.userblocks.class.php *}
...
defined( 'USERBLOCKS_CLASS_VERSION' ) or define( 'USERBLOCKS_CLASS_VERSION','0.1' );
...
/** {{*class UserBlocks=
    ...
    *}
    ...
    {*doc [url]http://schema.org/UserBlocks[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of UserBlocks.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class UserBlocks ====================================================== */
/* ==================================================================================== */
