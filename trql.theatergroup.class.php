...
/** {{{*fheader
    {*file                  trql.theatergroup.class.php *}
    {*purpose               A theater group or company, for example, the Royal
...
defined( 'THEATERGROUP_CLASS_VERSION' ) or define( 'THEATERGROUP_CLASS_VERSION','0.1' );
...
/** {{*class TheaterGroup=
    ...
    *}
    ...
    {*doc [url]http://schema.org/TheaterGroup[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $wikidataId                     = 'Q2416217';       /* {*property   $wikidataId                     (string)                        Wikidata ID. Theatre troupe ... organized group that 
                                                                                                                                                    plays theatre *} */
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of TheaterGroup.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of TheaterGroup.__destruct() =========================================== */
    /* ================================================================================ */
