...
/** {{{*fheader
    {*file                  trql.itemlistordertype.class.php *}
    {*purpose               Enumerated for values for itemListOrder for indicating how
                            an ordered ItemList is organized. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
/****************************************************************************************/
namespace trql\itemlistordertype;
...
defined( 'ITEMLISTORDERTYPE_CLASS_VERSION' ) or define( 'ITEMLISTORDERTYPE_CLASS_VERSION','0.1' );
...
/** {{*class ItemListOrderType=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ItemListOrderType[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of ItemListOrderType.__construct() ========================================== */
    /* ================================================================================ */
...
}   /* End of class ItemListOrderType ====================================================== */
/* ==================================================================================== */
