...
use \trql\event, series\Event, Series    as Event, Series;


if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'trql.vaesoli.class.php' );

if ( ! defined( 'EVENT, SERIES_CLASS_VERSION' ) )
    require_once( 'trql.event, series.class.php' );
 ...
 */
/* ==================================================================================== */
class EventSeries extends Event, Series
/*--------------------------------------*/
{
