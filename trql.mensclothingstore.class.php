...
/** {{{*fheader
    {*file                  trql.mensclothingstore.class.php *}
    {*purpose               A men's clothing store. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
    ...
    *}}} */
/****************************************************************************************/
namespace trql\mensclothingstore;
...
defined( 'MENSCLOTHINGSTORE_CLASS_VERSION' ) or define( 'MENSCLOTHINGSTORE_CLASS_VERSION','0.1' );
...
/** {{*class MensClothingStore=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MensClothingStore[/url] *}
