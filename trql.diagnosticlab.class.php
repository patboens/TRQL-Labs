...
/** {{{*fheader
    {*file                  trql.diagnosticlab.class.php *}
    {*purpose               A medical laboratory that offers on-site or off-site
                            diagnostic services. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
/****************************************************************************************/
namespace trql\diagnosticlab;

use \trql\vaesoli\Vaesoli                   as Vaesoli;
use \trql\medicalorganization\MedicalOrganization    as MedicalOrganization;


if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'trql.vaesoli.class.php' );

if ( ! defined( 'MEDICALORGANIZATION_CLASS_VERSION' ) )
    require_once( 'trql.medicalorganization.class.php' );



defined( 'DIAGNOSTICLAB_CLASS_VERSION' ) or define( 'DIAGNOSTICLAB_CLASS_VERSION','0.1' );
...
/** {{*class DiagnosticLab=
    ...
    *}
    ...
    {*doc [url]http://schema.org/DiagnosticLab[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $availableTest                  = null;             /* {*property   $availableTest                  (MedicalTest)                   A diagnostic test or procedure offered by this lab. *} */
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of DiagnosticLab.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->autodoc();
        $this->UIKey();
    }   /* End of DiagnosticLab.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class DiagnosticLab ====================================================== */
/* ==================================================================================== */
