...
/** {{{*fheader
    {*file                  trql.quoteaction.class.php *}
    {*purpose               An agent quotes/estimates/appraises an
                            object/product/service with a price at a location/store. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'QUOTEACTION_CLASS_VERSION' ) or define( 'QUOTEACTION_CLASS_VERSION','0.1' );
...
/** {{*class QuoteAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/QuoteAction[/url] *}
