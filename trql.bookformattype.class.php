...
/** {{{*fheader
    {*file                  trql.bookformattype.class.php *}
    {*purpose               The publication format of the book. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'BOOKFORMATTYPE_CLASS_VERSION' ) or define( 'BOOKFORMATTYPE_CLASS_VERSION','0.1' );
...
/** {{*class BookFormatType=
    ...
    *}
    ...
    {*doc [url]http://schema.org/BookFormatType[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of BookFormatType.__construct() ========================================== */
    /* ================================================================================ */
