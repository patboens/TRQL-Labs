...
/** {{{*fheader
    {*file                  trql.oceanbodyofwater.class.php *}
    {*purpose               An ocean (for example, the Pacific). *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'OCEANBODYOFWATER_CLASS_VERSION' ) or define( 'OCEANBODYOFWATER_CLASS_VERSION','0.1' );
...
/** {{*class OceanBodyOfWater=
    ...
    *}
    ...
    {*doc [url]http://schema.org/OceanBodyOfWater[/url] *}
