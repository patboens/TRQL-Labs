...
/** {{{*fheader
    {*file                  trql.medicalcontraindication.class.php *}
    {*purpose               A condition or factor that serves as a reason to withhold a
...
/****************************************************************************************/
namespace trql\medicalcontraindication;
...
defined( 'MEDICALCONTRAINDICATION_CLASS_VERSION' ) or define( 'MEDICALCONTRAINDICATION_CLASS_VERSION','0.1' );
...
/** {{*class MedicalContraindication=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MedicalContraindication[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of MedicalContraindication.__construct() ========================================== */
    /* ================================================================================ */
...
}   /* End of class MedicalContraindication ====================================================== */
/* ==================================================================================== */
