...
/** {{{*fheader
    {*file                  trql.canal.class.php *}
    {*purpose               A canal, like the Panama Canal. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'CANAL_CLASS_VERSION' ) or define( 'CANAL_CLASS_VERSION','0.1' );
...
/** {{*class Canal=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Canal[/url] *}
