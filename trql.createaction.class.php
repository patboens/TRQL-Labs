...
/** {{{*fheader
    {*file                  trql.createaction.class.php *}
    {*purpose               The act of deliberately
                            creating/producing/generating/building a result out of the
                            agent. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'CREATEACTION_CLASS_VERSION' ) or define( 'CREATEACTION_CLASS_VERSION','0.1' );
...
/** {{*class CreateAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/CreateAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of CreateAction.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of CreateAction.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class CreateAction ====================================================== */
/* ==================================================================================== */
