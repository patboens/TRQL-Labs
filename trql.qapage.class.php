...
/** {{{*fheader
    {*file                  trql.qapage.class.php *}
    {*purpose               A QAPage is a WebPage focussed on a specific Question and
                            its Answer(s), e.g. in a question answering site or
...
/** {{*class QAPage=
    ...
    *}
    ...
    {*doc [url]http://schema.org/QAPage[/url] *}
