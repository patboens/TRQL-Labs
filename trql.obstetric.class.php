...
/** {{{*fheader
    {*file                  trql.obstetric.class.php *}
    {*purpose               A specific branch of medical science that specializes in the
                            care of women during the prenatal and postnatal care and
...
defined( 'OBSTETRIC_CLASS_VERSION' ) or define( 'OBSTETRIC_CLASS_VERSION','0.1' );
...
/** {{*class Obstetric=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Obstetric[/url] *}
