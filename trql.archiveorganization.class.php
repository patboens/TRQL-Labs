...
/** {{{*fheader
    {*file                  trql.archiveorganization.class.php *}
    {*purpose               An organization with archival holdings. An organization
                            which keeps and preserves archival material and typically
...
/****************************************************************************************/
namespace trql\archiveorganization;
...
defined( 'ARCHIVEORGANIZATION_CLASS_VERSION' ) or define( 'ARCHIVEORGANIZATION_CLASS_VERSION','0.1' );
...
/** {{*class ArchiveOrganization=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ArchiveOrganization[/url] *}
...
/*-------------------------------------------*/
{
    ...
    public      $archiveHeld                    = null;             /* {*property   $archiveHeld                    (ArchiveComponent)              Collection, fonds, or item held, kept or maintained by an
                                                                                                                                                    ArchiveOrganization. *} */
