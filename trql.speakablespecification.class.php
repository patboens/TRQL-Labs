...
/** {{{*fheader
    {*file                  trql.speakablespecification.class.php *}
    {*purpose               A SpeakableSpecification indicates (typically via xpath or
    ...
    *}}} */
/****************************************************************************************/
namespace trql\speakablespecification;
...
defined( 'SPEAKABLESPECIFICATION_CLASS_VERSION' ) or define( 'SPEAKABLESPECIFICATION_CLASS_VERSION','0.1' );
...
/** {{*class SpeakableSpecification=
    ...
    *}
    ...
    {*doc [url]http://schema.org/SpeakableSpecification[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of SpeakableSpecification.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of SpeakableSpecification.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class SpeakableSpecification ====================================================== */
/* ==================================================================================== */
