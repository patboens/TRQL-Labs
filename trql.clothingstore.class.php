...
/** {{{*fheader
    {*file                  trql.clothingstore.class.php *}
    {*purpose               A clothing store. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'CLOTHINGSTORE_CLASS_VERSION' ) or define( 'CLOTHINGSTORE_CLASS_VERSION','0.1' );
...
/** {{*class ClothingStore=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ClothingStore[/url] *}
...
/*------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of ClothingStore.__destruct() ========================================== */
    /* ================================================================================ */
