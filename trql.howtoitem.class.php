...
/** {{{*fheader
    {*file                  trql.howtoitem.class.php *}
    {*purpose               An item used as either a tool or supply when performing the
...
/****************************************************************************************/
namespace trql\howtoitem;

use \trql\vaesoli\Vaesoli                   as Vaesoli;
use \trql\listitem\ListItem    as ListItem;


if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'trql.vaesoli.class.php' );

if ( ! defined( 'LISTITEM_CLASS_VERSION' ) )
    require_once( 'trql.listitem.class.php' );



defined( 'HOWTOITEM_CLASS_VERSION' ) or define( 'HOWTOITEM_CLASS_VERSION','0.1' );
...
/** {{*class HowToItem=
    ...
    *}
    ...
    {*doc [url]http://schema.org/HowToItem[/url] *}
