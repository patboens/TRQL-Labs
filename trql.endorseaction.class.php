...
/** {{{*fheader
    {*file                  trql.endorseaction.class.php *}
    {*purpose               An agent approves/certifies/likes/supports/sanction an
                            object. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'ENDORSEACTION_CLASS_VERSION' ) or define( 'ENDORSEACTION_CLASS_VERSION','0.1' );
...
/** {{*class EndorseAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/EndorseAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $endorsee                       = null;             /* {*property   $endorsee                       (Person|Organization)           A sub property of participant. The person/organization being
                                                                                                                                                    supported. *} */
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of EndorseAction.__construct() ========================================== */
    /* ================================================================================ */
