...
/** {{{*fheader
    {*file                  trql.menu.class.php *}
    {*purpose               A structured representation of food or drink items available
...
defined( 'MENU_CLASS_VERSION' ) or define( 'MENU_CLASS_VERSION','0.1' );
...
/** {{*class Menu=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Menu[/url] *}
