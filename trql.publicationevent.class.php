...
/** {{{*fheader
    {*file                  trql.publicationevent.class.php *}
    {*purpose               A PublicationEvent corresponds indifferently to the event of
    ...
    *}}} */
/****************************************************************************************/
namespace trql\publicationevent;
...
defined( 'PUBLICATIONEVENT_CLASS_VERSION' ) or define( 'PUBLICATIONEVENT_CLASS_VERSION','0.1' );
...
/** {{*class PublicationEvent=
    ...
    *}
    ...
    {*doc [url]http://schema.org/PublicationEvent[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $free                           = null;             /* {*property   $free                           (boolean)                       A flag to signal that the item, event, or place is accessible for
                                                                                                                                                    free. *} */
    ...
    public      $previousStartDate              = null;             /* {*property   $previousStartDate              (Date)                          Used in conjunction with eventStatus for rescheduled or cancelled
                                                                                                                                                    ...
                                                                                                                                                    repeated. *} */
    public      $publishedBy                    = null;             /* {*property   $publishedBy                    (Organization|Person)           An agent associated with the publication event. *} */
    public      $publishedOn                    = null;             /* {*property   $publishedOn                    (BroadcastService)              A broadcast service associated with the publication event. *} */
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of PublicationEvent.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of PublicationEvent.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class PublicationEvent ====================================================== */
/* ==================================================================================== */
