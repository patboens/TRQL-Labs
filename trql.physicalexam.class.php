...
/** {{{*fheader
    {*file                  trql.physicalexam.class.php *}
    {*purpose               A type of physical examination of a patient performed by a
                            physician. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
    ...
    *}}} */
/****************************************************************************************/
namespace trql\physicalexam;

use \trql\vaesoli\Vaesoli                   as Vaesoli;
use \trql\medicalenumeration, medicalprocedure\MedicalEnumeration, MedicalProcedure    as MedicalEnumeration, MedicalProcedure;


if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'trql.vaesoli.class.php' );

if ( ! defined( 'MEDICALENUMERATION, MEDICALPROCEDURE_CLASS_VERSION' ) )
    require_once( 'trql.medicalenumeration, medicalprocedure.class.php' );



defined( 'PHYSICALEXAM_CLASS_VERSION' ) or define( 'PHYSICALEXAM_CLASS_VERSION','0.1' );
...
/** {{*class PhysicalExam=
    ...
    *}
    ...
    {*doc [url]http://schema.org/PhysicalExam[/url] *}
 ...
 */
/* ==================================================================================== */
class PhysicalExam extends MedicalEnumeration, MedicalProcedure
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of PhysicalExam.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of PhysicalExam.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class PhysicalExam ====================================================== */
/* ==================================================================================== */
