...
/** {{{*fheader
    {*file                  trql.occupationaltherapy.class.php *}
    {*purpose               A treatment of people with physical, emotional, or social
    ...
    *}}} */
/****************************************************************************************/
namespace trql\occupationaltherapy;
...
defined( 'OCCUPATIONALTHERAPY_CLASS_VERSION' ) or define( 'OCCUPATIONALTHERAPY_CLASS_VERSION','0.1' );
...
/** {{*class OccupationalTherapy=
    ...
    *}
    ...
    {*doc [url]http://schema.org/OccupationalTherapy[/url] *}
