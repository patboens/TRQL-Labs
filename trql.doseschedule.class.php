...
/** {{{*fheader
    {*file                  trql.doseschedule.class.php *}
    {*purpose               A specific dosing schedule for a drug or supplement. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'DOSESCHEDULE_CLASS_VERSION' ) or define( 'DOSESCHEDULE_CLASS_VERSION','0.1' );
...
/** {{*class DoseSchedule=
    ...
    *}
    ...
    {*doc [url]http://schema.org/DoseSchedule[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of DoseSchedule.__construct() ========================================== */
    /* ================================================================================ */
