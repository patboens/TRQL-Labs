...
/** {{{*fheader
    {*file                  trql.selfstorage.class.php *}
    {*purpose               A self-storage facility. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'SELFSTORAGE_CLASS_VERSION' ) or define( 'SELFSTORAGE_CLASS_VERSION','0.1' );
...
/** {{*class SelfStorage=
    ...
    *}
    ...
    {*doc [url]http://schema.org/SelfStorage[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of SelfStorage.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of SelfStorage.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class SelfStorage ====================================================== */
/* ==================================================================================== */
