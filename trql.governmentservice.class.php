...
/** {{{*fheader
    {*file                  trql.governmentservice.class.php *}
    {*purpose               A service provided by a government organization, e.g. food
    ...
    *}}} */
/****************************************************************************************/
namespace trql\governmentservice;
...
defined( 'GOVERNMENTSERVICE_CLASS_VERSION' ) or define( 'GOVERNMENTSERVICE_CLASS_VERSION','0.1' );
...
/** {{*class GovernmentService=
    ...
    *}
    ...
    {*doc [url]http://schema.org/GovernmentService[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $serviceOperator                = null;             /* {*property   $serviceOperator                (Organization)                  The operating organization, if different from the provider. This
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of GovernmentService.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->autodoc();
        $this->UIKey();
    }   /* End of GovernmentService.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class GovernmentService ====================================================== */
/* ==================================================================================== */
