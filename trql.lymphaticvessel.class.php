...
/** {{{*fheader
    {*file                  trql.lymphaticvessel.class.php *}
    {*purpose               A type of blood vessel that specifically carries lymph fluid
...
/****************************************************************************************/
namespace trql\lymphaticvessel;
...
defined( 'LYMPHATICVESSEL_CLASS_VERSION' ) or define( 'LYMPHATICVESSEL_CLASS_VERSION','0.1' );
...
/** {{*class LymphaticVessel=
    ...
    *}
    ...
    {*doc [url]http://schema.org/LymphaticVessel[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $originatesFrom                 = null;             /* {*property   $originatesFrom                 (Vessel)                        The vasculature the lymphatic structure originates, or afferents,
                                                                                                                                                    from. *} */
    ...
    public      $runsTo                         = null;             /* {*property   $runsTo                         (Vessel)                        The vasculature the lymphatic structure runs, or efferents, to. *} */
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of LymphaticVessel.__construct() ========================================== */
    /* ================================================================================ */
