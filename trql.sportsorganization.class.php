...
defined( 'SPORTSORGANIZATION_CLASS_VERSION' ) or define( 'SPORTSORGANIZATION_CLASS_VERSION','0.1' );
...
/*-----------------------------------------*/
{
    ...
    public      $wikidataId                     = 'Q4438121';       /* {*property   $wikidataId                     (string)                        Organization involved primarily in sports. *} */
