...
/** {{{*fheader
    {*file                  trql.podiatric.class.php *}
    {*purpose               Podiatry is the care of the human foot, especially the
...
defined( 'PODIATRIC_CLASS_VERSION' ) or define( 'PODIATRIC_CLASS_VERSION','0.1' );
...
/** {{*class Podiatric=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Podiatric[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of Podiatric.__destruct() ============================================== */
    /* ================================================================================ */
}   /* End of class Podiatric ========================================================= */
/* ==================================================================================== */
