...
use \trql\audioobject, book\AudioObject, Book    as AudioObject, Book;
...
if ( ! defined( 'AUDIOOBJECT, BOOK_CLASS_VERSION' ) )
    require_once( 'trql.audioobject, book.class.php' );
 ...
 */
/* ==================================================================================== */
class Audiobook extends AudioObject, Book
/*--------------------------------------*/
{
    ...
    public      $timeRequired                   = null;             /* {*property   $timeRequired                   (Duration)                      Approximate or typical time it takes to work with or through this
                                                                                                                                                    ...
                                                                                                                                                    'PT30M', 'PT1H25M'. *} */
    public      $transcript                     = null;             /* {*property   $transcript                     (string)                        If this MediaObject is an AudioObject or VideoObject, the transcript
                                                                                                                                                    of that object. *} */
