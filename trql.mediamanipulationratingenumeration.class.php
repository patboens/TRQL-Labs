...
/** {{{*fheader
    {*file                  trql.mediamanipulationratingenumeration.class.php *}
    {*purpose               (editorial work in progress, this definition is incomplete
                            and unreviewed) MediaManipulationRatingEnumeration
                            classifies a number of ways in which a media item (video,
                            image, audio) can be manipulated, taking into account the
...
/****************************************************************************************/
namespace trql\mediamanipulationratingenumeration;
...
defined( 'MEDIAMANIPULATIONRATINGENUMERATION_CLASS_VERSION' ) or define( 'MEDIAMANIPULATIONRATINGENUMERATION_CLASS_VERSION','0.1' );
...
/** {{*class MediaManipulationRatingEnumeration=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MediaManipulationRatingEnumeration[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of MediaManipulationRatingEnumeration.__construct() ========================================== */
    /* ================================================================================ */
...
}   /* End of class MediaManipulationRatingEnumeration ====================================================== */
/* ==================================================================================== */
