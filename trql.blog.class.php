...
defined( 'BLOG_CLASS_VERSION' ) or define( 'BLOG_CLASS_VERSION','0.1' );
...
/** {{*class Blog=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Blog[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $blogPost                       = null;             /* {*property   $blogPost                       (BlogPosting)                   A posting that is part of this blog. *} */
    ...
    public      $wikidataId                     = 'Q30849';         /* {*property   $wikidataId                     (string)                        Wikidata ID. Discussion or informational site published on the World Wide Web *} */
