...
/** {{{*fheader
    {*file                  trql.ondemandevent.class.php *}
    {*purpose               A publication event e.g. catch-up TV or radio podcast,
...
defined( 'ONDEMANDEVENT_CLASS_VERSION' ) or define( 'ONDEMANDEVENT_CLASS_VERSION','0.1' );
...
/** {{*class OnDemandEvent=
    ...
    *}
    ...
    {*doc [url]http://schema.org/OnDemandEvent[/url] *}
