...
/** {{{*fheader
    {*file                  trql.foodservice.class.php *}
    {*purpose               A food service, like breakfast, lunch, or dinner. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'FOODSERVICE_CLASS_VERSION' ) or define( 'FOODSERVICE_CLASS_VERSION','0.1' );
...
/** {{*class FoodService=
    ...
    *}
    ...
    {*doc [url]http://schema.org/FoodService[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of FoodService.__construct() ========================================== */
    /* ================================================================================ */
