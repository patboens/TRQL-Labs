...
/** {{{*fheader
    {*file                  trql.transferaction.class.php *}
    {*purpose               The act of transferring/moving (abstract or concrete)
...
defined( 'TRANSFERACTION_CLASS_VERSION' ) or define( 'TRANSFERACTION_CLASS_VERSION','0.1' );
...
/** {{*class TransferAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/TransferAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of TransferAction.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of TransferAction.__destruct() =========================================== */
    /* ================================================================================ */
