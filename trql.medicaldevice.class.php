...
/** {{{*fheader
    {*file                  trql.medicaldevice.class.php *}
    {*purpose               Any object used in a medical capacity, such as to diagnose
                            or treat a patient. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'MEDICALDEVICE_CLASS_VERSION' ) or define( 'MEDICALDEVICE_CLASS_VERSION','0.1' );
...
/** {{*class MedicalDevice=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MedicalDevice[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $postOp                         = null;             /* {*property   $postOp                         (string)                        A description of the postoperative procedures, care, and/or followups
                                                                                                                                                    for this device. *} */
    public      $potentialAction                = null;             /* {*property   $potentialAction                (Action)                        Indicates a potential Action, which describes an idealized action in
                                                                                                                                                    which this thing would play an 'object' role. *} */
    public      $preOp                          = null;             /* {*property   $preOp                          (string)                        A description of the workup, testing, and other preparations required
                                                                                                                                                    before implanting this device. *} */
    public      $procedure                      = null;             /* {*property   $procedure                      (string)                        A description of the procedure involved in setting up, using, and/or
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of MedicalDevice.__construct() ========================================== */
    /* ================================================================================ */
