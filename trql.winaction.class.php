...
/** {{{*fheader
    {*file                  trql.winaction.class.php *}
    {*purpose               The act of achieving victory in a competitive activity. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'WINACTION_CLASS_VERSION' ) or define( 'WINACTION_CLASS_VERSION','0.1' );
...
/** {{*class WinAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/WinAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $loser                          = null;             /* {*property   $loser                          (Person)                        A sub property of participant. The loser of the action. *} */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of WinAction.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class WinAction ====================================================== */
/* ==================================================================================== */
