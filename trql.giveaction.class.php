...
/** {{{*fheader
    {*file                  trql.giveaction.class.php *}
    {*purpose               The act of transferring ownership of an object to a
                            destination. Reciprocal of TakeAction.Related
                            actions:TakeAction: Reciprocal of GiveAction.SendAction:
                            Unlike SendAction, GiveAction implies that ownership is
                            being transferred (e.g. I may send my laptop to you, but
...
defined( 'GIVEACTION_CLASS_VERSION' ) or define( 'GIVEACTION_CLASS_VERSION','0.1' );
...
/** {{*class GiveAction=
    ...
    {*desc
        ...
        GiveAction.SendAction: Unlike SendAction, GiveAction implies that ownership
        is being transferred (e.g. I may send my laptop to you, but that doesn't
    ...
    *}
    ...
    {*doc [url]http://schema.org/GiveAction[/url] *}
