...
/** {{{*fheader
    {*file                  trql.replaceaction.class.php *}
    {*purpose               The act of editing a recipient by replacing an old object
                            with a new object. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
use \trql\schema\action\UpdateAction    as UpdateAction;
...
defined( 'REPLACEACTION_CLASS_VERSION' ) or define( 'REPLACEACTION_CLASS_VERSION','0.1' );
...
/** {{*class ReplaceAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ReplaceAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $collection                     = null;             /* {*property   $collection                     (Thing)                         A sub property of object. The collection target of the action. *} */
    ...
    public      $replacee                       = null;             /* {*property   $replacee                       (Thing)                         A sub property of object. The object that is being replaced. *} */
    public      $replacer                       = null;             /* {*property   $replacer                       (Thing)                         A sub property of object. The object that replaces. *} */
    ...
    public      $targetCollection               = null;             /* {*property   $targetCollection               (Thing)                         A sub property of object. The collection target of the action. *} */
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of ReplaceAction.__construct() ========================================= */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of ReplaceAction.__destruct() ========================================== */
    /* ================================================================================ */
}   /* End of class ReplaceAction ===================================================== */
/* ==================================================================================== */
