...
/** {{{*fheader
    {*file                  trql.landform.class.php *}
    {*purpose               A landform or physical feature. Landform elements include
...
defined( 'LANDFORM_CLASS_VERSION' ) or define( 'LANDFORM_CLASS_VERSION','0.1' );
...
/** {{*class Landform=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Landform[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of Landform.__destruct() =============================================== */
    /* ================================================================================ */
}   /* End of class Landform ========================================================== */
/* ==================================================================================== */
?>