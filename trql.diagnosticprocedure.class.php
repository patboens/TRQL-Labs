...
/** {{{*fheader
    {*file                  trql.diagnosticprocedure.class.php *}
    {*purpose               A medical procedure intended primarily for diagnostic, as
...
/****************************************************************************************/
namespace trql\diagnosticprocedure;
...
defined( 'DIAGNOSTICPROCEDURE_CLASS_VERSION' ) or define( 'DIAGNOSTICPROCEDURE_CLASS_VERSION','0.1' );
...
/** {{*class DiagnosticProcedure=
    ...
    *}
    ...
    {*doc [url]http://schema.org/DiagnosticProcedure[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of DiagnosticProcedure.__construct() ========================================== */
    /* ================================================================================ */
...
}   /* End of class DiagnosticProcedure ====================================================== */
/* ==================================================================================== */
