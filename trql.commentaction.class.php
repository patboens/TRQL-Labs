...
/** {{{*fheader
    {*file                  trql.commentaction.class.php *}
    {*purpose               The act of generating a comment about a subject. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'COMMENTACTION_CLASS_VERSION' ) or define( 'COMMENTACTION_CLASS_VERSION','0.1' );
...
/** {{*class CommentAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/CommentAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of CommentAction.__construct() ========================================== */
    /* ================================================================================ */
