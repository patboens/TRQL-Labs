...
defined( 'CHURCH_CLASS_VERSION' ) or define( 'CHURCH_CLASS_VERSION','0.1' );
...
/** {{*class Church=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Church[/url] *}
