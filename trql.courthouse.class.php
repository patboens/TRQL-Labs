...
/** {{{*fheader
    {*file                  trql.courthouse.class.php *}
    {*purpose               A courthouse. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'COURTHOUSE_CLASS_VERSION' ) or define( 'COURTHOUSE_CLASS_VERSION','0.1' );
...
/** {{*class Courthouse=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Courthouse[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->autodoc();
        $this->UIKey();
    }   /* End of Courthouse.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class Courthouse ====================================================== */
/* ==================================================================================== */
