...
/** {{{*fheader
    {*file                  trql.class.class.php *}
    {*purpose               A class, also often called a 'Type'; equivalent to
                            rdfs:Class. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'CLASS_CLASS_VERSION' ) or define( 'CLASS_CLASS_VERSION','0.1' );
...
/** {{*class Class=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Class[/url] *}
 ...
 */
/* ==================================================================================== */
class AClass extends Intangible
/*---------------------------*/
{
