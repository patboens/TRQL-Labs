...
/** {{{*fheader
    {*file                  trql.medicalenumeration.class.php *}
    {*purpose               Enumerations related to health and the practice of medicine:
                            A concept that is used to attribute a quality to another
                            concept, as a qualifier, a collection of items or a listing
...
/****************************************************************************************/
namespace trql\medicalenumeration;
...
defined( 'MEDICALENUMERATION_CLASS_VERSION' ) or define( 'MEDICALENUMERATION_CLASS_VERSION','0.1' );
...
/** {{*class MedicalEnumeration=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MedicalEnumeration[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of MedicalEnumeration.__construct() ========================================== */
    /* ================================================================================ */
...
}   /* End of class MedicalEnumeration ====================================================== */
/* ==================================================================================== */
