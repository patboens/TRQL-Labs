...
/** {{{*fheader
    {*file                  trql.prependaction.class.php *}
    {*purpose               The act of inserting at the beginning if an ordered
                            collection. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
    ...
    *}}} */
/****************************************************************************************/
namespace trql\prependaction;

use \trql\vaesoli\Vaesoli                   as Vaesoli;
use \trql\insertaction\InsertAction    as InsertAction;


if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'trql.vaesoli.class.php' );

if ( ! defined( 'INSERTACTION_CLASS_VERSION' ) )
    require_once( 'trql.insertaction.class.php' );



defined( 'PREPENDACTION_CLASS_VERSION' ) or define( 'PREPENDACTION_CLASS_VERSION','0.1' );
...
/** {{*class PrependAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/PrependAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of PrependAction.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of PrependAction.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class PrependAction ====================================================== */
/* ==================================================================================== */
