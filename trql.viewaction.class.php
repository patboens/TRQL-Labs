...
/** {{{*fheader
    {*file                  trql.viewaction.class.php *}
    {*purpose               The act of consuming static visual content. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'VIEWACTION_CLASS_VERSION' ) or define( 'VIEWACTION_CLASS_VERSION','0.1' );
...
/** {{*class ViewAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ViewAction[/url] *}
