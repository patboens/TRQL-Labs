...
/** {{{*fheader
    {*file                  trql.userdownloads.class.php *}
...
defined( 'USERDOWNLOADS_CLASS_VERSION' ) or define( 'USERDOWNLOADS_CLASS_VERSION','0.1' );
...
/** {{*class UserDownloads=
    ...
    *}
    ...
    {*doc [url]http://schema.org/UserDownloads[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of UserDownloads.__construct() ========================================= */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of UserDownloads.__destruct() ========================================== */
    /* ================================================================================ */
