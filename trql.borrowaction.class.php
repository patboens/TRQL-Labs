...
/** {{{*fheader
    {*file                  trql.borrowaction.class.php *}
    {*purpose               The act of obtaining an object under an agreement to return
                            it at a later date. Reciprocal of LendAction.Related
...
defined( 'BORROWACTION_CLASS_VERSION' ) or define( 'BORROWACTION_CLASS_VERSION','0.1' );
...
/** {{*class BorrowAction=
    ...
    {*desc
        ...
        date. Reciprocal of LendAction.Related actions:LendAction: Reciprocal of
        BorrowAction.
    ...
    *}
    ...
    {*doc [url]http://schema.org/BorrowAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $instrument                     = null;             /* {*property   $instrument                     (Thing)                         The object that helped the agent perform the action. e.g. John wrote a
                                                                                                                                                    book with a pen. *} */
    public      $lender                         = null;             /* {*property   $lender                         (Person|Organization)           A sub property of participant. The person that lends the object being
                                                                                                                                                    borrowed. *} */
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of BorrowAction.__construct() ========================================== */
    /* ================================================================================ */
