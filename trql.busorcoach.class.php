...
/** {{{*fheader
    {*file                  trql.busorcoach.class.php *}
    {*purpose               A bus (also omnibus or autobus) is a road vehicle designed
                            to carry passengers. Coaches are luxury busses, usually in
...
defined( 'BUSORCOACH_CLASS_VERSION' ) or define( 'BUSORCOACH_CLASS_VERSION','0.1' );
...
/** {{*class BusOrCoach=
    ...
    *}
    ...
    {*doc [url]http://schema.org/BusOrCoach[/url] *}
...
/*-----------------------------*/
{
    ...
    public      $wikidataId                     = 'Q12334006';      /* {*property   $wikidataId                     (string)                        Wikidata ID. Coach ... type of bus for conveying passengers on 
                                                                                                                                                    excursions and on longer-distance intercity coach services. *} */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of BusOrCoach.__destruct() ============================================= */
    /* ================================================================================ */
}   /* End of class BusOrCoach ======================================================== */
/* ==================================================================================== */
