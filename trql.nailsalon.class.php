...
/** {{{*fheader
    {*file                  trql.nailsalon.class.php *}
    {*purpose               A nail salon. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'NAILSALON_CLASS_VERSION' ) or define( 'NAILSALON_CLASS_VERSION','0.1' );
...
/** {{*class NailSalon=
    ...
    *}
    ...
    {*doc [url]http://schema.org/NailSalon[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of NailSalon.__destruct() ============================================== */
    /* ================================================================================ */

}   /* End of class NailSalon ========================================================= */
/* ==================================================================================== */
