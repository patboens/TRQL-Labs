...
/** {{{*fheader
    {*file                  trql.gatedresidencecommunity.class.php *}
    {*purpose               Residence type: Gated community. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'GATEDRESIDENCECOMMUNITY_CLASS_VERSION' ) or define( 'GATEDRESIDENCECOMMUNITY_CLASS_VERSION','0.1' );
...
/** {{*class GatedResidenceCommunity=
    ...
    *}
    ...
    {*doc [url]http://schema.org/GatedResidenceCommunity[/url] *}
