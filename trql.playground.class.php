...
/** {{{*fheader
    {*file                  trql.playground.class.php *}
    {*purpose               A playground. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'PLAYGROUND_CLASS_VERSION' ) or define( 'PLAYGROUND_CLASS_VERSION','0.1' );
...
/** {{*class Playground=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Playground[/url] *}
