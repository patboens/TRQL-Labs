...
/** {{{*fheader
    {*file                  trql.medicalwebpage.class.php *}
    {*purpose               A web page that provides medical information. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'MEDICALWEBPAGE_CLASS_VERSION' ) or define( 'MEDICALWEBPAGE_CLASS_VERSION','0.1' );
...
/** {{*class MedicalWebPage=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MedicalWebPage[/url] *}
...
/*--------------------------------*/
{
    ...
    public      $medicalAudience                = null;             /* {*property   $medicalAudience        (MedicalAudienceType|MedicalAudience)   Medical audience for page. *} */
