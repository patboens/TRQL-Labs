...
/** {{{*fheader
    {*file                  trql.specialty.class.php *}
    {*purpose               Any branch of a field in which people typically develop
                            specific expertise, usually after significant study, time,
                            and effort. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'SPECIALTY_CLASS_VERSION' ) or define( 'SPECIALTY_CLASS_VERSION','0.1' );
...
/** {{*class Specialty=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Specialty[/url] *}
