...
/** {{{*fheader
    {*file                  trql.sportinggoodsstore.class.php *}
    {*purpose               A sporting goods store. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'SPORTINGGOODSSTORE_CLASS_VERSION' ) or define( 'SPORTINGGOODSSTORE_CLASS_VERSION','0.1' );
...
/** {{*class SportingGoodsStore=
    ...
    *}
    ...
    {*doc [url]http://schema.org/SportingGoodsStore[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of SportingGoodsStore.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of SportingGoodsStore.__destruct() =========================================== */
    /* ================================================================================ */
