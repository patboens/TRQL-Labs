...
defined( 'LIBRARY_CLASS_VERSION' ) or define( 'LIBRARY_CLASS_VERSION','0.1' );
...
/** {{*class Library=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Library[/url] *}
