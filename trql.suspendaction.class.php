...
/** {{{*fheader
    {*file                  trql.suspendaction.class.php *}
    {*purpose               The act of momentarily pausing a device or application (e.g.
...
defined( 'SUSPENDACTION_CLASS_VERSION' ) or define( 'SUSPENDACTION_CLASS_VERSION','0.1' );
...
/** {{*class SuspendAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/SuspendAction[/url] *}
