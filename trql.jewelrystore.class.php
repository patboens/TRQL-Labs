...
/** {{{*fheader
    {*file                  trql.jewelrystore.class.php *}
    {*purpose               A jewelry store. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'JEWELRYSTORE_CLASS_VERSION' ) or define( 'JEWELRYSTORE_CLASS_VERSION','0.1' );
...
/** {{*class JewelryStore=
    ...
    *}
    ...
    {*doc [url]http://schema.org/JewelryStore[/url] *}
...
/*----------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of JewelryStore.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of JewelryStore.__destruct() =========================================== */
    /* ================================================================================ */
