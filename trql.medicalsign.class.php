...
/** {{{*fheader
    {*file                  trql.medicalsign.class.php *}
    {*purpose               Any physical manifestation of a person's medical condition
...
defined( 'MEDICALSIGN_CLASS_VERSION' ) or define( 'MEDICALSIGN_CLASS_VERSION','0.1' );
...
/** {{*class MedicalSign=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MedicalSign[/url] *}
