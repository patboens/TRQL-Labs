...
/** {{{*fheader
    {*file                  trql.itempage.class.php *}
    {*purpose               A page devoted to a single item, such as a particular
                            product or hotel. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'ITEMPAGE_CLASS_VERSION' ) or define( 'ITEMPAGE_CLASS_VERSION','0.1' );
...
/** {{*class ItemPage=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ItemPage[/url] *}
