...
/** {{{*fheader
    {*file                  trql.mobilephonestore.class.php *}
    {*purpose               A store that sells mobile phones and related accessories. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'MOBILEPHONESTORE_CLASS_VERSION' ) or define( 'MOBILEPHONESTORE_CLASS_VERSION','0.1' );
...
/** {{*class MobilePhoneStore=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MobilePhoneStore[/url] *}
