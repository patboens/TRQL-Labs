...
/** {{{*fheader
    {*file                  trql.enumeration.class.php *}
    {*purpose               Lists or enumerations—for example, a list of cuisines or
                            music genres, etc. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'ENUMERATION_CLASS_VERSION' ) or define( 'ENUMERATION_CLASS_VERSION','0.1' );
...
/** {{*class Enumeration=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Enumeration[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $wikidataId                     = 'Q2704791';       /* {*property   $wikidataId                     (string)                        Wikidata ID. Complete, ordered listing of all the items 
                                                                                                                                                    in a collection *} */
