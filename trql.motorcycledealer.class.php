...
/** {{{*fheader
    {*file                  trql.motorcycledealer.class.php *}
    {*purpose               A motorcycle dealer. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'MOTORCYCLEDEALER_CLASS_VERSION' ) or define( 'MOTORCYCLEDEALER_CLASS_VERSION','0.1' );
...
/** {{*class MotorcycleDealer=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MotorcycleDealer[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of MotorcycleDealer.__construct() ====================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of MotorcycleDealer.__destruct() ======================================= */
    /* ================================================================================ */
