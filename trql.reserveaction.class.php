...
/** {{{*fheader
    {*file                  trql.reserveaction.class.php *}
    {*purpose               Reserving a concrete object.Related actions:ScheduleAction:
                            Unlike ScheduleAction, ReserveAction reserves concrete
                            objects (e.g. a table, a hotel) towards a time slot /
                            spatial allocation. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
/** {{*class ReserveAction=
    ...
    {*desc
        ...
        Reserving a concrete object.Related actions:ScheduleAction: Unlike
    ...
    *}
    ...
    {*doc [url]http://schema.org/ReserveAction[/url] *}
