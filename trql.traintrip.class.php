...
/** {{{*fheader
    {*file                  trql.traintrip.class.php *}
    {*purpose               A trip on a commercial train line. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'TRAINTRIP_CLASS_VERSION' ) or define( 'TRAINTRIP_CLASS_VERSION','0.1' );
...
/** {{*class TrainTrip=
    ...
    *}
    ...
    {*doc [url]http://schema.org/TrainTrip[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $arrivalPlatform                = null;             /* {*property   $arrivalPlatform                (string)                        The platform where the train arrives. *} */
    public      $arrivalStation                 = null;             /* {*property   $arrivalStation                 (TrainStation)                  The station where the train trip ends. *} */
    public      $arrivalTime                    = null;             /* {*property   $arrivalTime                    (Time|DateTime)                 The expected arrival time. *} */
    public      $departurePlatform              = null;             /* {*property   $departurePlatform              (string)                        The platform from which the train departs. *} */
    public      $departureStation               = null;             /* {*property   $departureStation               (TrainStation)                  The station from which the train departs. *} */
    ...
    public      $trainName                      = null;             /* {*property   $trainName                      (string)                        The name of the train (e.g. The Orient Express). *} */
    public      $trainNumber                    = null;             /* {*property   $trainNumber                    (string)                        The unique identifier for the train. *} */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of TrainTrip.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class TrainTrip ====================================================== */
/* ==================================================================================== */
