...
/** {{{*fheader
    {*file                  trql.policestation.class.php *}
    {*purpose               A police station. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
    ...
    *}}} */
/****************************************************************************************/
namespace trql\policestation;

use \trql\vaesoli\Vaesoli                   as Vaesoli;
use \trql\civicstructure, emergencyservice\CivicStructure, EmergencyService    as CivicStructure, EmergencyService;


if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'trql.vaesoli.class.php' );

if ( ! defined( 'CIVICSTRUCTURE, EMERGENCYSERVICE_CLASS_VERSION' ) )
    require_once( 'trql.civicstructure, emergencyservice.class.php' );



defined( 'POLICESTATION_CLASS_VERSION' ) or define( 'POLICESTATION_CLASS_VERSION','0.1' );
...
/** {{*class PoliceStation=
    ...
    *}
    ...
    {*doc [url]http://schema.org/PoliceStation[/url] *}
 ...
 */
/* ==================================================================================== */
class PoliceStation extends CivicStructure, EmergencyService
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of PoliceStation.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of PoliceStation.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class PoliceStation ====================================================== */
/* ==================================================================================== */
