...
/** {{{*fheader
    {*file                  trql.educationalaudience.class.php *}
    {*purpose               An EducationalAudience. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
/****************************************************************************************/
namespace trql\educationalaudience;
...
defined( 'EDUCATIONALAUDIENCE_CLASS_VERSION' ) or define( 'EDUCATIONALAUDIENCE_CLASS_VERSION','0.1' );
...
/** {{*class EducationalAudience=
    ...
    *}
    ...
    {*doc [url]http://schema.org/EducationalAudience[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $educationalRole                = null;             /* {*property   $educationalRole                (string)                        An educationalRole of an EducationalAudience. *} */
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of EducationalAudience.__construct() ========================================== */
    /* ================================================================================ */
...
}   /* End of class EducationalAudience ====================================================== */
/* ==================================================================================== */
