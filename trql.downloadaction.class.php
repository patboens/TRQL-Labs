...
/** {{{*fheader
    {*file                  trql.downloadaction.class.php *}
    {*purpose               The act of downloading an object. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'DOWNLOADACTION_CLASS_VERSION' ) or define( 'DOWNLOADACTION_CLASS_VERSION','0.1' );
...
/** {{*class DownloadAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/DownloadAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of DownloadAction.__construct() ========================================== */
    /* ================================================================================ */
