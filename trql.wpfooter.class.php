...
/** {{{*fheader
    {*file                  trql.wpfooter.class.php *}
    {*purpose               The footer section of the page. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'WPFOOTER_CLASS_VERSION' ) or define( 'WPFOOTER_CLASS_VERSION','0.1' );
...
/** {{*class WPFooter=
    ...
    *}
    ...
    {*doc [url]http://schema.org/WPFooter[/url] *}
