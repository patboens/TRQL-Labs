...
/** {{{*fheader
    {*file                  trql.offeritemcondition.class.php *}
    {*purpose               A list of possible conditions for the item. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
    ...
    *}}} */
/****************************************************************************************/
namespace trql\offeritemcondition;
...
defined( 'OFFERITEMCONDITION_CLASS_VERSION' ) or define( 'OFFERITEMCONDITION_CLASS_VERSION','0.1' );
...
/** {{*class OfferItemCondition=
    ...
    *}
    ...
    {*doc [url]http://schema.org/OfferItemCondition[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of OfferItemCondition.__construct() ==================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of OfferItemCondition.__destruct() ===================================== */
    /* ================================================================================ */

}   /* End of class OfferItemCondition ================================================ */
/* ==================================================================================== */
