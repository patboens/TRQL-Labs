...
/** {{{*fheader
    {*file                  trql.druglegalstatus.class.php *}
    {*purpose               The legal availability status of a medical drug. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
/****************************************************************************************/
namespace trql\druglegalstatus;
...
defined( 'DRUGLEGALSTATUS_CLASS_VERSION' ) or define( 'DRUGLEGALSTATUS_CLASS_VERSION','0.1' );
...
/** {{*class DrugLegalStatus=
    ...
    *}
    ...
    {*doc [url]http://schema.org/DrugLegalStatus[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of DrugLegalStatus.__construct() ========================================== */
    /* ================================================================================ */
