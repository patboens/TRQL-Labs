...
/** {{{*fheader
    {*file                  trql.listenaction.class.php *}
    {*purpose               The act of consuming audio content. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
/** {{*class ListenAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ListenAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of ListenAction.__construct() ========================================== */
    /* ================================================================================ */
