...
/** {{{*fheader
    {*file                  trql.taxistand.class.php *}
    {*purpose               A taxi stand. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'TAXISTAND_CLASS_VERSION' ) or define( 'TAXISTAND_CLASS_VERSION','0.1' );
...
/** {{*class TaxiStand=
    ...
    *}
    ...
    {*doc [url]http://schema.org/TaxiStand[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of TaxiStand.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class TaxiStand ====================================================== */
/* ==================================================================================== */
