...
/** {{{*fheader
    {*file                  trql.howtotip.class.php *}
    {*purpose               An explanation in the instructions for how to achieve a
                            result. It provides supplementary information about a
                            technique, supply, author's preference, etc. It can explain
                            what could be done, or what should not be done, but doesn't
...
defined( 'HOWTOTIP_CLASS_VERSION' ) or define( 'HOWTOTIP_CLASS_VERSION','0.1' );
...
/** {{*class HowToTip=
    ...
    *}
    ...
    {*doc [url]http://schema.org/HowToTip[/url] *}
...
/*-------------------------------*/
{
    ...
    public      $wikidataId                     = 'Q1142825';       /* {*property   $wikidataId                     (string)                        Wikidata ID. how-to (the closest I can get): Description 
