...
/** {{{*fheader
    {*file                  trql.rejectaction.class.php *}
    {*purpose               The act of rejecting to/adopting an object.Related
...
defined( 'REJECTACTION_CLASS_VERSION' ) or define( 'REJECTACTION_CLASS_VERSION','0.1' );
...
/** {{*class RejectAction=
    ...
    {*desc
        ...
        The act of rejecting to/adopting an object.Related actions:AcceptAction:
    ...
    *}
    ...
    {*doc [url]http://schema.org/RejectAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of RejectAction.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of RejectAction.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class RejectAction ====================================================== */
/* ==================================================================================== */
