...
use \trql\creativework, itemlist, listitem\CreativeWork, ItemList, ListItem    as CreativeWork, ItemList, ListItem;
 ...
 */
/* ==================================================================================== */
class HowToSection extends CreativeWork, ItemList, ListItem
/*--------------------------------------*/
{
    ...
    public      $steps                          = null;             /* {*property   $steps                          (CreativeWork|ItemList|string)  A single step item (as HowToStep, text, document, video, etc.) or a
