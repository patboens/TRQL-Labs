...
/** {{{*fheader
    {*file                  trql.musicalbumproductiontype.class.php *}
    {*purpose               Classification of the album by it's type of content:
    ...
    *}}} */
/****************************************************************************************/
namespace trql\musicalbumproductiontype;
...
defined( 'MUSICALBUMPRODUCTIONTYPE_CLASS_VERSION' ) or define( 'MUSICALBUMPRODUCTIONTYPE_CLASS_VERSION','0.1' );
...
/** {{*class MusicAlbumProductionType=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MusicAlbumProductionType[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of MusicAlbumProductionType.__construct() ============================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of MusicAlbumProductionType.__destruct() =============================== */
    /* ================================================================================ */
