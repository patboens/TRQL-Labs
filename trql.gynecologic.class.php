...
/** {{{*fheader
    {*file                  trql.gynecologic.class.php *}
    {*purpose               A specific branch of medical science that pertains to the
                            health care of women, particularly in the diagnosis and
                            treatment of disorders affecting the female reproductive
                            system. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'GYNECOLOGIC_CLASS_VERSION' ) or define( 'GYNECOLOGIC_CLASS_VERSION','0.1' );
...
/** {{*class Gynecologic=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Gynecologic[/url] *}
