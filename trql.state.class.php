...
/** {{{*fheader
    {*file                  trql.state.class.php *}
    {*purpose               A state or province of a country. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'STATE_CLASS_VERSION' ) or define( 'STATE_CLASS_VERSION','0.1' );
...
/** {{*class State=
    ...
    *}
    ...
    {*doc [url]http://schema.org/State[/url] *}
