...
defined( 'FLORIST_CLASS_VERSION' ) or define( 'FLORIST_CLASS_VERSION','0.1' );
...
/** {{*class Florist=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Florist[/url] *}
