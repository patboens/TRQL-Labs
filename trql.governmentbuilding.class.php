...
/** {{{*fheader
    {*file                  trql.governmentbuilding.class.php *}
    {*purpose               A government building.. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
    {*cdate                 01-03-21 17:22 *}
    {*mdate                 auto *}
    {*license               {RIGHTS} *}
...
defined( 'GOVERNMENTBUILDING_CLASS_VERSION' ) or define( 'GOVERNMENTBUILDING_CLASS_VERSION','0.1' );
