...
/** {{{*fheader
    {*file                  trql.autodealer.class.php *}
    {*purpose               An car dealership. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'AUTODEALER_CLASS_VERSION' ) or define( 'AUTODEALER_CLASS_VERSION','0.1' );
...
/** {{*class AutoDealer=
    ...
    *}
    ...
    {*doc [url]http://schema.org/AutoDealer[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $wikidataId                     = 'Q786803';        /* {*property   $wikidataId                     (string)                            Wikidata ID: Car dealership: business which sells, 
                                                                                                                                                        buys, and trades new and/or used cars, trucks, 
                                                                                                                                                        SUVs, and vans *} */
