...
/** {{{*fheader
    {*file                  trql.code.class.php *}
    {*purpose               Computer programming source code. Example: Full 
                            (compile ready) solutions, code snippet samples, 
                            scripts, templates. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
    {*cdate                 24-08-2020 12:45 *}
    {*mdate                 auto *}
    {*license               {RIGHTS} *}
    {*UTF-8                 Quel bel été *}
...
/** {{*class Code=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Code[/url] *}
