...
/** {{{*fheader
    {*file                  trql.geriatric.class.php *}
    {*purpose               A specific branch of medical science that is concerned with
                            the diagnosis and treatment of diseases, debilities and
...
defined( 'GERIATRIC_CLASS_VERSION' ) or define( 'GERIATRIC_CLASS_VERSION','0.1' );
...
/** {{*class Geriatric=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Geriatric[/url] *}
