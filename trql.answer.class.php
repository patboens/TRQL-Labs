...
/** {{{*fheader
    {*file                  trql.answer.class.php *}
    {*purpose               An answer offered to a question; perhaps correct, perhaps
...
defined( 'ANSWER_CLASS_VERSION' ) or define( 'ANSWER_CLASS_VERSION','0.1' );
...
/** {{*class Answer=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Answer[/url] *}
