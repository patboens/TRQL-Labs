...
/** {{{*fheader
    {*file                  trql.discoveraction.class.php *}
    {*purpose               The act of discovering/finding an object. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'DISCOVERACTION_CLASS_VERSION' ) or define( 'DISCOVERACTION_CLASS_VERSION','0.1' );
...
/** {{*class DiscoverAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/DiscoverAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of DiscoverAction.__construct() ========================================== */
    /* ================================================================================ */
