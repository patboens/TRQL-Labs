...
/** {{{*fheader
    {*file                  trql.medicaltestpanel.class.php *}
    {*purpose               Any collection of tests commonly ordered together. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
    ...
    *}}} */
/****************************************************************************************/
namespace trql\medicaltestpanel;
...
defined( 'MEDICALTESTPANEL_CLASS_VERSION' ) or define( 'MEDICALTESTPANEL_CLASS_VERSION','0.1' );
...
/** {{*class MedicalTestPanel=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MedicalTestPanel[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $subTest                        = null;             /* {*property   $subTest                        (MedicalTest)                   A component test of the panel. *} */
