...
/** {{{*fheader
    {*file                  trql.literaryevent.class.php *}
    {*purpose               Event type: Literary event. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'LITERARYEVENT_CLASS_VERSION' ) or define( 'LITERARYEVENT_CLASS_VERSION','0.1' );
...
/** {{*class LiteraryEvent=
    ...
    *}
    ...
    {*doc [url]http://schema.org/LiteraryEvent[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of LiteraryEvent.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->autodoc();
        $this->UIKey();
    }   /* End of LiteraryEvent.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class LiteraryEvent ====================================================== */
/* ==================================================================================== */
