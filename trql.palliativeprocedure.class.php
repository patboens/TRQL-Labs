...
use \trql\medicalprocedure, medicaltherapy\MedicalProcedure, MedicalTherapy    as MedicalProcedure, MedicalTherapy;


if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'trql.vaesoli.class.php' );

if ( ! defined( 'MEDICALPROCEDURE, MEDICALTHERAPY_CLASS_VERSION' ) )
    require_once( 'trql.medicalprocedure, medicaltherapy.class.php' );
 ...
 */
/* ==================================================================================== */
class PalliativeProcedure extends MedicalProcedure, MedicalTherapy
/*--------------------------------------*/
{
