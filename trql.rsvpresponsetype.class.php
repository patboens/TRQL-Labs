...
/** {{{*fheader
    {*file                  trql.rsvpresponsetype.class.php *}
    {*purpose               RsvpResponseType is an enumeration type whose instances
    ...
    *}}} */
/****************************************************************************************/
namespace trql\rsvpresponsetype;
...
defined( 'RSVPRESPONSETYPE_CLASS_VERSION' ) or define( 'RSVPRESPONSETYPE_CLASS_VERSION','0.1' );
...
/** {{*class RsvpResponseType=
    ...
    *}
    ...
    {*doc [url]http://schema.org/RsvpResponseType[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of RsvpResponseType.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of RsvpResponseType.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class RsvpResponseType ====================================================== */
/* ==================================================================================== */
