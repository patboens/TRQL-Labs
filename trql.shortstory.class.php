...
/** {{{*fheader
    {*file                  trql.shortstory.class.php *}
    {*purpose               Short story or tale. A brief work of literature, usually
...
defined( 'SHORTSTORY_CLASS_VERSION' ) or define( 'SHORTSTORY_CLASS_VERSION','0.1' );
...
/** {{*class ShortStory=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ShortStory[/url] *}
...
/*---------------------------------*/
{
    ...
    public      $wikidataId                     = 'Q49084';         /* {*property   $wikidataId                     (string)                        Wikidata ID. brief work of literature, usually written
                                                                                                                                                    in narrative prose *} */
