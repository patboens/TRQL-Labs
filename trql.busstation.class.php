...
/** {{{*fheader
    {*file                  trql.busstation.class.php *}
    {*purpose               A bus station. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'BUSSTATION_CLASS_VERSION' ) or define( 'BUSSTATION_CLASS_VERSION','0.1' );
...
/** {{*class BusStation=
    ...
    *}
    ...
    {*doc [url]http://schema.org/BusStation[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->autodoc();
        $this->UIKey();
    }   /* End of BusStation.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class BusStation ====================================================== */
/* ==================================================================================== */
