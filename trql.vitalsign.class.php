...
/** {{{*fheader
    {*file                  trql.vitalsign.class.php *}
    {*purpose               Vital signs are measures of various physiological functions
    ...
    *}}} */
/****************************************************************************************/
namespace trql\vitalsign;

use \trql\vaesoli\Vaesoli                   as Vaesoli;
use \trql\medicalsign\MedicalSign    as MedicalSign;


if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'trql.vaesoli.class.php' );

if ( ! defined( 'MEDICALSIGN_CLASS_VERSION' ) )
    require_once( 'trql.medicalsign.class.php' );



defined( 'VITALSIGN_CLASS_VERSION' ) or define( 'VITALSIGN_CLASS_VERSION','0.1' );
...
/** {{*class VitalSign=
    ...
    *}
    ...
    {*doc [url]http://schema.org/VitalSign[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $identifyingExam                = null;             /* {*property   $identifyingExam                (PhysicalExam)                  A physical examination that can identify this sign. *} */
    public      $identifyingTest                = null;             /* {*property   $identifyingTest                (MedicalTest)                   A diagnostic test that can identify this sign. *} */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of VitalSign.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class VitalSign ====================================================== */
/* ==================================================================================== */
