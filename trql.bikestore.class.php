...
/** {{{*fheader
    {*file                  trql.bikestore.class.php *}
    {*purpose               A bike store. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'BIKESTORE_CLASS_VERSION' ) or define( 'BIKESTORE_CLASS_VERSION','0.1' );
...
/** {{*class BikeStore=
    ...
    *}
    ...
    {*doc [url]http://schema.org/BikeStore[/url] *}
