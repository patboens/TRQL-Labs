...
/** {{{*fheader
    {*file                  trql.radiobroadcastservice.class.php *}
    {*purpose               A delivery service through which radio content is provided
                            via broadcast over the air or online. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
    ...
    *}}} */
/****************************************************************************************/
namespace trql\radiobroadcastservice;

use \trql\vaesoli\Vaesoli                   as Vaesoli;
use \trql\broadcastservice\BroadcastService    as BroadcastService;


if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'trql.vaesoli.class.php' );

if ( ! defined( 'BROADCASTSERVICE_CLASS_VERSION' ) )
    require_once( 'trql.broadcastservice.class.php' );



defined( 'RADIOBROADCASTSERVICE_CLASS_VERSION' ) or define( 'RADIOBROADCASTSERVICE_CLASS_VERSION','0.1' );
...
/** {{*class RadioBroadcastService=
    ...
    *}
    ...
    {*doc [url]http://schema.org/RadioBroadcastService[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of RadioBroadcastService.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of RadioBroadcastService.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class RadioBroadcastService ====================================================== */
/* ==================================================================================== */
