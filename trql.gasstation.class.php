...
/** {{{*fheader
    {*file                  trql.gasstation.class.php *}
    {*purpose               A gas station. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'GASSTATION_CLASS_VERSION' ) or define( 'GASSTATION_CLASS_VERSION','0.1' );
...
/** {{*class GasStation=
    ...
    *}
    ...
    {*doc [url]http://schema.org/GasStation[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->autodoc();
        $this->UIKey();
    }   /* End of GasStation.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class GasStation ====================================================== */
/* ==================================================================================== */
