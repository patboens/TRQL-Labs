...
defined( 'COUNTRY_CLASS_VERSION' ) or define( 'COUNTRY_CLASS_VERSION','0.1' );
...
/** {{*class Country=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Country[/url] *}
