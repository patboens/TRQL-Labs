...
/** {{{*fheader
    {*file                  trql.televisionstation.class.php *}
    {*purpose               A television station. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'TELEVISIONSTATION_CLASS_VERSION' ) or define( 'TELEVISIONSTATION_CLASS_VERSION','0.1' );
...
/** {{*class TelevisionStation=
    ...
    *}
    ...
    {*doc [url]http://schema.org/TelevisionStation[/url] *}
...
/*-----------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of TelevisionStation.__construct() ===================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of TelevisionStation.__destruct() ====================================== */
    /* ================================================================================ */
