...
/** {{{*fheader
    {*file                  trql.mapcategorytype.class.php *}
    {*purpose               An enumeration of several kinds of Map. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
/****************************************************************************************/
namespace trql\mapcategorytype;
...
defined( 'MAPCATEGORYTYPE_CLASS_VERSION' ) or define( 'MAPCATEGORYTYPE_CLASS_VERSION','0.1' );
...
/** {{*class MapCategoryType=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MapCategoryType[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of MapCategoryType.__construct() ========================================== */
    /* ================================================================================ */
