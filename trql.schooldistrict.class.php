...
/** {{{*fheader
    {*file                  trql.schooldistrict.class.php *}
    {*purpose               A School District is an administrative area for the
...
defined( 'SCHOOLDISTRICT_CLASS_VERSION' ) or define( 'SCHOOLDISTRICT_CLASS_VERSION','0.1' );
...
/** {{*class SchoolDistrict=
    ...
    *}
    ...
    {*doc [url]http://schema.org/SchoolDistrict[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of SchoolDistrict.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of SchoolDistrict.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class SchoolDistrict ====================================================== */
/* ==================================================================================== */
