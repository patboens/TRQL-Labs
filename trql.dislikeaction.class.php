...
/** {{{*fheader
    {*file                  trql.dislikeaction.class.php *}
    {*purpose               The act of expressing a negative sentiment about the object.
...
defined( 'DISLIKEACTION_CLASS_VERSION' ) or define( 'DISLIKEACTION_CLASS_VERSION','0.1' );
...
/** {{*class DislikeAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/DislikeAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of DislikeAction.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->autodoc();
        $this->UIKey();
    }   /* End of DislikeAction.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class DislikeAction ====================================================== */
/* ==================================================================================== */
