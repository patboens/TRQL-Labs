...
/** {{{*fheader
    {*file                  trql.restricteddiet.class.php *}
    {*purpose               A diet restricted to certain foods or preparations for
...
defined( 'RESTRICTEDDIET_CLASS_VERSION' ) or define( 'RESTRICTEDDIET_CLASS_VERSION','0.1' );
...
/** {{*class RestrictedDiet=
    ...
    *}
    ...
    {*doc [url]http://schema.org/RestrictedDiet[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of RestrictedDiet.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of RestrictedDiet.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class RestrictedDiet ====================================================== */
/* ==================================================================================== */
