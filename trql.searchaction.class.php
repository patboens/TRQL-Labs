...
/** {{{*fheader
    {*file                  trql.searchaction.class.php *}
    {*purpose               The act of searching for an object.Related
                            actions:FindAction: SearchAction generally leads to a
...
defined( 'SEARCHACTION_CLASS_VERSION' ) or define( 'SEARCHACTION_CLASS_VERSION','0.1' );
...
/** {{*class SearchAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/SearchAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $query                          = null;             /* {*property   $query                          (string)                        A sub property of instrument. The query used on this action. *} */
