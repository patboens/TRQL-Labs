...
/** {{{*fheader
    {*file                  trql.outletstore.class.php *}
    {*purpose               An outlet store. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'OUTLETSTORE_CLASS_VERSION' ) or define( 'OUTLETSTORE_CLASS_VERSION','0.1' );
...
/** {{*class OutletStore=
    ...
    *}
    ...
    {*doc [url]http://schema.org/OutletStore[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of OutletStore.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of OutletStore.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class OutletStore ====================================================== */
/* ==================================================================================== */
