...
/** {{{*fheader
    {*file                  trql.travelaction.class.php *}
    {*purpose               The act of traveling from an fromLocation to a destination
                            by a specified mode of transport, optionally with
                            participants. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'TRAVELACTION_CLASS_VERSION' ) or define( 'TRAVELACTION_CLASS_VERSION','0.1' );
...
/** {{*class TravelAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/TravelAction[/url] *}
