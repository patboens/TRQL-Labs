...
/** {{{*fheader
    {*file                  trql.gendertype.class.php *}
    {*purpose               An enumeration of genders. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'GENDERTYPE_CLASS_VERSION' ) or define( 'GENDERTYPE_CLASS_VERSION','0.1' );
...
/** {{*class GenderType=
    ...
    *}
    ...
    {*doc [url]http://schema.org/GenderType[/url] *}
