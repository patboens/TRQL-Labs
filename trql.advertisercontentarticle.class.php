...
/** {{{*fheader
    {*file                  trql.advertisercontentarticle.class.php *}
    {*purpose               An Article that an external entity has paid to place or to
                            produce to its specifications. Includes advertorials,
                            sponsored content, native advertising and other paid
                            content. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'ADVERTISERCONTENTARTICLE_CLASS_VERSION' ) or define( 'ADVERTISERCONTENTARTICLE_CLASS_VERSION','0.1' );
...
/** {{*class AdvertiserContentArticle=
    ...
    {*desc
        ...
        specifications. Includes advertorials, sponsored content, native advertising
    ...
    *}
    ...
    {*doc [url]http://schema.org/AdvertiserContentArticle[/url] *}
