...
/** {{{*fheader
    {*file                  trql.collegeoruniversity.class.php *}
    {*purpose               A college, university, or other third-level educational
                            institution. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'COLLEGEORUNIVERSITY_CLASS_VERSION' ) or define( 'COLLEGEORUNIVERSITY_CLASS_VERSION','0.1' );
...
/** {{*class CollegeOrUniversity=
    ...
    *}
    ...
    {*doc [url]http://schema.org/CollegeOrUniversity[/url] *}
...
/*------------------------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of CollegeOrUniversity.__construct() =================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of CollegeOrUniversity.__destruct() ==================================== */
    /* ================================================================================ */
