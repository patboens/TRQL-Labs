...
/** {{{*fheader
    {*file                  trql.ddxelement.class.php *}
    {*purpose               An alternative, closely-related condition typically
                            considered later in the differential diagnosis process along
...
defined( 'DDXELEMENT_CLASS_VERSION' ) or define( 'DDXELEMENT_CLASS_VERSION','0.1' );
...
/** {{*class DDxElement=
    ...
    *}
    ...
    {*doc [url]http://schema.org/DDxElement[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $distinguishingSign             = null;             /* {*property   $distinguishingSign             (MedicalSignOrSymptom)          One of a set of signs and symptoms that can be used to distinguish
