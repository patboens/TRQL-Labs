...
/** {{{*fheader
    {*file                  trql.childcare.class.php *}
    {*purpose               A Childcare center. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'CHILDCARE_CLASS_VERSION' ) or define( 'CHILDCARE_CLASS_VERSION','0.1' );
...
/** {{*class ChildCare=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ChildCare[/url] *}
...
/*---------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of ChildCare.__destruct() ============================================== */
    /* ================================================================================ */
}   /* End of class ChildCare ========================================================= */
/* ==================================================================================== */
?>