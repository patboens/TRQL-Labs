...
/** {{{*fheader
    {*file                  trql.medicalintangible.class.php *}
    {*purpose               A utility class that serves as the umbrella for a number of
    ...
    *}}} */
/****************************************************************************************/
namespace trql\medicalintangible;
...
defined( 'MEDICALINTANGIBLE_CLASS_VERSION' ) or define( 'MEDICALINTANGIBLE_CLASS_VERSION','0.1' );
...
/** {{*class MedicalIntangible=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MedicalIntangible[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of MedicalIntangible.__construct() ========================================== */
    /* ================================================================================ */
...
}   /* End of class MedicalIntangible ====================================================== */
/* ==================================================================================== */
