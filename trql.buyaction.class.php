...
/*--------------------------------------*/
{
    ...
    public      $vendor                         = null;             /* {*property   $vendor                         (Organization|Person)           'vendor' is an earlier term for 'seller'. *} */
    public      $warrantyPromise                = null;             /* {*property   $warrantyPromise                (WarrantyPromise)               The warranty promise(s) included in the offer. *} */
