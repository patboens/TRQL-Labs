...
/** {{{*fheader
    {*file                  trql.maximumdoseschedule.class.php *}
    {*purpose               The maximum dosing schedule considered safe for a drug or
...
/****************************************************************************************/
namespace trql\maximumdoseschedule;
...
defined( 'MAXIMUMDOSESCHEDULE_CLASS_VERSION' ) or define( 'MAXIMUMDOSESCHEDULE_CLASS_VERSION','0.1' );
...
/** {{*class MaximumDoseSchedule=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MaximumDoseSchedule[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of MaximumDoseSchedule.__construct() ========================================== */
    /* ================================================================================ */
...
}   /* End of class MaximumDoseSchedule ====================================================== */
/* ==================================================================================== */
