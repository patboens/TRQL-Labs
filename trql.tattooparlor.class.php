...
/** {{{*fheader
    {*file                  trql.tattooparlor.class.php *}
    {*purpose               A tattoo parlor. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'TATTOOPARLOR_CLASS_VERSION' ) or define( 'TATTOOPARLOR_CLASS_VERSION','0.1' );
...
/** {{*class TattooParlor=
    ...
    *}
    ...
    {*doc [url]http://schema.org/TattooParlor[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of TattooParlor.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of TattooParlor.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class TattooParlor ====================================================== */
/* ==================================================================================== */
