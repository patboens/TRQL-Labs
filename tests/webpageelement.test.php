...
/****************************************************************************** */
/** {{{*fheader
    {*file                  webpageelement.test.php *}
    {*purpose               Script that tests the webpageelement class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*webpageelement()=
        ...
        Basic test of the webpageelement class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/webpageelement.test.php
        *}
...
if ( ! defined( 'WEBPAGEELEMENT_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.webpageelement.class.php' );

$o = new webpageelement();
...
{
    var_dump('Documentation of "webpageelement" outdated');
    $o->document();
}
