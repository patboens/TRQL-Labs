...
/****************************************************************************** */
/** {{{*fheader
    {*file                  nudebeach.test.php *}
    {*purpose               Script that tests the nudebeach class *}
    {*author                {PYB} *}
...
use \trql\nudebeach\NudeBeach   as NudeBeach;

if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.vaesoli.class.php' );

if ( ! defined( 'NUDEBEACH_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.nudebeach.class.php' );
