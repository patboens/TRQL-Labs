...
/****************************************************************************** */
/** {{{*fheader
    {*file                  voltaire.test.php *}
    {*purpose               Script that tests the voltaire class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*voltaire()=
        ...
        Basic test of the voltaire class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/voltaire.test.php
        *}
...
use \trql\voltaire\Voltaire as voltaire;
...
{
    var_dump('Documentation of "voltaire" outdated');
    $o->document();
}
