...
/****************************************************************************** */
/** {{{*fheader
    {*file                  watchaction.test.php *}
    {*purpose               Script that tests the watchaction class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*watchaction()=
        ...
        Basic test of the watchaction class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/watchaction.test.php
        *}
...
use \trql\watchaction\Watchaction as watchaction;

if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.vaesoli.class.php' );

if ( ! defined( 'WATCHACTION_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.watchaction.class.php' );
...
{
    var_dump('Documentation of "watchaction" outdated');
    $o->document();
}
