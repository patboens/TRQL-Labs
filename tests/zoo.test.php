...
/** {{{*fheader
    {*file                  zoo.test.php *}
    {*purpose               Script that tests the zoo class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*zoo()=
        ...
        *}
        ...
        {*example
            http://trql.io/tests/zoo.test.php
        *}
...
use \trql\zoo\Zoo as zoo;

if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.vaesoli.class.php' );

if ( ! defined( 'ZOO_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.zoo.class.php' );
...
{
    var_dump('Documentation of "zoo" outdated');
    $o->document();
}
