...
/****************************************************************************** */
/** {{{*fheader
    {*file                  wearaction.test.php *}
    {*purpose               Script that tests the wearaction class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*wearaction()=
        ...
        Basic test of the wearaction class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/wearaction.test.php
        *}
...
use \trql\wearaction\Wearaction as wearaction;

if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.vaesoli.class.php' );

if ( ! defined( 'WEARACTION_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.wearaction.class.php' );
...
{
    var_dump('Documentation of "wearaction" outdated');
    $o->document();
}
