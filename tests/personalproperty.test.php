...
/****************************************************************************** */
/** {{{*fheader
    {*file                  personalproperty.test.php *}
    {*purpose               Script that tests the PersonalProperty class *}
    {*author                {PYB} *}
...
use \trql\personalproperty\PersonalProperty     as TheObj;

if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.vaesoli.class.php' );

if ( ! defined( 'PERSONALPROPERTY_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.personalproperty.class.php' );
