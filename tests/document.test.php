...
/****************************************************************************** */
/** {{{*fheader
    {*file                  document.test.php *}
    {*purpose               Script that tests the document class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*document()=
        ...
        Basic test of the document class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/document.test.php
        *}
...
if ( ! defined( 'DOCUMENT_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.document.class.php' );
...
{
    var_dump('Documentation of "document" outdated');
    $o->document();
}
