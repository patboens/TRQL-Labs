...
/****************************************************************************** */
/** {{{*fheader
    {*file                  webcontent.test.php *}
    {*purpose               Script that tests the webcontent class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*webcontent()=
        ...
        Basic test of the webcontent class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/webcontent.test.php
        *}
...
if ( ! defined( 'WEBCONTENT_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.webcontent.class.php' );
...
{
    var_dump('Documentation of "webcontent" outdated');
    $o->document();
}
