...
/****************************************************************************** */
/** {{{*fheader
    {*file                  vessel.test.php *}
    {*purpose               Script that tests the vessel class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*vessel()=
        ...
        Basic test of the vessel class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/vessel.test.php
        *}
...
if ( ! defined( 'VESSEL_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.vessel.class.php' );
...
{
    var_dump('Documentation of "vessel" outdated');
    $o->document();
}
