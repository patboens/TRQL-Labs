...
/****************************************************************************** */
/** {{{*fheader
    {*file                  whatwasdone.test.php *}
    {*purpose               Script that tests the whatwasdone class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*whatwasdone()=
        ...
        Basic test of the whatwasdone class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/whatwasdone.test.php
        *}
...
use \trql\whatwasdone\Whatwasdone as whatwasdone;

if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.vaesoli.class.php' );

if ( ! defined( 'WHATWASDONE_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.whatwasdone.class.php' );
...
{
    var_dump('Documentation of "whatwasdone" outdated');
    $o->document();
}
