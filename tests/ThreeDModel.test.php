...
/****************************************************************************** */
/** {{{*fheader
    {*file                  ThreeDModel.test.php *}
    {*purpose               Script that tests the 3dmodel class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*3dmodel()=
        ...
        Basic test of the 3dmodel class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/3dmodel.test.php
        *}
...
use \trql\threedmodel\ThreeDModel   as ThreeDModel;

if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.vaesoli.class.php' );

if ( ! defined( '3DMODEL_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.threedmodel.class.php' );
...
{
    var_dump('Documentation of "ThreeDModel" outdated');
    $o->document();
}
