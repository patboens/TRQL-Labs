...
/****************************************************************************** */
/** {{{*fheader
    {*file                  kanbanboard.test.php *}
    {*purpose               Script that tests the kanbanboard class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*kanbanboard()=
        ...
        Basic test of the kanbanboard class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/kanbanboard.test.php
        *}
...
use \trql\kanbanboard\Kanbanboard   as TheObj;

if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.vaesoli.class.php' );

if ( ! defined( 'KANBANBOARD_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.kanbanboard.class.php' );
...
{
    var_dump('Documentation of "kanbanboard" outdated');
    $o->document();
}
