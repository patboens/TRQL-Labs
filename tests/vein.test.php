...
/** {{{*fheader
    {*file                  vein.test.php *}
    {*purpose               Script that tests the vein class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*vein()=
        ...
        *}
        ...
        {*example
            http://trql.io/tests/vein.test.php
        *}
...
use \trql\vein\Vein as vein;

if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.vaesoli.class.php' );

if ( ! defined( 'VEIN_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.vein.class.php' );
...
{
    var_dump('Documentation of "vein" outdated');
    $o->document();
}
