...
/****************************************************************************** */
/** {{{*fheader
    {*file                  videoobject.test.php *}
    {*purpose               Script that tests the videoobject class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*videoobject()=
        ...
        Basic test of the videoobject class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/videoobject.test.php
        *}
...
use \trql\videoobject\Videoobject as videoobject;

if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.vaesoli.class.php' );

if ( ! defined( 'VIDEOOBJECT_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.videoobject.class.php' );
...
{
    var_dump('Documentation of "videoobject" outdated');
    $o->document();
}
