...
/****************************************************************************** */
/** {{{*fheader
    {*file                  definedtermset.test.php *}
    {*purpose               Script that tests the definedtermset class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*definedtermset()=
        ...
        Basic test of the definedtermset class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/definedtermset.test.php
        *}
...
{
    var_dump('Documentation of "definedtermset" outdated');
    $o->document();
}
