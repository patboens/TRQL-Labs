...
/****************************************************************************** */
/** {{{*fheader
    {*file                  voteaction.test.php *}
    {*purpose               Script that tests the voteaction class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*voteaction()=
        ...
        Basic test of the voteaction class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/voteaction.test.php
        *}
...
use \trql\voteaction\Voteaction as voteaction;

if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.vaesoli.class.php' );

if ( ! defined( 'VOTEACTION_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.voteaction.class.php' );
...
{
    var_dump('Documentation of "voteaction" outdated');
    $o->document();
}
