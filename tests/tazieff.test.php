...
/****************************************************************************** */
/** {{{*fheader
    {*file                  tazieff.test.php *}
    {*purpose               Script that tests the tazieff class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*tazieff()=
        ...
        Basic test of the tazieff class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/tazieff.test.php
        *}
...
use \trql\tazieff\Tazieff   as tazieff;
