...
/****************************************************************************** */
/** {{{*fheader
    {*file                  videogame.test.php *}
    {*purpose               Script that tests the videogame class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*videogame()=
        ...
        Basic test of the videogame class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/videogame.test.php
        *}
...
use \trql\videogame\Videogame as videogame;

if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.vaesoli.class.php' );

if ( ! defined( 'VIDEOGAME_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.videogame.class.php' );
...
{
    var_dump('Documentation of "videogame" outdated');
    $o->document();
}
