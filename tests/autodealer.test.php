...
/****************************************************************************** */
/** {{{*fheader
    {*file                  autodealer.test.php *}
    {*purpose               Script that tests the autodealer class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*autodealer()=
        ...
        Basic test of the autodealer class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/autodealer.test.php
        *}
...
use \trql\automotive\AutoDealer     as AutoDealer;

if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.vaesoli.class.php' );

if ( ! defined( 'AUTODEALER_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.autodealer.class.php' );
...
{
    var_dump('Documentation of "autodealer" outdated');
    $o->document();
}
