...
/****************************************************************************** */
/** {{{*fheader
    {*file                  autowash.test.php *}
    {*purpose               Script that tests the autowash class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*autowash()=
        ...
        Basic test of the autowash class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/autowash.test.php
        *}
...
use \trql\automotive\Autowash   as AutoWash;

if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.vaesoli.class.php' );

if ( ! defined( 'AUTOWASH_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.autowash.class.php' );
...
{
    var_dump('Documentation of "autowash" outdated');
    $o->document();
}
