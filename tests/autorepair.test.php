...
/****************************************************************************** */
/** {{{*fheader
    {*file                  autorepair.test.php *}
    {*purpose               Script that tests the autorepair class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*autorepair()=
        ...
        Basic test of the autorepair class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/autorepair.test.php
        *}
...
use \trql\automotive\AutoRepair     as AutoRepair;

if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.vaesoli.class.php' );

if ( ! defined( 'AUTOREPAIR_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.autorepair.class.php' );
...
{
    var_dump('Documentation of "autorepair" outdated');
    $o->document();
}
