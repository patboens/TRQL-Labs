...
/****************************************************************************** */
/** {{{*fheader
    {*file                  automotivebusiness.test.php *}
    {*purpose               Script that tests the automotivebusiness class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*automotivebusiness()=
        ...
        Basic test of the automotivebusiness class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/automotivebusiness.test.php
        *}
...
if ( ! defined( 'AUTOMOTIVEBUSINESS_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.automotivebusiness.class.php' );

$o = new AutomotiveBusiness();
...
{
    var_dump('Documentation of "automotivebusiness" outdated');
    $o->document();
}
