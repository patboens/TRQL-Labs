...
/****************************************************************************** */
/** {{{*fheader
    {*file                  volcano.test.php *}
    {*purpose               Script that tests the volcano class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*volcano()=
        ...
        Basic test of the volcano class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/volcano.test.php
        *}
...
use \trql\volcano\Volcano as volcano;

if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.vaesoli.class.php' );

if ( ! defined( 'VOLCANO_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.volcano.class.php' );
...
{
    var_dump('Documentation of "volcano" outdated');
    $o->document();
}
