...
/****************************************************************************** */
/** {{{*fheader
    {*file                  french.test.php *}
    {*purpose               Script that tests the french class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*french()=
        ...
        Basic test of the french class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/french.test.php
        *}
...
use \trql\language\French   as french;

if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.vaesoli.class.php' );

if ( ! defined( 'FRENCH_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.french.class.php' );
...
{
    var_dump('Documentation of "french" outdated');
    $o->document();
}
