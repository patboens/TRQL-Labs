...
/****************************************************************************** */
/** {{{*fheader
    {*file                  paradeigma.test.php *}
    {*purpose               Script that tests the paradeigma class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*paradeigma()=
        ...
        Basic test of the paradeigma class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/paradeigma.test.php
        *}
...
use \trql\web\Paradeigma    as Paradeigma;

if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.vaesoli.class.php' );

if ( ! defined( 'PARADEIGMA_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.paradeigma.class.php' );
...
{
    var_dump('Documentation of "paradeigma" outdated');
    $o->document();
}
