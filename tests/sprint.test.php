...
/****************************************************************************** */
/** {{{*fheader
    {*file                  sprint.test.php *}
    {*purpose               Script that tests the sprint class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*sprint()=
        ...
        Basic test of the sprint class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/sprint.test.php
        *}
...
if ( ! defined( 'SPRINT_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.sprint.class.php' );
...
{
    var_dump('Documentation of "sprint" outdated');
    $o->document();
}
