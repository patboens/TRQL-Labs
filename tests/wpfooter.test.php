...
/****************************************************************************** */
/** {{{*fheader
    {*file                  wpfooter.test.php *}
    {*purpose               Script that tests the wpfooter class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*wpfooter()=
        ...
        Basic test of the wpfooter class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/wpfooter.test.php
        *}
...
use \trql\wpfooter\Wpfooter as wpfooter;

if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.vaesoli.class.php' );

if ( ! defined( 'WPFOOTER_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.wpfooter.class.php' );
...
{
    var_dump('Documentation of "wpfooter" outdated');
    $o->document();
}
