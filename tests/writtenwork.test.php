...
/****************************************************************************** */
/** {{{*fheader
    {*file                  writtenwork.test.php *}
    {*purpose               Script that tests the writtenwork class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*writtenwork()=
        ...
        Basic test of the writtenwork class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/writtenwork.test.php
        *}
...
if ( ! defined( 'WRITTENWORK_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.writtenwork.class.php' );
...
{
    var_dump('Documentation of "writtenwork" outdated');
    $o->document();
}
