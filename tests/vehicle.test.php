...
/****************************************************************************** */
/** {{{*fheader
    {*file                  vehicle.test.php *}
    {*purpose               Script that tests the vehicle class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*vehicle()=
        ...
        Basic test of the vehicle class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/vehicle.test.php
        *}
...
if ( ! defined( 'VEHICLE_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.vehicle.class.php' );
...
{
    var_dump('Documentation of "vehicle" outdated');
    $o->document();
}
