...
/** {{{*fheader
    ...
    {*purpose               Script that tests the version class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*version()=
        ...
        Basic test of the version class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/version.test.php
        *}
...
use \trql\version\Version as version;

if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.vaesoli.class.php' );

if ( ! defined( 'VERSION_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.version.class.php' );
...
{
    var_dump('Documentation of "version" outdated');
    $o->document();
}
