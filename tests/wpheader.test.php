...
/****************************************************************************** */
/** {{{*fheader
    {*file                  wpheader.test.php *}
    {*purpose               Script that tests the wpheader class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*wpheader()=
        ...
        Basic test of the wpheader class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/wpheader.test.php
        *}
...
use \trql\wpheader\Wpheader as wpheader;

if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.vaesoli.class.php' );

if ( ! defined( 'WPHEADER_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.wpheader.class.php' );
...
{
    var_dump('Documentation of "wpheader" outdated');
    $o->document();
}
