...
/****************************************************************************** */
/** {{{*fheader
    {*file                  wpsidebar.test.php *}
    {*purpose               Script that tests the wpsidebar class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*wpsidebar()=
        ...
        Basic test of the wpsidebar class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/wpsidebar.test.php
        *}
...
use \trql\wpsidebar\Wpsidebar as wpsidebar;

if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.vaesoli.class.php' );

if ( ! defined( 'WPSIDEBAR_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.wpsidebar.class.php' );
...
{
    var_dump('Documentation of "wpsidebar" outdated');
    $o->document();
}
