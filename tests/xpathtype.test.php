...
/****************************************************************************** */
/** {{{*fheader
    {*file                  xpathtype.test.php *}
    {*purpose               Script that tests the xpathtype class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*xpathtype()=
        ...
        Basic test of the xpathtype class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/xpathtype.test.php
        *}
...
use \trql\xpathtype\Xpathtype as xpathtype;

if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.vaesoli.class.php' );

if ( ! defined( 'XPATHTYPE_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.xpathtype.class.php' );
...
{
    var_dump('Documentation of "xpathtype" outdated');
    $o->document();
}
