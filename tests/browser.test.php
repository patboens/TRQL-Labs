...
/****************************************************************************** */
/** {{{*fheader
    {*file                  browser.test.php *}
    {*purpose               Script that tests the browser class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*browser()=
        ...
        Basic test of the browser class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/browser.test.php
        *}
...
{
    $o->document();
    var_dump( 'Documentation of "browser" updated' );
}
