...
/****************************************************************************** */
/** {{{*fheader
    {*file                  wpadblock.test.php *}
    {*purpose               Script that tests the wpadblock class *}
    {*author                {PYB} *}
    ...
    *}}} */
    ...
    /** {{*wpadblock()=
        ...
        Basic test of the wpadblock class
        ...
        *}
        ...
        {*example
            http://trql.io/tests/wpadblock.test.php
        *}
...
use \trql\wpadblock\Wpadblock as wpadblock;

if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.vaesoli.class.php' );

if ( ! defined( 'WPADBLOCK_CLASS_VERSION' ) )
    require_once( 'd:/websites/snippet-center/trql.wpadblock.class.php' );
...
{
    var_dump('Documentation of "wpadblock" outdated');
    $o->document();
}
