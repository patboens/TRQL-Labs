...
/** {{{*fheader
    {*file                  trql.rvpark.class.php *}
    {*purpose               A place offering space for "Recreational Vehicles",
...
defined( 'RVPARK_CLASS_VERSION' ) or define( 'RVPARK_CLASS_VERSION','0.1' );
...
/** {{*class RVPark=
    ...
    *}
    ...
    {*doc [url]http://schema.org/RVPark[/url] *}
