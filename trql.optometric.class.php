...
/** {{{*fheader
    {*file                  trql.optometric.class.php *}
    {*purpose               The science or practice of testing visual acuity and
...
defined( 'OPTOMETRIC_CLASS_VERSION' ) or define( 'OPTOMETRIC_CLASS_VERSION','0.1' );
...
/** {{*class Optometric=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Optometric[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of Optometric.__destruct() ============================================= */
    /* ================================================================================ */

}   /* End of class Optometric ======================================================== */
/* ==================================================================================== */
