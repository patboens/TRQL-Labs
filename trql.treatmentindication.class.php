...
/** {{{*fheader
    {*file                  trql.treatmentindication.class.php *}
    {*purpose               An indication for treating an underlying condition, symptom,
                            etc. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
    ...
    *}}} */
/****************************************************************************************/
namespace trql\treatmentindication;
...
defined( 'TREATMENTINDICATION_CLASS_VERSION' ) or define( 'TREATMENTINDICATION_CLASS_VERSION','0.1' );
...
/** {{*class TreatmentIndication=
    ...
    *}
    ...
    {*doc [url]http://schema.org/TreatmentIndication[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of TreatmentIndication.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of TreatmentIndication.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class TreatmentIndication ====================================================== */
/* ==================================================================================== */
