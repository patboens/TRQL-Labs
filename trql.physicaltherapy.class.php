...
/** {{{*fheader
    {*file                  trql.physicaltherapy.class.php *}
    {*purpose               A process of progressive physical care and rehabilitation
    ...
    *}}} */
/****************************************************************************************/
namespace trql\physicaltherapy;
...
defined( 'PHYSICALTHERAPY_CLASS_VERSION' ) or define( 'PHYSICALTHERAPY_CLASS_VERSION','0.1' );
...
/** {{*class PhysicalTherapy=
    ...
    *}
    ...
    {*doc [url]http://schema.org/PhysicalTherapy[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of PhysicalTherapy.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of PhysicalTherapy.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class PhysicalTherapy ====================================================== */
/* ==================================================================================== */
