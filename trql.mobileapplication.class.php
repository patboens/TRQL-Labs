...
/** {{{*fheader
    {*file                  trql.mobileapplication.class.php *}
    {*purpose               A software application designed specifically to work well on
                            a mobile device such as a telephone. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
    ...
    *}}} */
/****************************************************************************************/
namespace trql\mobileapplication;
...
defined( 'MOBILEAPPLICATION_CLASS_VERSION' ) or define( 'MOBILEAPPLICATION_CLASS_VERSION','0.1' );
...
/** {{*class MobileApplication=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MobileApplication[/url] *}
...
/*-----------------------------------------------*/
{
    ...
    public      $carrierRequirements            = null;             /* {*property   $carrierRequirements            (string)                        Specifies specific carrier(s) requirements for the application (e.g.
