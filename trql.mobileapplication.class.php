...
/*--------------------------------------*/
{
    ...
    public      $applicationSuite               = null;             /* {*property   $applicationSuite               (string)                        The name of the application suite to which the application belongs
    ...
    public      $author                         = null;             /* {*property   $author                         (Organization|Person)           The author of this content or rating. Please note that author is
                                                                                                                                                    ...
                                                                                                                                                    interchangeably. *} */
    public      $availableOnDevice              = null;             /* {*property   $availableOnDevice              (string)                        Device required to run the application. Used in cases where a specific
    ...
    public      $countriesNotSupported          = null;             /* {*property   $countriesNotSupported          (string)                        Countries for which the application is not supported. You can also
                                                                                                                                                    provide the two-letter ISO 3166-1 alpha-2 country code. *} */
    public      $countriesSupported             = null;             /* {*property   $countriesSupported             (string)                        Countries for which the application is supported. You can also provide
    ...
    public      $device                         = null;             /* {*property   $device                         (string)                        Device required to run the application. Used in cases where a specific
                                                                                                                                                    make/model is required to run the application. *} */
    ...
    public      $expires                        = null;             /* {*property   $expires                        (Date)                          Date the content expires and is no longer useful or available. For
                                                                                                                                                    ...
                                                                                                                                                    after some date. *} */
    public      $featureList                    = null;             /* {*property   $featureList                    (URL|string)                    Features or modules provided by this application (and possibly
    ...
    public      $fileFormat                     = null;             /* {*property   $fileFormat                     (URL|string)                    Media type, typically MIME format (see IANA site) of the content e.g.
                                                                                                                                                    ...
                                                                                                                                                    Wikipedia entry. *} */
    public      $fileSize                       = null;             /* {*property   $fileSize                       (string)                        Size of the application / package (e.g. 18MB). In the absence of a
    ...
    public      $installUrl                     = null;             /* {*property   $installUrl                     (URL)                           URL at which the app may be installed, if different from the URL of
                                                                                                                                                    the item. *} */
    ...
    public      $permissions                    = null;             /* {*property   $permissions                    (string)                        Permission(s) required to run the app (for example, a mobile app may
    ...
    public      $releasedEvent                  = null;             /* {*property   $releasedEvent                  (PublicationEvent)              The place and time the release was issued, expressed as a
                                                                                                                                                    PublicationEvent. *} */
    public      $requirements                   = null;             /* {*property   $requirements                   (URL|string)                    Component dependency requirements for application. This includes
    ...
    public      $screenshot                     = null;             /* {*property   $screenshot                     (URL|ImageObject)               A link to a screenshot image of the app. *} */
    ...
    public      $softwareRequirements           = null;             /* {*property   $softwareRequirements           (URL|string)                    Component dependency requirements for application. This includes
                                                                                                                                                    runtime environments and shared libraries that are not included in the
                                                                                                                                                    application distribution package, but required to run the application
                                                                                                                                                    (Examples: DirectX, Java or .NET runtime). *} */
    ...
    public      $storageRequirements            = null;             /* {*property   $storageRequirements            (URL|string)                    Storage requirements (free space required). *} */
