...
/** {{{*fheader
    {*file                  trql.eventvenue.class.php *}
    {*purpose               An event venue. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'EVENTVENUE_CLASS_VERSION' ) or define( 'EVENTVENUE_CLASS_VERSION','0.1' );
...
/** {{*class EventVenue=
    ...
    *}
    ...
    {*doc [url]http://schema.org/EventVenue[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->autodoc();
        $this->UIKey();
    }   /* End of EventVenue.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class EventVenue ====================================================== */
/* ==================================================================================== */
