...
/** {{{*fheader
    {*file                  trql.dietarysupplement.class.php *}
    {*purpose               A product taken by mouth that contains a dietary ingredient
...
/****************************************************************************************/
namespace trql\dietarysupplement;
...
defined( 'DIETARYSUPPLEMENT_CLASS_VERSION' ) or define( 'DIETARYSUPPLEMENT_CLASS_VERSION','0.1' );
...
/** {{*class DietarySupplement=
    ...
    *}
    ...
    {*doc [url]http://schema.org/DietarySupplement[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $recommendedIntake              = null;             /* {*property   $recommendedIntake              (RecommendedDoseSchedule)       Recommended intake of this supplement for a given population as
                                                                                                                                                    defined by a specific recommending authority. *} */
    ...
    public      $safetyConsideration            = null;             /* {*property   $safetyConsideration            (string)                        Any potential safety concern associated with the supplement. May
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of DietarySupplement.__construct() ========================================== */
    /* ================================================================================ */
...
}   /* End of class DietarySupplement ====================================================== */
/* ==================================================================================== */
