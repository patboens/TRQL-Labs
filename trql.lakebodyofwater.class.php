...
/** {{{*fheader
    {*file                  trql.lakebodyofwater.class.php *}
    {*purpose               A lake (for example, Lake Pontrachain). *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
/****************************************************************************************/
namespace trql\lakebodyofwater;
...
defined( 'LAKEBODYOFWATER_CLASS_VERSION' ) or define( 'LAKEBODYOFWATER_CLASS_VERSION','0.1' );
...
/** {{*class LakeBodyOfWater=
    ...
    *}
    ...
    {*doc [url]http://schema.org/LakeBodyOfWater[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of LakeBodyOfWater.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->autodoc();
        $this->UIKey();
    }   /* End of LakeBodyOfWater.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class LakeBodyOfWater ====================================================== */
/* ==================================================================================== */
