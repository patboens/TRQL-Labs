...
/** {{{*fheader
    {*file                  trql.reviewaction.class.php *}
    {*purpose               The act of producing a balanced opinion about the object for
...
defined( 'REVIEWACTION_CLASS_VERSION' ) or define( 'REVIEWACTION_CLASS_VERSION','0.1' );
...
/** {{*class ReviewAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ReviewAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $resultReview                   = null;             /* {*property   $resultReview                   (Review)                        A sub property of result. The review that resulted in the performing
                                                                                                                                                    of the action. *} */
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of ReviewAction.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of ReviewAction.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class ReviewAction ====================================================== */
/* ==================================================================================== */
