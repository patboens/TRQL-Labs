...
/** {{{*fheader
    {*file                  trql.movingcompany.class.php *}
    {*purpose               A moving company. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'MOVINGCOMPANY_CLASS_VERSION' ) or define( 'MOVINGCOMPANY_CLASS_VERSION','0.1' );
...
/** {{*class MovingCompany=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MovingCompany[/url] *}
...
/*---------------------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of MovingCompany.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of MovingCompany.__destruct() ========================================== */
    /* ================================================================================ */
}   /* End of class MovingCompany ===================================================== */
/* ==================================================================================== */
?>