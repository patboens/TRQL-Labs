...
defined( 'USERLIKES_CLASS_VERSION' ) or define( 'USERLIKES_CLASS_VERSION','0.1' );
...
/** {{*class UserLikes=
    ...
    *}
    ...
    {*doc [url]http://schema.org/UserLikes[/url] *}
...
/*------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of UserLikes.__destruct() ============================================== */
    /* ================================================================================ */
}   /* End of class UserLikes ========================================================= */
/* ==================================================================================== */
?>