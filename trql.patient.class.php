...
use \trql\medicalaudience\MedicalAudience   as MedicalAudience;

if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'trql.vaesoli.class.php' );

if ( ! defined( 'MEDICALAUDIENCE_CLASS_VERSION' ) )
    require_once( 'trql.medicalaudience.class.php' );
...
/*---------------------------------*/
{
    ...
    public      $wikidataId                     = 'Q181600';        /* {*property   $wikidataId                     (string)                        Wikidata ID. Person who takes a medical treatment or is subject of
                                                                                                                                                    a case study *} */
