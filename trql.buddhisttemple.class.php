...
/** {{{*fheader
    {*file                  trql.buddhisttemple.class.php *}
    {*purpose               A Buddhist temple. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'BUDDHISTTEMPLE_CLASS_VERSION' ) or define( 'BUDDHISTTEMPLE_CLASS_VERSION','0.1' );
...
/** {{*class BuddhistTemple=
    ...
    *}
    ...
    {*doc [url]http://schema.org/BuddhistTemple[/url] *}
...
/*---------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of BuddhistTemple.__construct() ======================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of BuddhistTemple.__destruct() ========================================= */
    /* ================================================================================ */
}   /* End of class BuddhistTemple ==================================================== */
/* ==================================================================================== */
?>