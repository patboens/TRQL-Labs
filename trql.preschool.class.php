...
defined( 'PRESCHOOL_CLASS_VERSION' ) or define( 'PRESCHOOL_CLASS_VERSION','0.1' );
...
/** {{*class Preschool=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Preschool[/url] *}
