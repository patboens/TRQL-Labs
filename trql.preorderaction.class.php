...
/** {{{*fheader
    {*file                  trql.preorderaction.class.php *}
    {*purpose               An agent orders a (not yet released) object/product/service
                            to be delivered/sent. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'PREORDERACTION_CLASS_VERSION' ) or define( 'PREORDERACTION_CLASS_VERSION','0.1' );
...
/** {{*class PreOrderAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/PreOrderAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of PreOrderAction.__construct() ======================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of PreOrderAction.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class PreOrderAction ====================================================== */
/* ==================================================================================== */
