...
/** {{{*fheader
    {*file                  trql.bedtype.class.php *}
    {*purpose               A type of bed. This is used for indicating the bed or beds
...
defined( 'BEDTYPE_CLASS_VERSION' ) or define( 'BEDTYPE_CLASS_VERSION','0.1' );
...
/** {{*class BedType=
    ...
    *}
    ...
    {*doc [url]http://schema.org/BedType[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of BedType.__destruct() ================================================ */
    /* ================================================================================ */
}   /* End of class BedType =========================================================== */
/* ==================================================================================== */
?>