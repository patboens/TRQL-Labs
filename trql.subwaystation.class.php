...
/** {{{*fheader
    {*file                  trql.subwaystation.class.php *}
    {*purpose               A subway station. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'SUBWAYSTATION_CLASS_VERSION' ) or define( 'SUBWAYSTATION_CLASS_VERSION','0.1' );
...
/** {{*class SubwayStation=
    ...
    *}
    ...
    {*doc [url]http://schema.org/SubwayStation[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of SubwayStation.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of SubwayStation.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class SubwayStation ====================================================== */
/* ==================================================================================== */
