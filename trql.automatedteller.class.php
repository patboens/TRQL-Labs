...
/** {{{*fheader
    {*file                  trql.automatedteller.class.php *}
    {*purpose               ATM/cash machine. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
/****************************************************************************************/
namespace trql\automatedteller;
...
defined( 'AUTOMATEDTELLER_CLASS_VERSION' ) or define( 'AUTOMATEDTELLER_CLASS_VERSION','0.1' );
...
/** {{*class AutomatedTeller=
    ...
    *}
    ...
    {*doc [url]http://schema.org/AutomatedTeller[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $wikidataId                         = 'Q81235';     /* {*property   $wikidataId                     (string)                        Wikidata ID. Automated teller machine: electronic banking kiosk *} */
