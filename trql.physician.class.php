...
/** {{{*fheader
    {*file                  trql.physician.class.php *}
    {*purpose               A doctor's office. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
    ...
    *}}} */
/****************************************************************************************/
namespace trql\physician;

use \trql\vaesoli\Vaesoli                   as Vaesoli;
use \trql\medicalbusiness, medicalorganization\MedicalBusiness, MedicalOrganization    as MedicalBusiness, MedicalOrganization;


if ( ! defined( 'VAESOLI_CLASS_VERSION' ) )
    require_once( 'trql.vaesoli.class.php' );

if ( ! defined( 'MEDICALBUSINESS, MEDICALORGANIZATION_CLASS_VERSION' ) )
    require_once( 'trql.medicalbusiness, medicalorganization.class.php' );



defined( 'PHYSICIAN_CLASS_VERSION' ) or define( 'PHYSICIAN_CLASS_VERSION','0.1' );
...
/** {{*class Physician=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Physician[/url] *}
 ...
 */
/* ==================================================================================== */
class Physician extends MedicalBusiness, MedicalOrganization
/*--------------------------------------*/
{
    ...
    public      $hospitalAffiliation            = null;             /* {*property   $hospitalAffiliation            (Hospital)                      A hospital with which the physician or office is affiliated. *} */
