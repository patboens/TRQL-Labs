...
/** {{{*fheader
    {*file                  trql.muscle.class.php *}
    {*purpose               A muscle is an anatomical structure consisting of a
...
defined( 'MUSCLE_CLASS_VERSION' ) or define( 'MUSCLE_CLASS_VERSION','0.1' );
...
/** {{*class Muscle=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Muscle[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $antagonist                     = null;             /* {*property   $antagonist                     (Muscle)                        The muscle whose action counteracts the specified muscle. *} */
    ...
    public      $bloodSupply                    = null;             /* {*property   $bloodSupply                    (Vessel)                        The blood vessel that carries blood from the heart to the muscle. *} */
    ...
    public      $image                          = null;             /* {*property   $image                          (ImageObject|URL)               An image of the item. This can be a URL or a fully described
                                                                                                                                                    ImageObject. *} */
    public      $insertion                      = null;             /* {*property   $insertion                      (AnatomicalStructure)           The place of attachment of a muscle, or what the muscle moves. *} */
    ...
    public      $muscleAction                   = null;             /* {*property   $muscleAction                   (string)                        The movement the muscle generates. *} */
    public      $name                           = null;             /* {*property   $name                           (string)                        The name of the item. *} */
    public      $nerve                          = null;             /* {*property   $nerve                          (Nerve)                         The underlying innervation associated with the muscle. *} */
