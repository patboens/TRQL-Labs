...
/** {{{*fheader
    {*file                  trql.medicalbusiness.class.php *}
    {*purpose               A particular physical or virtual business of an organization
                            for medical purposes. Examples of MedicalBusiness include
...
/** {{*class MedicalBusiness=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MedicalBusiness[/url] *}
...
/*----------------------------------------*/
{
    ...
    public      $wikidataId                     = null;             /* {*property   $wikidataId                     (string)                        Wikidata ID. NOT CHECKED SO FAR (26-02-21 07:47:49). *} */
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of MedicalBusiness.__construct() ======================================= */
    /* ================================================================================ */
