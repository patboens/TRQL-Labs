...
/** {{{*fheader
    {*file                  trql.foodevent.class.php *}
    {*purpose               Event type: Food event. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'FOODEVENT_CLASS_VERSION' ) or define( 'FOODEVENT_CLASS_VERSION','0.1' );
...
/** {{*class FoodEvent=
    ...
    *}
    ...
    {*doc [url]http://schema.org/FoodEvent[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->autodoc();
        $this->UIKey();
    }   /* End of FoodEvent.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class FoodEvent ====================================================== */
/* ==================================================================================== */
