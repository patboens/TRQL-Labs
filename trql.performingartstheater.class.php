...
/** {{{*fheader
    {*file                  trql.performingartstheater.class.php *}
    {*purpose               A theater or other performing art center. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
    ...
    *}}} */
/****************************************************************************************/
namespace trql\performingartstheater;
...
defined( 'PERFORMINGARTSTHEATER_CLASS_VERSION' ) or define( 'PERFORMINGARTSTHEATER_CLASS_VERSION','0.1' );
...
/** {{*class PerformingArtsTheater=
    ...
    *}
    ...
    {*doc [url]http://schema.org/PerformingArtsTheater[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of PerformingArtsTheater.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of PerformingArtsTheater.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class PerformingArtsTheater ====================================================== */
/* ==================================================================================== */
