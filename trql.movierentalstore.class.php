...
/** {{{*fheader
    {*file                  trql.movierentalstore.class.php *}
    {*purpose               A movie rental store. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'MOVIERENTALSTORE_CLASS_VERSION' ) or define( 'MOVIERENTALSTORE_CLASS_VERSION','0.1' );
...
/** {{*class MovieRentalStore=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MovieRentalStore[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of MovieRentalStore.__construct() ====================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of MovieRentalStore.__destruct() ======================================= */
    /* ================================================================================ */

}   /* End of class MovieRentalStore ================================================== */
/* ==================================================================================== */
