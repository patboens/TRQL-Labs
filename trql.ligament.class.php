...
/** {{{*fheader
    {*file                  trql.ligament.class.php *}
    {*purpose               A short band of tough, flexible, fibrous connective tissue
...
defined( 'LIGAMENT_CLASS_VERSION' ) or define( 'LIGAMENT_CLASS_VERSION','0.1' );
...
/** {{*class Ligament=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Ligament[/url] *}
