...
/** {{{*fheader
    {*file                  trql.installaction.class.php *}
    {*purpose               The act of installing an application. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'INSTALLACTION_CLASS_VERSION' ) or define( 'INSTALLACTION_CLASS_VERSION','0.1' );
...
/** {{*class InstallAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/InstallAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of InstallAction.__construct() ========================================== */
    /* ================================================================================ */
