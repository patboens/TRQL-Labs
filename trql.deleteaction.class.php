...
/** {{{*fheader
    {*file                  trql.deleteaction.class.php *}
    {*purpose               The act of editing a recipient by removing one of its
                            objects. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'DELETEACTION_CLASS_VERSION' ) or define( 'DELETEACTION_CLASS_VERSION','0.1' );
...
/** {{*class DeleteAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/DeleteAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of DeleteAction.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of DeleteAction.__destruct() =========================================== */
    /* ================================================================================ */
}   /* End of class DeleteAction ====================================================== */
/* ==================================================================================== */
