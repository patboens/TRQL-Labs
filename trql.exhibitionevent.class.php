...
/** {{{*fheader
    {*file                  trql.exhibitionevent.class.php *}
    {*purpose               Event type: Exhibition event, e.g. at a museum, library,
                            archive, tradeshow, ... *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
/****************************************************************************************/
namespace trql\exhibitionevent;
...
defined( 'EXHIBITIONEVENT_CLASS_VERSION' ) or define( 'EXHIBITIONEVENT_CLASS_VERSION','0.1' );
...
/** {{*class ExhibitionEvent=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ExhibitionEvent[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of ExhibitionEvent.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->autodoc();
        $this->UIKey();
    }   /* End of ExhibitionEvent.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class ExhibitionEvent ====================================================== */
/* ==================================================================================== */
