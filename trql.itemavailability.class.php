...
/** {{{*fheader
    {*file                  trql.itemavailability.class.php *}
    {*purpose               A list of possible product availability options. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
/****************************************************************************************/
namespace trql\itemavailability;
...
defined( 'ITEMAVAILABILITY_CLASS_VERSION' ) or define( 'ITEMAVAILABILITY_CLASS_VERSION','0.1' );
...
/** {{*class ItemAvailability=
    ...
    *}
    ...
    {*doc [url]http://schema.org/ItemAvailability[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of ItemAvailability.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of ItemAvailability.__destruct() =========================================== */
    /* ================================================================================ */
