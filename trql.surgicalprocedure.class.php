...
/** {{{*fheader
    {*file                  trql.surgicalprocedure.class.php *}
    {*purpose               A medical procedure involving an incision with instruments;
    ...
    *}}} */
/****************************************************************************************/
namespace trql\surgicalprocedure;
...
defined( 'SURGICALPROCEDURE_CLASS_VERSION' ) or define( 'SURGICALPROCEDURE_CLASS_VERSION','0.1' );
...
/** {{*class SurgicalProcedure=
    ...
    *}
    ...
    {*doc [url]http://schema.org/SurgicalProcedure[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of SurgicalProcedure.__construct() ========================================== */
    /* ================================================================================ */
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of SurgicalProcedure.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class SurgicalProcedure ====================================================== */
/* ==================================================================================== */
