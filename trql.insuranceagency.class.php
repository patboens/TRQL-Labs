...
/** {{{*fheader
    {*file                  trql.insuranceagency.class.php *}
    {*purpose               An Insurance agency. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
/****************************************************************************************/
namespace trql\insuranceagency;
...
defined( 'INSURANCEAGENCY_CLASS_VERSION' ) or define( 'INSURANCEAGENCY_CLASS_VERSION','0.1' );
...
/** {{*class InsuranceAgency=
    ...
    *}
    ...
    {*doc [url]http://schema.org/InsuranceAgency[/url] *}
...
/*------------------------------------------*/
{
    ...
    public      $wikidataId                     = 'Q27038992';      /* {*property   $wikidataId                         (string)                   Wikidata ID. business that offers insurance policies. *} */
