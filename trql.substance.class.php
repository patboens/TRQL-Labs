...
/** {{{*fheader
    {*file                  trql.substance.class.php *}
    {*purpose               Any matter of defined composition that has discrete
                            existence, whose origin may be biological, mineral or
                            chemical. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'SUBSTANCE_CLASS_VERSION' ) or define( 'SUBSTANCE_CLASS_VERSION','0.1' );
...
/** {{*class Substance=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Substance[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of Substance.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class Substance ====================================================== */
/* ==================================================================================== */
