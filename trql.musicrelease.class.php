...
/*--------------------------------------*/
{
    ...
    public      $timeRequired                   = null;             /* {*property   $timeRequired                   (Duration)                      Approximate or typical time it takes to work with or through this
                                                                                                                                                    ...
                                                                                                                                                    'PT30M', 'PT1H25M'. *} */
    public      $track                          = null;             /* {*property   $track                          (ItemList|MusicRecording)       A music recording (track)&#x2014;usually a single song. If an ItemList
                                                                                                                                                    is given, the list should contain items of type MusicRecording. *} */
    public      $tracks                         = null;             /* {*property   $tracks                         (MusicRecording)                A music recording (track)&#x2014;usually a single song. *} */
