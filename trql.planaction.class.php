...
/** {{{*fheader
    {*file                  trql.planaction.class.php *}
    {*purpose               The act of planning the execution of an
...
defined( 'PLANACTION_CLASS_VERSION' ) or define( 'PLANACTION_CLASS_VERSION','0.1' );
...
/** {{*class PlanAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/PlanAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->WikiData();
        $this->necroSignaling();
    }   /* End of PlanAction.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class PlanAction ====================================================== */
/* ==================================================================================== */
