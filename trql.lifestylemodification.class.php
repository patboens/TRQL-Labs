...
/** {{{*fheader
    {*file                  trql.lifestylemodification.class.php *}
    {*purpose               A process of care involving exercise, changes to diet,
                            fitness routines, and other lifestyle changes aimed at
...
/****************************************************************************************/
namespace trql\lifestylemodification;
...
defined( 'LIFESTYLEMODIFICATION_CLASS_VERSION' ) or define( 'LIFESTYLEMODIFICATION_CLASS_VERSION','0.1' );
...
/** {{*class LifestyleModification=
    ...
    *}
    ...
    {*doc [url]http://schema.org/LifestyleModification[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of LifestyleModification.__construct() ========================================== */
    /* ================================================================================ */
...
}   /* End of class LifestyleModification ====================================================== */
/* ==================================================================================== */
