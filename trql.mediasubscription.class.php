...
/** {{{*fheader
    {*file                  trql.mediasubscription.class.php *}
    {*purpose               A subscription which allows a user to access media including
...
/****************************************************************************************/
namespace trql\mediasubscription;
...
defined( 'MEDIASUBSCRIPTION_CLASS_VERSION' ) or define( 'MEDIASUBSCRIPTION_CLASS_VERSION','0.1' );
...
/** {{*class MediaSubscription=
    ...
    *}
    ...
    {*doc [url]http://schema.org/MediaSubscription[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $authenticator                  = null;             /* {*property   $authenticator                  (Organization)                  The Organization responsible for authenticating the user's
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of MediaSubscription.__construct() ========================================== */
    /* ================================================================================ */
...
}   /* End of class MediaSubscription ====================================================== */
/* ==================================================================================== */
