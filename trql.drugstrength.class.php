...
/** {{{*fheader
    {*file                  trql.drugstrength.class.php *}
    {*purpose               A specific strength in which a medical drug is available in
                            a specific country. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'DRUGSTRENGTH_CLASS_VERSION' ) or define( 'DRUGSTRENGTH_CLASS_VERSION','0.1' );
...
/** {{*class DrugStrength=
    ...
    *}
    ...
    {*doc [url]http://schema.org/DrugStrength[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $availableIn                    = null;             /* {*property   $availableIn                    (AdministrativeArea)            The location in which the strength is available. *} */
    ...
    public      $sameAs                         = null;             /* {*property   $sameAs                         (URL)                           URL of a reference Web page that unambiguously indicates the item's
                                                                                                                                                    ...
                                                                                                                                                    or official website. *} */
    public      $strengthUnit                   = null;             /* {*property   $strengthUnit                   (string)                        The units of an active ingredient's strength, e.g. mg. *} */
    public      $strengthValue                  = null;             /* {*property   $strengthValue                  (float)                         The value of an active ingredient's strength, e.g. 325. *} */
    ...
    */
    ...
    /*-----------------------------------------*/
    {
        ...
        return ( $this );
    }   /* End of DrugStrength.__construct() ========================================== */
    /* ================================================================================ */
