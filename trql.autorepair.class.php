...
/** {{{*fheader
    {*file                  trql.autorepair.class.php *}
    {*purpose               Car repair business. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'AUTOREPAIR_CLASS_VERSION' ) or define( 'AUTOREPAIR_CLASS_VERSION','0.1' );
...
/** {{*class AutoRepair=
    ...
    *}
    ...
    {*doc [url]http://schema.org/AutoRepair[/url] *}
