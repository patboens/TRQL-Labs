...
/** {{{*fheader
    {*file                  trql.loseaction.class.php *}
    {*purpose               The act of being defeated in a competitive activity. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'LOSEACTION_CLASS_VERSION' ) or define( 'LOSEACTION_CLASS_VERSION','0.1' );
...
/** {{*class LoseAction=
    ...
    *}
    ...
    {*doc [url]http://schema.org/LoseAction[/url] *}
...
/*--------------------------------------*/
{
    ...
    public      $winner                         = null;             /* {*property   $winner                         (Person)                        A sub property of participant. The winner of the action. *} */
