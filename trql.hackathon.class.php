...
/** {{{*fheader
    {*file                  trql.hackathon.class.php *}
    {*purpose               A hackathon event. *}
    {*author                {PYB} *}
    {*company               {COMPANY} *}
...
defined( 'HACKATHON_CLASS_VERSION' ) or define( 'HACKATHON_CLASS_VERSION','0.1' );
...
/** {{*class Hackathon=
    ...
    *}
    ...
    {*doc [url]http://schema.org/Hackathon[/url] *}
...
/*--------------------------------------*/
{
    ...
    */
    ...
    /*------------------------*/
    {
        ...
        $this->autodoc();
        $this->UIKey();
    }   /* End of Hackathon.__destruct() =========================================== */
    /* ================================================================================ */

}   /* End of class Hackathon ====================================================== */
/* ==================================================================================== */
